# Bluetooth Mesh - SoC Switch CTL Low Power RTOS

The **Bluetooth Mesh - SoC Switch CTL Low Power FreeRTOS/Micrium OS** example is a working example application that you can use as a template for Bluetooth Mesh Switch Low Power applications.
...
## Testing the Bluetooth Mesh - SoC Switch CTL Low Power FreeRTOS/Micrium OS Application

To test the application, do the following:

1. Make sure a bootloader is installed. See the Troubleshooting section.
2. Build and flash the **Bluetooth Mesh - SoC Switch CTL Low Power FreeRTOS/Micrium OS** example to the device.
