# Bluetooth Mesh - SoC Switch CTL RTOS

The **Bluetooth Mesh - SoC Switch CTL FreeRTOS/Micrium OS** example is a working example application that you can use as a template for Bluetooth Mesh Switch applications.
...
## Testing the Bluetooth Mesh - SoC Switch CTL FreeRTOS/Micrium Application
