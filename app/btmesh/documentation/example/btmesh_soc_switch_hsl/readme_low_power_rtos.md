...
## Testing the Bluetooth Mesh - SoC Switch HSL Low Power FreeRTOS/Micrium OS Application

To test the application, do the following:

1. Make sure a bootloader is installed. See the Troubleshooting section.
2. Build and flash the **Bluetooth Mesh - SoC Switch HSL Low Power FreeRTOS/Micrium OS** example to the device.
