# Bluetooth Mesh - SoC Switch HSL Low Power

The **Bluetooth Mesh - SoC Switch HSL Low Power** example is a working example application that you can use as a template for Bluetooth Mesh Switch Low Power applications.
...
In typical cases use the **Bluetooth Mesh - SoC Switch HSL** example, as it is easier to get feedback about the state and operations. But if you want to have the optimal power consumption, use the **Bluetooth Mesh - SoC Switch HSL Low Power** example, which does not have LCD, CLI or logging. Use that especially for the power consumption measurements.
...
## Testing the Bluetooth Mesh - SoC Switch HSL Low Power Application

To test the application, do the following:

1. Make sure a bootloader is installed. See the Troubleshooting section.
2. Build and flash the **Bluetooth Mesh - SoC Switch HSL Low Power** example to the device.
