...
class CliProcessor(cmd.Cmd):
    ...
    def arg_image_update(self):
        ...
        parser_image_update_converter_group.add_argument('--display_index', '-d', metavar='<u8>', type=int, help="Try auto-conversion image for this display. Mutually exclusive with '--raw' argument.")
