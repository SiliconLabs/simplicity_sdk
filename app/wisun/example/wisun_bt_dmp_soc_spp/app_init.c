...
void app_init(void)
{
  // Make VCOM I/O Stream non-blocking so that CLI can be redirected
  // to another I/O Stream on runtime
  sl_iostream_uart_set_read_block(sl_iostream_uart_vcom_handle, false);

  /* Init project info */
  sl_wisun_app_core_util_project_info_init("Wi-SUN - BLE DMP SPP Application");
