...
// Used for both CSMA and LBT
static union {
  RAIL_LbtConfig_t lbt;
  RAIL_CsmaConfig_t csma;
} lbtParams = {
  .csma = RAIL_CSMA_CONFIG_802_15_4_2003_2p4_GHz_OQPSK_CSMA,
};
...
void getLbtParams(sl_cli_command_arg_t *args)
{
  responsePrint(sl_cli_get_command_string(args, 0),
                ...
                "Duration:%u,"
                "Timeout:%u",
                lbtParams.lbt.lbtMinBoRand,
                lbtParams.lbt.lbtMaxBoRand,
                lbtParams.lbt.lbtTries,
                lbtParams.lbt.lbtThreshold,
                lbtParams.lbt.lbtBackoff,
                lbtParams.lbt.lbtDuration,
                lbtParams.lbt.lbtTimeout);
}

void setLbtParams(sl_cli_command_arg_t *args)
{
  lbtParams.lbt.lbtMinBoRand = sl_cli_get_argument_uint8(args, 0);
  lbtParams.lbt.lbtMaxBoRand = sl_cli_get_argument_uint8(args, 1);
  lbtParams.lbt.lbtTries     = sl_cli_get_argument_uint8(args, 2);
  lbtParams.lbt.lbtThreshold = sl_cli_get_argument_int8(args, 3);
  lbtParams.lbt.lbtBackoff   = sl_cli_get_argument_uint16(args, 4);
  lbtParams.lbt.lbtDuration  = sl_cli_get_argument_uint16(args, 5);
  lbtParams.lbt.lbtTimeout   = sl_cli_get_argument_uint32(args, 6);
