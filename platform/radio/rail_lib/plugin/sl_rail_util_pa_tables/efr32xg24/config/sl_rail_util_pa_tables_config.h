...
// <RAIL_PA_TABLE_SELECTION_DISABLE=> Disable
// <RAIL_PA_TABLE_SELECTION_HP=> High Power PA
// <i> Default: RAIL_PA_TABLE_SELECTION_HP
#define SL_RAIL_UTIL_PA_TABLE_SELECTION_2P4_GHZ    SL_RAIL_PA_TABLE_SELECTION_HP
#else
// <o SL_RAIL_UTIL_PA_TABLE_SELECTION_2P4_GHZ> 2.4 GHz PA Table Selection
// <RAIL_PA_TABLE_SELECTION_DISABLE=> Disable
// <RAIL_PA_TABLE_SELECTION_HP=> High Power PA
// <RAIL_PA_TABLE_SELECTION_LP=> Low Power PA
// <RAIL_PA_TABLE_SELECTION_AUTO_HP=> Automode with HP PA
// <i> Default: RAIL_PA_TABLE_SELECTION_AUTO_HP
...
// <RAIL_PA_TABLE_SELECTION_DISABLE=> Disable
// <i> Default: RAIL_PA_POWER_SETTING_SUBMODE_DISABLE
