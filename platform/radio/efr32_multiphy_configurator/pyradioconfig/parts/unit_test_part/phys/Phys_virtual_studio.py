...
class PHYS_virtual_studio(IPhy):
    ...
    def PHY_Secret1_868M_38p4kbps_renamed_virtual_studio(self, model):

        phy = self._makePhy(model, model.profiles.Base, 'PHY Secret1 868M 38p4kbps virtual studio PHY')
