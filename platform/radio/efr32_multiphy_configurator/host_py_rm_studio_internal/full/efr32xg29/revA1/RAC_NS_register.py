...
class RM_Register_RAC_NS_VCOCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.VCODETAMPLITUDE = RM_Field_RAC_NS_VCOCTRL_VCODETAMPLITUDE(self)
...
class RM_Register_RAC_NS_SYNTHCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_NS_SYNTHCTRL, self).__init__(rmio, label,
            0xb8020000, 0x0A4,
            'SYNTHCTRL', 'RAC_NS.SYNTHCTRL', 'read-write',
            u"",
            0x00000000, 0x00000400,
            0x00001000, 0x00002000,
            0x00003000)

        self.MMDPOWERBALANCEDISABLE = RM_Field_RAC_NS_SYNTHCTRL_MMDPOWERBALANCEDISABLE(self)
...
class RM_Register_RAC_NS_PAENCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PARAMPMODE = RM_Field_RAC_NS_PAENCTRL_PARAMPMODE(self)
...
class RM_Register_RAC_NS_LNAMIXDEBUG(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXDISMXR = RM_Field_RAC_NS_LNAMIXDEBUG_LNAMIXDISMXR(self)
...
class RM_Register_RAC_NS_LNAMIXTRIM0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXCURCTRL = RM_Field_RAC_NS_LNAMIXTRIM0_LNAMIXCURCTRL(self)
        self.zz_fdict['LNAMIXCURCTRL'] = self.LNAMIXCURCTRL
        self.LNAMIXHIGHCUR = RM_Field_RAC_NS_LNAMIXTRIM0_LNAMIXHIGHCUR(self)
        self.zz_fdict['LNAMIXHIGHCUR'] = self.LNAMIXHIGHCUR
        self.LNAMIXLOWCUR = RM_Field_RAC_NS_LNAMIXTRIM0_LNAMIXLOWCUR(self)
        ...
        self.LNAMIXRFPKDCALCM = RM_Field_RAC_NS_LNAMIXTRIM0_LNAMIXRFPKDCALCM(self)
        self.zz_fdict['LNAMIXRFPKDCALCM'] = self.LNAMIXRFPKDCALCM
        self.LNAMIXRFPKDCALDM = RM_Field_RAC_NS_LNAMIXTRIM0_LNAMIXRFPKDCALDM(self)
...
class RM_Register_RAC_NS_LNAMIXTRIM1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXIBIASADJ = RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXIBIASADJ(self)
        self.zz_fdict['LNAMIXIBIASADJ'] = self.LNAMIXIBIASADJ
        self.LNAMIXLNACAPSEL = RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXLNACAPSEL(self)
        self.zz_fdict['LNAMIXLNACAPSEL'] = self.LNAMIXLNACAPSEL
        self.LNAMIXMXRBIAS = RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXMXRBIAS(self)
        self.zz_fdict['LNAMIXMXRBIAS'] = self.LNAMIXMXRBIAS
        self.LNAMIXNCASADJ = RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXNCASADJ(self)
        self.zz_fdict['LNAMIXNCASADJ'] = self.LNAMIXNCASADJ
        self.LNAMIXPCASADJ = RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXPCASADJ(self)
        self.zz_fdict['LNAMIXPCASADJ'] = self.LNAMIXPCASADJ
        self.LNAMIXVOUTADJ = RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXVOUTADJ(self)
...
class RM_Register_RAC_NS_LNAMIXCAL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXENIRCAL = RM_Field_RAC_NS_LNAMIXCAL_LNAMIXENIRCAL(self)
        self.zz_fdict['LNAMIXENIRCAL'] = self.LNAMIXENIRCAL
        self.LNAMIXIRCALAMP = RM_Field_RAC_NS_LNAMIXCAL_LNAMIXIRCALAMP(self)
...
class RM_Register_RAC_NS_PATRIM0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TX0DBMTRIMDUTYCYN = RM_Field_RAC_NS_PATRIM0_TX0DBMTRIMDUTYCYN(self)
        self.zz_fdict['TX0DBMTRIMDUTYCYN'] = self.TX0DBMTRIMDUTYCYN
        self.TX0DBMTRIMDUTYCYP = RM_Field_RAC_NS_PATRIM0_TX0DBMTRIMDUTYCYP(self)
...
class RM_Register_RAC_NS_PATRIM1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TX0DBMTRIMTAPCAP = RM_Field_RAC_NS_PATRIM1_TX0DBMTRIMTAPCAP(self)
...
class RM_Register_RAC_NS_PATRIM2(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TX6DBMTRIMBIASN = RM_Field_RAC_NS_PATRIM2_TX6DBMTRIMBIASN(self)
        self.zz_fdict['TX6DBMTRIMBIASN'] = self.TX6DBMTRIMBIASN
        self.TX6DBMTRIMBIASP = RM_Field_RAC_NS_PATRIM2_TX6DBMTRIMBIASP(self)
        self.zz_fdict['TX6DBMTRIMBIASP'] = self.TX6DBMTRIMBIASP
        self.TX6DBMTRIMDUTYCYN = RM_Field_RAC_NS_PATRIM2_TX6DBMTRIMDUTYCYN(self)
        self.zz_fdict['TX6DBMTRIMDUTYCYN'] = self.TX6DBMTRIMDUTYCYN
        self.TX6DBMTRIMDUTYCYP = RM_Field_RAC_NS_PATRIM2_TX6DBMTRIMDUTYCYP(self)
...
class RM_Register_RAC_NS_PATRIM3(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TX6DBMTRIMIBIASMASTER = RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMIBIASMASTER(self)
        self.zz_fdict['TX6DBMTRIMIBIASMASTER'] = self.TX6DBMTRIMIBIASMASTER
        self.TX6DBMTRIMPREDRVREGFB = RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGFB(self)
        self.zz_fdict['TX6DBMTRIMPREDRVREGFB'] = self.TX6DBMTRIMPREDRVREGFB
        self.TX6DBMTRIMPREDRVREGFBKATT = RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGFBKATT(self)
        self.zz_fdict['TX6DBMTRIMPREDRVREGFBKATT'] = self.TX6DBMTRIMPREDRVREGFBKATT
        self.TX6DBMTRIMPREDRVREGPSR = RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGPSR(self)
        self.zz_fdict['TX6DBMTRIMPREDRVREGPSR'] = self.TX6DBMTRIMPREDRVREGPSR
        self.TX6DBMTRIMPREDRVREGSLICE = RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGSLICE(self)
        self.zz_fdict['TX6DBMTRIMPREDRVREGSLICE'] = self.TX6DBMTRIMPREDRVREGSLICE
        self.TX6DBMTRIMPREDRVREGVREF = RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGVREF(self)
        self.zz_fdict['TX6DBMTRIMPREDRVREGVREF'] = self.TX6DBMTRIMPREDRVREGVREF
        self.TX6DBMTRIMREGBLEEDAUTO = RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMREGBLEEDAUTO(self)
        self.zz_fdict['TX6DBMTRIMREGBLEEDAUTO'] = self.TX6DBMTRIMREGBLEEDAUTO
        self.TX6DBMTRIMREGFB = RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMREGFB(self)
        self.zz_fdict['TX6DBMTRIMREGFB'] = self.TX6DBMTRIMREGFB
        self.TX6DBMTRIMREGPSR = RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMREGPSR(self)
        self.zz_fdict['TX6DBMTRIMREGPSR'] = self.TX6DBMTRIMREGPSR
        self.TX6DBMTRIMREGVREF = RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMREGVREF(self)
        self.zz_fdict['TX6DBMTRIMREGVREF'] = self.TX6DBMTRIMREGVREF
        self.TX6DBMTRIMRXMODEVREF = RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMRXMODEVREF(self)
...
class RM_Register_RAC_NS_PACTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TX0DBMPOWER = RM_Field_RAC_NS_PACTRL_TX0DBMPOWER(self)
        self.zz_fdict['TX0DBMPOWER'] = self.TX0DBMPOWER
        self.TX0DBMSELSLICE = RM_Field_RAC_NS_PACTRL_TX0DBMSELSLICE(self)
        ...
        self.TX6DBMPOWER = RM_Field_RAC_NS_PACTRL_TX6DBMPOWER(self)
        self.zz_fdict['TX6DBMPOWER'] = self.TX6DBMPOWER
        self.TX6DBMSELSLICE = RM_Field_RAC_NS_PACTRL_TX6DBMSELSLICE(self)
        self.zz_fdict['TX6DBMSELSLICE'] = self.TX6DBMSELSLICE
        self.TX6DBMSLICERESET = RM_Field_RAC_NS_PACTRL_TX6DBMSLICERESET(self)
        self.zz_fdict['TX6DBMSLICERESET'] = self.TX6DBMSLICERESET
        self.TX6DBMLATCHBYPASS = RM_Field_RAC_NS_PACTRL_TX6DBMLATCHBYPASS(self)
        self.zz_fdict['TX6DBMLATCHBYPASS'] = self.TX6DBMLATCHBYPASS
        self.TX6DBMPREDRVREGBYPASS = RM_Field_RAC_NS_PACTRL_TX6DBMPREDRVREGBYPASS(self)
        self.zz_fdict['TX6DBMPREDRVREGBYPASS'] = self.TX6DBMPREDRVREGBYPASS
        self.TX6DBMPULLDOWNREG = RM_Field_RAC_NS_PACTRL_TX6DBMPULLDOWNREG(self)
        self.zz_fdict['TX6DBMPULLDOWNREG'] = self.TX6DBMPULLDOWNREG
        self.TX6DBMREGBYPASS = RM_Field_RAC_NS_PACTRL_TX6DBMREGBYPASS(self)
...
class RM_Register_RAC_NS_PGACTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXRFPKDTHRESHSEL = RM_Field_RAC_NS_PGACTRL_LNAMIXRFPKDTHRESHSEL(self)
...
class RM_Register_RAC_NS_RFPATHEN(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_NS_RFPATHEN, self).__init__(rmio, label,
            0xb8020000, 0x140,
            'RFPATHEN', 'RAC_NS.RFPATHEN', 'read-write',
            u"",
            0x00000004, 0x0000001E,
            0x00001000, 0x00002000,
            0x00003000)

        self.LNAMIXEN = RM_Field_RAC_NS_RFPATHEN_LNAMIXEN(self)
        self.zz_fdict['LNAMIXEN'] = self.LNAMIXEN
        self.LNAMIXRFATTDCEN = RM_Field_RAC_NS_RFPATHEN_LNAMIXRFATTDCEN(self)
        self.zz_fdict['LNAMIXRFATTDCEN'] = self.LNAMIXRFATTDCEN
        self.LNAMIXRFPKDENRF = RM_Field_RAC_NS_RFPATHEN_LNAMIXRFPKDENRF(self)
        self.zz_fdict['LNAMIXRFPKDENRF'] = self.LNAMIXRFPKDENRF
        self.LNAMIXTRSW = RM_Field_RAC_NS_RFPATHEN_LNAMIXTRSW(self)
...
class RM_Register_RAC_NS_RX(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYCHPBIASTRIMBUF = RM_Field_RAC_NS_RX_SYCHPBIASTRIMBUF(self)
        ...
        self.SYPFDCHPLPEN = RM_Field_RAC_NS_RX_SYPFDCHPLPEN(self)
        self.zz_fdict['SYPFDCHPLPEN'] = self.SYPFDCHPLPEN
        self.SYPFDFPWEN = RM_Field_RAC_NS_RX_SYPFDFPWEN(self)
        self.zz_fdict['SYPFDFPWEN'] = self.SYPFDFPWEN
        self.TX6DBMENRXMODEBIAS = RM_Field_RAC_NS_RX_TX6DBMENRXMODEBIAS(self)
...
class RM_Register_RAC_NS_TX(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TX6DBMENBLEEDPREDRVREG = RM_Field_RAC_NS_TX_TX6DBMENBLEEDPREDRVREG(self)
        self.zz_fdict['TX6DBMENBLEEDPREDRVREG'] = self.TX6DBMENBLEEDPREDRVREG
        self.TX6DBMENBLEEDREG = RM_Field_RAC_NS_TX_TX6DBMENBLEEDREG(self)
        self.zz_fdict['TX6DBMENBLEEDREG'] = self.TX6DBMENBLEEDREG
        self.TX6DBMENPREDRVREG = RM_Field_RAC_NS_TX_TX6DBMENPREDRVREG(self)
        self.zz_fdict['TX6DBMENPREDRVREG'] = self.TX6DBMENPREDRVREG
        self.TX6DBMENRAMPCLK = RM_Field_RAC_NS_TX_TX6DBMENRAMPCLK(self)
        self.zz_fdict['TX6DBMENRAMPCLK'] = self.TX6DBMENRAMPCLK
        self.TX6DBMENREG = RM_Field_RAC_NS_TX_TX6DBMENREG(self)
        self.zz_fdict['TX6DBMENREG'] = self.TX6DBMENREG
        self.TX6DBMENPACORE = RM_Field_RAC_NS_TX_TX6DBMENPACORE(self)
        self.zz_fdict['TX6DBMENPACORE'] = self.TX6DBMENPACORE
        self.TX6DBMENPAOUT = RM_Field_RAC_NS_TX_TX6DBMENPAOUT(self)
        self.zz_fdict['TX6DBMENPAOUT'] = self.TX6DBMENPAOUT
        self.ENXOSQBUFFILT = RM_Field_RAC_NS_TX_ENXOSQBUFFILT(self)
...
class RM_Register_RAC_NS_SYTRIM0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYCHPCURR = RM_Field_RAC_NS_SYTRIM0_SYCHPCURR(self)
        ...
        self.SYCHPLEVPSRC = RM_Field_RAC_NS_SYTRIM0_SYCHPLEVPSRC(self)
        self.zz_fdict['SYCHPLEVPSRC'] = self.SYCHPLEVPSRC
        self.SYCHPSRCEN = RM_Field_RAC_NS_SYTRIM0_SYCHPSRCEN(self)
...
class RM_Register_RAC_NS_SYTRIM1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYLODIVLDOTRIMCORE = RM_Field_RAC_NS_SYTRIM1_SYLODIVLDOTRIMCORE(self)
        self.zz_fdict['SYLODIVLDOTRIMCORE'] = self.SYLODIVLDOTRIMCORE
        self.SYLODIVLDOTRIMNDIO = RM_Field_RAC_NS_SYTRIM1_SYLODIVLDOTRIMNDIO(self)
        ...
        self.SYLODIVRLOADCCLKSEL = RM_Field_RAC_NS_SYTRIM1_SYLODIVRLOADCCLKSEL(self)
        self.zz_fdict['SYLODIVRLOADCCLKSEL'] = self.SYLODIVRLOADCCLKSEL
        self.SYLODIVSGTESTDIV = RM_Field_RAC_NS_SYTRIM1_SYLODIVSGTESTDIV(self)
...
class RM_Register_RAC_NS_SYEN(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYCHPLPEN = RM_Field_RAC_NS_SYEN_SYCHPLPEN(self)
        ...
        self.SYLODIVEN = RM_Field_RAC_NS_SYEN_SYLODIVEN(self)
        self.zz_fdict['SYLODIVEN'] = self.SYLODIVEN
        self.SYLODIVLDOBIASEN = RM_Field_RAC_NS_SYEN_SYLODIVLDOBIASEN(self)
        self.zz_fdict['SYLODIVLDOBIASEN'] = self.SYLODIVLDOBIASEN
        self.SYLODIVLDOEN = RM_Field_RAC_NS_SYEN_SYLODIVLDOEN(self)
...
class RM_Register_RAC_NS_SYLOEN(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYLODIVRLO2G4EN = RM_Field_RAC_NS_SYLOEN_SYLODIVRLO2G4EN(self)
        ...
        self.SYLODIVTLO6DBM2G4AUXEN = RM_Field_RAC_NS_SYLOEN_SYLODIVTLO6DBM2G4AUXEN(self)
        self.zz_fdict['SYLODIVTLO6DBM2G4AUXEN'] = self.SYLODIVTLO6DBM2G4AUXEN
        self.SYLODIVTLO6DBM2G4EN = RM_Field_RAC_NS_SYLOEN_SYLODIVTLO6DBM2G4EN(self)
        self.zz_fdict['SYLODIVTLO6DBM2G4EN'] = self.SYLODIVTLO6DBM2G4EN
        self.SYLODIVSGTESTDIVEN = RM_Field_RAC_NS_SYLOEN_SYLODIVSGTESTDIVEN(self)
...
class RM_Register_RAC_NS_SYMMDCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYMMDMODE = RM_Field_RAC_NS_SYMMDCTRL_SYMMDMODE(self)
...
class RM_Register_RAC_NS_XOSQBUFFILT(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_NS_XOSQBUFFILT, self).__init__(rmio, label,
            0xb8020000, 0x17C,
            'XOSQBUFFILT', 'RAC_NS.XOSQBUFFILT', 'read-write',
            u"",
            0x00000000, 0x00000003,
            0x00001000, 0x00002000,
            0x00003000)

        self.XOSQBUFFILT = RM_Field_RAC_NS_XOSQBUFFILT_XOSQBUFFILT(self)
...
class RM_Register_RAC_NS_SPARE(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TX6DBMSPARE = RM_Field_RAC_NS_SPARE_TX6DBMSPARE(self)
...
class RM_Register_RAC_NS_AGCOVERWRITE(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_NS_AGCOVERWRITE, self).__init__(rmio, label,
            0xb8020000, 0x188,
            'AGCOVERWRITE', 'RAC_NS.AGCOVERWRITE', 'read-write',
            u"",
            0x00000000, 0x03F0FFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.ENMANLNAMIXRFATT = RM_Field_RAC_NS_AGCOVERWRITE_ENMANLNAMIXRFATT(self)
        self.zz_fdict['ENMANLNAMIXRFATT'] = self.ENMANLNAMIXRFATT
        self.ENMANLNAMIXSLICE = RM_Field_RAC_NS_AGCOVERWRITE_ENMANLNAMIXSLICE(self)
        self.zz_fdict['ENMANLNAMIXSLICE'] = self.ENMANLNAMIXSLICE
        self.ENMANPGAGAIN = RM_Field_RAC_NS_AGCOVERWRITE_ENMANPGAGAIN(self)
        self.zz_fdict['ENMANPGAGAIN'] = self.ENMANPGAGAIN
        self.ENMANIFADCSCALE = RM_Field_RAC_NS_AGCOVERWRITE_ENMANIFADCSCALE(self)
        self.zz_fdict['ENMANIFADCSCALE'] = self.ENMANIFADCSCALE
        self.MANLNAMIXRFATT = RM_Field_RAC_NS_AGCOVERWRITE_MANLNAMIXRFATT(self)
        self.zz_fdict['MANLNAMIXRFATT'] = self.MANLNAMIXRFATT
        self.MANLNAMIXSLICE = RM_Field_RAC_NS_AGCOVERWRITE_MANLNAMIXSLICE(self)
        self.zz_fdict['MANLNAMIXSLICE'] = self.MANLNAMIXSLICE
        self.MANPGAGAIN = RM_Field_RAC_NS_AGCOVERWRITE_MANPGAGAIN(self)
        self.zz_fdict['MANPGAGAIN'] = self.MANPGAGAIN
        self.MANIFADCSCALE = RM_Field_RAC_NS_AGCOVERWRITE_MANIFADCSCALE(self)
...
class RM_Register_RAC_NS_RFLOCK0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RACPAEN6DBM = RM_Field_RAC_NS_RFLOCK0_RACPAEN6DBM(self)
...
class RM_Register_RAC_NS_RFLOCK1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RACPASTRIPE0DBM = RM_Field_RAC_NS_RFLOCK1_RACPASTRIPE0DBM(self)
        self.zz_fdict['RACPASTRIPE0DBM'] = self.RACPASTRIPE0DBM
        self.RACPASLICE0DBM = RM_Field_RAC_NS_RFLOCK1_RACPASLICE0DBM(self)
        self.zz_fdict['RACPASLICE0DBM'] = self.RACPASLICE0DBM
        self.RACPASTRIPE6DBM = RM_Field_RAC_NS_RFLOCK1_RACPASTRIPE6DBM(self)
        self.zz_fdict['RACPASTRIPE6DBM'] = self.RACPASTRIPE6DBM
        self.RACPASLICE6DBM = RM_Field_RAC_NS_RFLOCK1_RACPASLICE6DBM(self)
