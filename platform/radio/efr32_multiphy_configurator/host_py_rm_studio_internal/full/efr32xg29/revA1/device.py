...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_EFR32XG29XFULL_RevA1``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_EFR32XG29XFULL_RevA1
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_EFR32XG29XFULL_RevA1' ]
...
class RM_Device_EFR32XG29XFULL_RevA1(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm', default_tz_access_mode=RM_TrustZone_Access_Mode.TZ_SECURE):
        ...
        super(RM_Device_EFR32XG29XFULL_RevA1, self).__init__(rmio, label,
            'EFR32XG29XFULL',
            RM_SVD_Info('EFR32XG29XFULL_SEQ.svd', 'b73090ab9f8fc2e61df7a59337499da6'))
