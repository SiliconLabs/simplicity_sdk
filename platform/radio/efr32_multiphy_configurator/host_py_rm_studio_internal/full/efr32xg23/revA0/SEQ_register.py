...
class RM_Register_SEQ_MISC(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SQBMODETX_VAL = RM_Field_SEQ_MISC_SQBMODETX_VAL(self)
        self.zz_fdict['SQBMODETX_VAL'] = self.SQBMODETX_VAL
        self.RESERVED6 = RM_Field_SEQ_MISC_RESERVED6(self)
        self.zz_fdict['RESERVED6'] = self.RESERVED6
        self.DIG_RAMP_EN = RM_Field_SEQ_MISC_DIG_RAMP_EN(self)
        self.zz_fdict['DIG_RAMP_EN'] = self.DIG_RAMP_EN
