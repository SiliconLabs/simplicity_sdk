...
class RM_Field_SEQ_MISC_SQBMODETX_VAL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SEQ_MISC_SQBMODETX_VAL, self).__init__(register,
            'SQBMODETX_VAL', 'SEQ.MISC.SQBMODETX_VAL', 'read-write',
            u"",
            10, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_SEQ_MISC_RESERVED6(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SEQ_MISC_RESERVED6, self).__init__(register,
            'RESERVED6', 'SEQ.MISC.RESERVED6', 'read-write',
            u"",
            6, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_SEQ_MISC_DIG_RAMP_EN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SEQ_MISC_DIG_RAMP_EN, self).__init__(register,
            'DIG_RAMP_EN', 'SEQ.MISC.DIG_RAMP_EN', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True
