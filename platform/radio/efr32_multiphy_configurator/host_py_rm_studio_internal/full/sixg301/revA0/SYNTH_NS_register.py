...
class RM_Register_SYNTH_NS_FSWIF(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_NS_FSWIF, self).__init__(rmio, label,
            0xb0218000, 0x018,
            'FSWIF', 'SYNTH_NS.FSWIF', 'read-write',
            u"",
            0x00000000, 0x00000637,
            0x00001000, 0x00002000,
            0x00003000)

        self.LOCKED = RM_Field_SYNTH_NS_FSWIF_LOCKED(self)
        self.zz_fdict['LOCKED'] = self.LOCKED
        self.UNLOCKED = RM_Field_SYNTH_NS_FSWIF_UNLOCKED(self)
        self.zz_fdict['UNLOCKED'] = self.UNLOCKED
        self.SYRDY = RM_Field_SYNTH_NS_FSWIF_SYRDY(self)
        self.zz_fdict['SYRDY'] = self.SYRDY
        self.VCOHIGH = RM_Field_SYNTH_NS_FSWIF_VCOHIGH(self)
        self.zz_fdict['VCOHIGH'] = self.VCOHIGH
        self.VCOLOW = RM_Field_SYNTH_NS_FSWIF_VCOLOW(self)
        self.zz_fdict['VCOLOW'] = self.VCOLOW
        self.LOCNTDONE = RM_Field_SYNTH_NS_FSWIF_LOCNTDONE(self)
        self.zz_fdict['LOCNTDONE'] = self.LOCNTDONE
        self.FCALDONE = RM_Field_SYNTH_NS_FSWIF_FCALDONE(self)
        self.zz_fdict['FCALDONE'] = self.FCALDONE
        self.__dict__['zz_frozen'] = True


class RM_Register_SYNTH_NS_FSWIEN(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_NS_FSWIEN, self).__init__(rmio, label,
            0xb0218000, 0x01C,
            'FSWIEN', 'SYNTH_NS.FSWIEN', 'read-write',
            u"",
            0x00000000, 0x00000637,
            0x00001000, 0x00002000,
            0x00003000)

        self.LOCKED = RM_Field_SYNTH_NS_FSWIEN_LOCKED(self)
        self.zz_fdict['LOCKED'] = self.LOCKED
        self.UNLOCKED = RM_Field_SYNTH_NS_FSWIEN_UNLOCKED(self)
        self.zz_fdict['UNLOCKED'] = self.UNLOCKED
        self.SYRDY = RM_Field_SYNTH_NS_FSWIEN_SYRDY(self)
        self.zz_fdict['SYRDY'] = self.SYRDY
        self.VCOHIGH = RM_Field_SYNTH_NS_FSWIEN_VCOHIGH(self)
        self.zz_fdict['VCOHIGH'] = self.VCOHIGH
        self.VCOLOW = RM_Field_SYNTH_NS_FSWIEN_VCOLOW(self)
        self.zz_fdict['VCOLOW'] = self.VCOLOW
        self.LOCNTDONE = RM_Field_SYNTH_NS_FSWIEN_LOCNTDONE(self)
        self.zz_fdict['LOCNTDONE'] = self.LOCNTDONE
        self.FCALDONE = RM_Field_SYNTH_NS_FSWIEN_FCALDONE(self)
        self.zz_fdict['FCALDONE'] = self.FCALDONE
        self.__dict__['zz_frozen'] = True
...
class RM_Register_SYNTH_NS_CTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.FORCECLKXOSCEN = RM_Field_SYNTH_NS_CTRL_FORCECLKXOSCEN(self)
...
class RM_Register_SYNTH_NS_DSMCTRLRX(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.QNCMODERX = RM_Field_SYNTH_NS_DSMCTRLRX_QNCMODERX(self)
        self.zz_fdict['QNCMODERX'] = self.QNCMODERX
        self.GLMSOVERRIDEVALRX = RM_Field_SYNTH_NS_DSMCTRLRX_GLMSOVERRIDEVALRX(self)
...
class RM_Register_SYNTH_NS_DSMCTRLTX(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.QNCMODETX = RM_Field_SYNTH_NS_DSMCTRLTX_QNCMODETX(self)
        self.zz_fdict['QNCMODETX'] = self.QNCMODETX
        self.GLMSOVERRIDEVALTX = RM_Field_SYNTH_NS_DSMCTRLTX_GLMSOVERRIDEVALTX(self)
...
class RM_Register_SYNTH_NS_FCALCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.FCALRST = RM_Field_SYNTH_NS_FCALCTRL_FCALRST(self)
...
class RM_Register_SYNTH_NS_SPARE(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_NS_SPARE, self).__init__(rmio, label,
            0xb0218000, 0x0A8,
            'SPARE', 'SYNTH_NS.SPARE', 'read-write',
            u"",
            0x00000000, 0x000000FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SPARE = RM_Field_SYNTH_NS_SPARE_SPARE(self)
