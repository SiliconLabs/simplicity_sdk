...
class RM_Field_SYNTH_NS_FSWIF_LOCKED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIF_LOCKED, self).__init__(register,
            'LOCKED', 'SYNTH_NS.FSWIF.LOCKED', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_FSWIF_UNLOCKED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIF_UNLOCKED, self).__init__(register,
            'UNLOCKED', 'SYNTH_NS.FSWIF.UNLOCKED', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_FSWIF_SYRDY(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIF_SYRDY, self).__init__(register,
            'SYRDY', 'SYNTH_NS.FSWIF.SYRDY', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_FSWIF_VCOHIGH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIF_VCOHIGH, self).__init__(register,
            'VCOHIGH', 'SYNTH_NS.FSWIF.VCOHIGH', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_FSWIF_VCOLOW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIF_VCOLOW, self).__init__(register,
            'VCOLOW', 'SYNTH_NS.FSWIF.VCOLOW', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_FSWIF_LOCNTDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIF_LOCNTDONE, self).__init__(register,
            'LOCNTDONE', 'SYNTH_NS.FSWIF.LOCNTDONE', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_FSWIF_FCALDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIF_FCALDONE, self).__init__(register,
            'FCALDONE', 'SYNTH_NS.FSWIF.FCALDONE', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_FSWIEN_LOCKED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIEN_LOCKED, self).__init__(register,
            'LOCKED', 'SYNTH_NS.FSWIEN.LOCKED', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_FSWIEN_UNLOCKED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIEN_UNLOCKED, self).__init__(register,
            'UNLOCKED', 'SYNTH_NS.FSWIEN.UNLOCKED', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_FSWIEN_SYRDY(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIEN_SYRDY, self).__init__(register,
            'SYRDY', 'SYNTH_NS.FSWIEN.SYRDY', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_FSWIEN_VCOHIGH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIEN_VCOHIGH, self).__init__(register,
            'VCOHIGH', 'SYNTH_NS.FSWIEN.VCOHIGH', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_FSWIEN_VCOLOW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIEN_VCOLOW, self).__init__(register,
            'VCOLOW', 'SYNTH_NS.FSWIEN.VCOLOW', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_FSWIEN_LOCNTDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIEN_LOCNTDONE, self).__init__(register,
            'LOCNTDONE', 'SYNTH_NS.FSWIEN.LOCNTDONE', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_FSWIEN_FCALDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FSWIEN_FCALDONE, self).__init__(register,
            'FCALDONE', 'SYNTH_NS.FSWIEN.FCALDONE', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_SYNTH_NS_CTRL_FORCECLKXOSCEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_CTRL_FORCECLKXOSCEN, self).__init__(register,
            'FORCECLKXOSCEN', 'SYNTH_NS.CTRL.FORCECLKXOSCEN', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_SYNTH_NS_DSMCTRLRX_QNCMODERX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_DSMCTRLRX_QNCMODERX, self).__init__(register,
            'QNCMODERX', 'SYNTH_NS.DSMCTRLRX.QNCMODERX', 'read-write',
            u"",
            7, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_DSMCTRLRX_GLMSOVERRIDEVALRX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_DSMCTRLRX_GLMSOVERRIDEVALRX, self).__init__(register,
            'GLMSOVERRIDEVALRX', 'SYNTH_NS.DSMCTRLRX.GLMSOVERRIDEVALRX', 'read-write',
            u"",
            9, 13)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_SYNTH_NS_DSMCTRLTX_QNCMODETX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_DSMCTRLTX_QNCMODETX, self).__init__(register,
            'QNCMODETX', 'SYNTH_NS.DSMCTRLTX.QNCMODETX', 'read-write',
            u"",
            7, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_NS_DSMCTRLTX_GLMSOVERRIDEVALTX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_DSMCTRLTX_GLMSOVERRIDEVALTX, self).__init__(register,
            'GLMSOVERRIDEVALTX', 'SYNTH_NS.DSMCTRLTX.GLMSOVERRIDEVALTX', 'read-write',
            u"",
            9, 13)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_SYNTH_NS_FCALCTRL_FCALRST(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_FCALCTRL_FCALRST, self).__init__(register,
            'FCALRST', 'SYNTH_NS.FCALCTRL.FCALRST', 'write-only',
            u"",
            24, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_SYNTH_NS_SPARE_SPARE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_SPARE_SPARE, self).__init__(register,
            'SPARE', 'SYNTH_NS.SPARE.SPARE', 'read-write',
            u"",
            0, 8)
        self.__dict__['zz_frozen'] = True
