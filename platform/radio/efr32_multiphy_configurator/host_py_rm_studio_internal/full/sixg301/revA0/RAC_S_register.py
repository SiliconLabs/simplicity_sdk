...
class RM_Register_RAC_S_CTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.FSMDEMODENSEARCH = RM_Field_RAC_S_CTRL_FSMDEMODENSEARCH(self)
        ...
        self.FSMDEMODENWAIT = RM_Field_RAC_S_CTRL_FSMDEMODENWAIT(self)
...
class RM_Register_RAC_S_IF(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PREREGBYPOUT = RM_Field_RAC_S_IF_PREREGBYPOUT(self)
...
class RM_Register_RAC_S_IEN(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.zz_fdict['FSWRESETREQ'] = self.FSWRESETREQ
        self.PREREGBYPOUT = RM_Field_RAC_S_IEN_PREREGBYPOUT(self)
        self.zz_fdict['PREREGBYPOUT'] = self.PREREGBYPOUT
...
class RM_Register_RAC_S_SEQIF(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PREREGBYPOUT = RM_Field_RAC_S_SEQIF_PREREGBYPOUT(self)
        self.zz_fdict['PREREGBYPOUT'] = self.PREREGBYPOUT
        ...
        self.BRERRAHB2AHB0 = RM_Field_RAC_S_SEQIF_BRERRAHB2AHB0(self)
        self.zz_fdict['BRERRAHB2AHB0'] = self.BRERRAHB2AHB0
        self.BRERRAHB2AHB1 = RM_Field_RAC_S_SEQIF_BRERRAHB2AHB1(self)
        self.zz_fdict['BRERRAHB2AHB1'] = self.BRERRAHB2AHB1
        self.BRERRLPW2HOST = RM_Field_RAC_S_SEQIF_BRERRLPW2HOST(self)
        self.zz_fdict['BRERRLPW2HOST'] = self.BRERRLPW2HOST
        self.BRERRLPW2SYSMB = RM_Field_RAC_S_SEQIF_BRERRLPW2SYSMB(self)
...
class RM_Register_RAC_S_SEQIEN(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.zz_fdict['PRSEVENT'] = self.PRSEVENT
        self.PREREGBYPOUT = RM_Field_RAC_S_SEQIEN_PREREGBYPOUT(self)
        self.zz_fdict['PREREGBYPOUT'] = self.PREREGBYPOUT
        ...
        self.zz_fdict['STATESHUTDOWN'] = self.STATESHUTDOWN
        self.BRERRAHB2AHB0 = RM_Field_RAC_S_SEQIEN_BRERRAHB2AHB0(self)
        self.zz_fdict['BRERRAHB2AHB0'] = self.BRERRAHB2AHB0
        self.BRERRAHB2AHB1 = RM_Field_RAC_S_SEQIEN_BRERRAHB2AHB1(self)
        self.zz_fdict['BRERRAHB2AHB1'] = self.BRERRAHB2AHB1
        self.BRERRLPW2HOST = RM_Field_RAC_S_SEQIEN_BRERRLPW2HOST(self)
        self.zz_fdict['BRERRLPW2HOST'] = self.BRERRLPW2HOST
        self.BRERRLPW2SYSMB = RM_Field_RAC_S_SEQIEN_BRERRLPW2SYSMB(self)
        self.zz_fdict['BRERRLPW2SYSMB'] = self.BRERRLPW2SYSMB
        self.__dict__['zz_frozen'] = True
...
class RM_Register_RAC_S_FSWIF(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.zz_fdict['STATESHUTDOWN'] = self.STATESHUTDOWN
        self.BRERRAHB2AHB0 = RM_Field_RAC_S_FSWIF_BRERRAHB2AHB0(self)
        self.zz_fdict['BRERRAHB2AHB0'] = self.BRERRAHB2AHB0
        self.BRERRAHB2AHB1 = RM_Field_RAC_S_FSWIF_BRERRAHB2AHB1(self)
        self.zz_fdict['BRERRAHB2AHB1'] = self.BRERRAHB2AHB1
        self.BRERRLPW2HOST = RM_Field_RAC_S_FSWIF_BRERRLPW2HOST(self)
        self.zz_fdict['BRERRLPW2HOST'] = self.BRERRLPW2HOST
        self.BRERRLPW2SYSMB = RM_Field_RAC_S_FSWIF_BRERRLPW2SYSMB(self)
        self.zz_fdict['BRERRLPW2SYSMB'] = self.BRERRLPW2SYSMB
        self.__dict__['zz_frozen'] = True
...
class RM_Register_RAC_S_FSWIEN(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.zz_fdict['STATESHUTDOWN'] = self.STATESHUTDOWN
        self.BRERRAHB2AHB0 = RM_Field_RAC_S_FSWIEN_BRERRAHB2AHB0(self)
        self.zz_fdict['BRERRAHB2AHB0'] = self.BRERRAHB2AHB0
        self.BRERRAHB2AHB1 = RM_Field_RAC_S_FSWIEN_BRERRAHB2AHB1(self)
        self.zz_fdict['BRERRAHB2AHB1'] = self.BRERRAHB2AHB1
        self.BRERRLPW2HOST = RM_Field_RAC_S_FSWIEN_BRERRLPW2HOST(self)
        self.zz_fdict['BRERRLPW2HOST'] = self.BRERRLPW2HOST
        self.BRERRLPW2SYSMB = RM_Field_RAC_S_FSWIEN_BRERRLPW2SYSMB(self)
        self.zz_fdict['BRERRLPW2SYSMB'] = self.BRERRLPW2SYSMB
        self.__dict__['zz_frozen'] = True
...
class RM_Register_RAC_S_RACSPARE(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_RACSPARE, self).__init__(rmio, label,
            0xa0220000, 0x054,
            'RACSPARE', 'RAC_S.RACSPARE', 'read-write',
            u"",
            0x00000000, 0x000000FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.RACSPARE = RM_Field_RAC_S_RACSPARE_RACSPARE(self)
        self.zz_fdict['RACSPARE'] = self.RACSPARE
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_PRSCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_PRSCTRL, self).__init__(rmio, label,
            0xa0220000, 0x058,
            'PRSCTRL', 'RAC_S.PRSCTRL', 'read-write',
            u"",
            0x00000000, 0x0000000F,
            0x00001000, 0x00002000,
            0x00003000)

        self.CTI0SEL = RM_Field_RAC_S_PRSCTRL_CTI0SEL(self)
        self.zz_fdict['CTI0SEL'] = self.CTI0SEL
        self.CTI1SEL = RM_Field_RAC_S_PRSCTRL_CTI1SEL(self)
        self.zz_fdict['CTI1SEL'] = self.CTI1SEL
        self.CTI2SEL = RM_Field_RAC_S_PRSCTRL_CTI2SEL(self)
        self.zz_fdict['CTI2SEL'] = self.CTI2SEL
        self.CTI3SEL = RM_Field_RAC_S_PRSCTRL_CTI3SEL(self)
        self.zz_fdict['CTI3SEL'] = self.CTI3SEL
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_SWDBG(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_SWDBG, self).__init__(rmio, label,
            0xa0220000, 0x05C,
            'SWDBG', 'RAC_S.SWDBG', 'read-write',
            u"",
            0x00000000, 0x0000000F,
            0x00001000, 0x00002000,
            0x00003000)

        self.SWDBG0 = RM_Field_RAC_S_SWDBG_SWDBG0(self)
        self.zz_fdict['SWDBG0'] = self.SWDBG0
        self.SWDBG1 = RM_Field_RAC_S_SWDBG_SWDBG1(self)
        self.zz_fdict['SWDBG1'] = self.SWDBG1
        self.SWDBG2 = RM_Field_RAC_S_SWDBG_SWDBG2(self)
        self.zz_fdict['SWDBG2'] = self.SWDBG2
        self.SWDBG3 = RM_Field_RAC_S_SWDBG_SWDBG3(self)
...
class RM_Register_RAC_S_PAENCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.INVRFCLKTXDAC = RM_Field_RAC_S_PAENCTRL_INVRFCLKTXDAC(self)
...
class RM_Register_RAC_S_DCCAL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_DCCAL, self).__init__(rmio, label,
            0xa0220000, 0x0C4,
            'DCCAL', 'RAC_S.DCCAL', 'read-write',
            u"",
            0x00000000, 0xFFF01FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.DCRUN = RM_Field_RAC_S_DCCAL_DCRUN(self)
        self.zz_fdict['DCRUN'] = self.DCRUN
        self.DCBUSY = RM_Field_RAC_S_DCCAL_DCBUSY(self)
        self.zz_fdict['DCBUSY'] = self.DCBUSY
        self.DCDONE = RM_Field_RAC_S_DCCAL_DCDONE(self)
        self.zz_fdict['DCDONE'] = self.DCDONE
        self.MAXITERS = RM_Field_RAC_S_DCCAL_MAXITERS(self)
        self.zz_fdict['MAXITERS'] = self.MAXITERS
        self.SETTLECNT = RM_Field_RAC_S_DCCAL_SETTLECNT(self)
        self.zz_fdict['SETTLECNT'] = self.SETTLECNT
        self.DCPKDINV = RM_Field_RAC_S_DCCAL_DCPKDINV(self)
        self.zz_fdict['DCPKDINV'] = self.DCPKDINV
        self.DCCTRLOX = RM_Field_RAC_S_DCCAL_DCCTRLOX(self)
        self.zz_fdict['DCCTRLOX'] = self.DCCTRLOX
        self.OXICAL = RM_Field_RAC_S_DCCAL_OXICAL(self)
        self.zz_fdict['OXICAL'] = self.OXICAL
        self.OXQCAL = RM_Field_RAC_S_DCCAL_OXQCAL(self)
...
class RM_Register_RAC_S_DIGCLKRETIMECTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.ENCLKQSPIDIGCLK = RM_Field_RAC_S_DIGCLKRETIMECTRL_ENCLKQSPIDIGCLK(self)
        self.zz_fdict['ENCLKQSPIDIGCLK'] = self.ENCLKQSPIDIGCLK
        self.QSPIHIGHCOUNTDIGCLK = RM_Field_RAC_S_DIGCLKRETIMECTRL_QSPIHIGHCOUNTDIGCLK(self)
        self.zz_fdict['QSPIHIGHCOUNTDIGCLK'] = self.QSPIHIGHCOUNTDIGCLK
        self.QSPILOWCOUNTDIGCLK = RM_Field_RAC_S_DIGCLKRETIMECTRL_QSPILOWCOUNTDIGCLK(self)
...
class RM_Register_RAC_S_XORETIMECTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.ENCLKQSPIXO = RM_Field_RAC_S_XORETIMECTRL_ENCLKQSPIXO(self)
        self.zz_fdict['ENCLKQSPIXO'] = self.ENCLKQSPIXO
        self.QSPIHIGHCOUNTXO = RM_Field_RAC_S_XORETIMECTRL_QSPIHIGHCOUNTXO(self)
        self.zz_fdict['QSPIHIGHCOUNTXO'] = self.QSPIHIGHCOUNTXO
        self.QSPILOWCOUNTXO = RM_Field_RAC_S_XORETIMECTRL_QSPILOWCOUNTXO(self)
...
class RM_Register_RAC_S_SYDLFCTRL1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYDLFREADXIMAPPING = RM_Field_RAC_S_SYDLFCTRL1_SYDLFREADXIMAPPING(self)
...
class RM_Register_RAC_S_AUXADCCTRL2(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.IFADCDISABLECLK = RM_Field_RAC_S_AUXADCCTRL2_IFADCDISABLECLK(self)
        ...
        self.IFADCS2PRSTEDGE = RM_Field_RAC_S_AUXADCCTRL2_IFADCS2PRSTEDGE(self)
...
class RM_Register_RAC_S_SYDLFCTRL0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYDLFCONTRDEN = RM_Field_RAC_S_SYDLFCTRL0_SYDLFCONTRDEN(self)
        self.zz_fdict['SYDLFCONTRDEN'] = self.SYDLFCONTRDEN
        self.SYDLFRDPRDMAN = RM_Field_RAC_S_SYDLFCTRL0_SYDLFRDPRDMAN(self)
        self.zz_fdict['SYDLFRDPRDMAN'] = self.SYDLFRDPRDMAN
        self.SYDLFRDPRDEXP = RM_Field_RAC_S_SYDLFCTRL0_SYDLFRDPRDEXP(self)
        self.zz_fdict['SYDLFRDPRDEXP'] = self.SYDLFRDPRDEXP
        self.SYDLFRDDLY = RM_Field_RAC_S_SYDLFCTRL0_SYDLFRDDLY(self)
...
class RM_Register_RAC_S_SYLOCTRL1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYENLODIVHADMRXTXMAN = RM_Field_RAC_S_SYLOCTRL1_SYENLODIVHADMRXTXMAN(self)
...
class RM_Register_RAC_S_SYTRIM3(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYTDCREGTRIMVREGTX = RM_Field_RAC_S_SYTRIM3_SYTDCREGTRIMVREGTX(self)
        self.zz_fdict['SYTDCREGTRIMVREGTX'] = self.SYTDCREGTRIMVREGTX
        self.SYVCOREGTRIMVREGTX = RM_Field_RAC_S_SYTRIM3_SYVCOREGTRIMVREGTX(self)
...
class RM_Register_RAC_S_HFXOCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_HFXOCTRL, self).__init__(rmio, label,
            0xa0220000, 0x2DC,
            'HFXOCTRL', 'RAC_S.HFXOCTRL', 'read-write',
            u"",
            0x00000099, 0x000007FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.ENCLKSYANA = RM_Field_RAC_S_HFXOCTRL_ENCLKSYANA(self)
        self.zz_fdict['ENCLKSYANA'] = self.ENCLKSYANA
        self.ENCLKCLKMULTANA = RM_Field_RAC_S_HFXOCTRL_ENCLKCLKMULTANA(self)
        self.zz_fdict['ENCLKCLKMULTANA'] = self.ENCLKCLKMULTANA
        self.ENCLKDIFANA = RM_Field_RAC_S_HFXOCTRL_ENCLKDIFANA(self)
        self.zz_fdict['ENCLKDIFANA'] = self.ENCLKDIFANA
        self.SQBUFBIASANA = RM_Field_RAC_S_HFXOCTRL_SQBUFBIASANA(self)
        self.zz_fdict['SQBUFBIASANA'] = self.SQBUFBIASANA
        self.SQBUFBIASRESANA = RM_Field_RAC_S_HFXOCTRL_SQBUFBIASRESANA(self)
        self.zz_fdict['SQBUFBIASRESANA'] = self.SQBUFBIASRESANA
        self.SQBUFBIASANAOVR = RM_Field_RAC_S_HFXOCTRL_SQBUFBIASANAOVR(self)
        self.zz_fdict['SQBUFBIASANAOVR'] = self.SQBUFBIASANAOVR
        self.SQBUFBIASRESANAOVR = RM_Field_RAC_S_HFXOCTRL_SQBUFBIASRESANAOVR(self)
        self.zz_fdict['SQBUFBIASRESANAOVR'] = self.SQBUFBIASRESANAOVR
        self.SHUNTBIASANAHPEN = RM_Field_RAC_S_HFXOCTRL_SHUNTBIASANAHPEN(self)
        self.zz_fdict['SHUNTBIASANAHPEN'] = self.SHUNTBIASANAHPEN
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_HFRCORETIMECTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_HFRCORETIMECTRL, self).__init__(rmio, label,
            0xa0220000, 0x2E0,
            'HFRCORETIMECTRL', 'RAC_S.HFRCORETIMECTRL', 'read-write',
            u"",
            0x00000000, 0x0003FFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.HFRCORETIMEENRETIME = RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMEENRETIME(self)
        self.zz_fdict['HFRCORETIMEENRETIME'] = self.HFRCORETIMEENRETIME
        self.HFRCORETIMEDISRETIME = RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMEDISRETIME(self)
        self.zz_fdict['HFRCORETIMEDISRETIME'] = self.HFRCORETIMEDISRETIME
        self.HFRCORETIMERESETN = RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMERESETN(self)
        self.zz_fdict['HFRCORETIMERESETN'] = self.HFRCORETIMERESETN
        self.HFRCORETIMELIMITH = RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMELIMITH(self)
        self.zz_fdict['HFRCORETIMELIMITH'] = self.HFRCORETIMELIMITH
        self.HFRCORETIMELIMITL = RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMELIMITL(self)
        self.zz_fdict['HFRCORETIMELIMITL'] = self.HFRCORETIMELIMITL
        self.ENCLKQSPIHFRCOLPW = RM_Field_RAC_S_HFRCORETIMECTRL_ENCLKQSPIHFRCOLPW(self)
        self.zz_fdict['ENCLKQSPIHFRCOLPW'] = self.ENCLKQSPIHFRCOLPW
        self.QSPIHIGHCOUNTHFRCOLPW = RM_Field_RAC_S_HFRCORETIMECTRL_QSPIHIGHCOUNTHFRCOLPW(self)
        self.zz_fdict['QSPIHIGHCOUNTHFRCOLPW'] = self.QSPIHIGHCOUNTHFRCOLPW
        self.QSPILOWCOUNTHFRCOLPW = RM_Field_RAC_S_HFRCORETIMECTRL_QSPILOWCOUNTHFRCOLPW(self)
        self.zz_fdict['QSPILOWCOUNTHFRCOLPW'] = self.QSPILOWCOUNTHFRCOLPW
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_HFRCORETIMESTATUS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_HFRCORETIMESTATUS, self).__init__(rmio, label,
            0xa0220000, 0x2E4,
            'HFRCORETIMESTATUS', 'RAC_S.HFRCORETIMESTATUS', 'read-only',
            u"",
            0x00000000, 0x00000003,
            0x00001000, 0x00002000,
            0x00003000)

        self.HFRCORETIMECLKSEL = RM_Field_RAC_S_HFRCORETIMESTATUS_HFRCORETIMECLKSEL(self)
        self.zz_fdict['HFRCORETIMECLKSEL'] = self.HFRCORETIMECLKSEL
        self.HFRCORETIMERESETNLO = RM_Field_RAC_S_HFRCORETIMESTATUS_HFRCORETIMERESETNLO(self)
...
class RM_Register_RAC_S_AGCOVERWRITE2(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.ENMANTIACAPFB = RM_Field_RAC_S_AGCOVERWRITE2_ENMANTIACAPFB(self)
        self.zz_fdict['ENMANTIACAPFB'] = self.ENMANTIACAPFB
        self.MANTIACAPFB = RM_Field_RAC_S_AGCOVERWRITE2_MANTIACAPFB(self)
