...
class RM_Register_AGC_S_AGCPERIOD0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PERIODLOSTL = RM_Field_AGC_S_AGCPERIOD0_PERIODLOSTL(self)
...
class RM_Register_AGC_S_CTRL8(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RSSISHIFTP = RM_Field_AGC_S_CTRL8_RSSISHIFTP(self)
        self.zz_fdict['RSSISHIFTP'] = self.RSSISHIFTP
        self.RSSIVALIDMODE = RM_Field_AGC_S_CTRL8_RSSIVALIDMODE(self)
        self.zz_fdict['RSSIVALIDMODE'] = self.RSSIVALIDMODE
        self.EARLYRSSIMODE = RM_Field_AGC_S_CTRL8_EARLYRSSIMODE(self)
        self.zz_fdict['EARLYRSSIMODE'] = self.EARLYRSSIMODE
        self.GAINALIGNALWAYS = RM_Field_AGC_S_CTRL8_GAINALIGNALWAYS(self)
        self.zz_fdict['GAINALIGNALWAYS'] = self.GAINALIGNALWAYS
        self.CFLOOPMINGAIN = RM_Field_AGC_S_CTRL8_CFLOOPMINGAIN(self)
        self.zz_fdict['CFLOOPMINGAIN'] = self.CFLOOPMINGAIN
        self.PRSDEBUGEN2 = RM_Field_AGC_S_CTRL8_PRSDEBUGEN2(self)
...
class RM_Register_AGC_S_PNGAIN1(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_PNGAIN1, self).__init__(rmio, label,
            0xa020c000, 0x10C,
            'PNGAIN1', 'AGC_S.PNGAIN1', 'read-write',
            u"",
            0x10171E26, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.PNGAINDB1 = RM_Field_AGC_S_PNGAIN1_PNGAINDB1(self)
        self.zz_fdict['PNGAINDB1'] = self.PNGAINDB1
        self.PNGAINDB2 = RM_Field_AGC_S_PNGAIN1_PNGAINDB2(self)
        self.zz_fdict['PNGAINDB2'] = self.PNGAINDB2
        self.PNGAINDB3 = RM_Field_AGC_S_PNGAIN1_PNGAINDB3(self)
        self.zz_fdict['PNGAINDB3'] = self.PNGAINDB3
        self.PNGAINDB4 = RM_Field_AGC_S_PNGAIN1_PNGAINDB4(self)
        self.zz_fdict['PNGAINDB4'] = self.PNGAINDB4
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_PNGAIN2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_PNGAIN2, self).__init__(rmio, label,
            0xa020c000, 0x110,
            'PNGAIN2', 'AGC_S.PNGAIN2', 'read-write',
            u"",
            0xF0F8FF04, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.PNGAINDB5 = RM_Field_AGC_S_PNGAIN2_PNGAINDB5(self)
        self.zz_fdict['PNGAINDB5'] = self.PNGAINDB5
        self.PNGAINDB6 = RM_Field_AGC_S_PNGAIN2_PNGAINDB6(self)
        self.zz_fdict['PNGAINDB6'] = self.PNGAINDB6
        self.PNGAINDB7 = RM_Field_AGC_S_PNGAIN2_PNGAINDB7(self)
        self.zz_fdict['PNGAINDB7'] = self.PNGAINDB7
        self.PNGAINDB8 = RM_Field_AGC_S_PNGAIN2_PNGAINDB8(self)
        self.zz_fdict['PNGAINDB8'] = self.PNGAINDB8
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_PNGAIN3(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_PNGAIN3, self).__init__(rmio, label,
            0xa020c000, 0x114,
            'PNGAIN3', 'AGC_S.PNGAIN3', 'read-write',
            u"",
            0xCED7E0E8, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.PNGAINDB9 = RM_Field_AGC_S_PNGAIN3_PNGAINDB9(self)
        self.zz_fdict['PNGAINDB9'] = self.PNGAINDB9
        self.PNGAINDB10 = RM_Field_AGC_S_PNGAIN3_PNGAINDB10(self)
        self.zz_fdict['PNGAINDB10'] = self.PNGAINDB10
        self.PNGAINDB11 = RM_Field_AGC_S_PNGAIN3_PNGAINDB11(self)
        self.zz_fdict['PNGAINDB11'] = self.PNGAINDB11
        self.PNGAINDB12 = RM_Field_AGC_S_PNGAIN3_PNGAINDB12(self)
        self.zz_fdict['PNGAINDB12'] = self.PNGAINDB12
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_PNGAIN4(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_PNGAIN4, self).__init__(rmio, label,
            0xa020c000, 0x118,
            'PNGAIN4', 'AGC_S.PNGAIN4', 'read-write',
            u"",
            0xADB5BDC5, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.PNGAINDB13 = RM_Field_AGC_S_PNGAIN4_PNGAINDB13(self)
        self.zz_fdict['PNGAINDB13'] = self.PNGAINDB13
        self.PNGAINDB14 = RM_Field_AGC_S_PNGAIN4_PNGAINDB14(self)
        self.zz_fdict['PNGAINDB14'] = self.PNGAINDB14
        self.PNGAINDB15 = RM_Field_AGC_S_PNGAIN4_PNGAINDB15(self)
        self.zz_fdict['PNGAINDB15'] = self.PNGAINDB15
        self.PNGAINDB16 = RM_Field_AGC_S_PNGAIN4_PNGAINDB16(self)
        self.zz_fdict['PNGAINDB16'] = self.PNGAINDB16
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_LNAGAIN1(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_LNAGAIN1, self).__init__(rmio, label,
            0xa020c000, 0x11C,
            'LNAGAIN1', 'AGC_S.LNAGAIN1', 'read-write',
            u"",
            0x0C141C24, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.LNAGAINDB1 = RM_Field_AGC_S_LNAGAIN1_LNAGAINDB1(self)
        self.zz_fdict['LNAGAINDB1'] = self.LNAGAINDB1
        self.LNAGAINDB2 = RM_Field_AGC_S_LNAGAIN1_LNAGAINDB2(self)
        self.zz_fdict['LNAGAINDB2'] = self.LNAGAINDB2
        self.LNAGAINDB3 = RM_Field_AGC_S_LNAGAIN1_LNAGAINDB3(self)
        self.zz_fdict['LNAGAINDB3'] = self.LNAGAINDB3
        self.LNAGAINDB4 = RM_Field_AGC_S_LNAGAIN1_LNAGAINDB4(self)
        self.zz_fdict['LNAGAINDB4'] = self.LNAGAINDB4
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_LNAGAIN2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_LNAGAIN2, self).__init__(rmio, label,
            0xa020c000, 0x120,
            'LNAGAIN2', 'AGC_S.LNAGAIN2', 'read-write',
            u"",
            0xEBF4FC04, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.LNAGAINDB5 = RM_Field_AGC_S_LNAGAIN2_LNAGAINDB5(self)
        self.zz_fdict['LNAGAINDB5'] = self.LNAGAINDB5
        self.LNAGAINDB6 = RM_Field_AGC_S_LNAGAIN2_LNAGAINDB6(self)
        self.zz_fdict['LNAGAINDB6'] = self.LNAGAINDB6
        self.LNAGAINDB7 = RM_Field_AGC_S_LNAGAIN2_LNAGAINDB7(self)
        self.zz_fdict['LNAGAINDB7'] = self.LNAGAINDB7
        self.LNAGAINDB8 = RM_Field_AGC_S_LNAGAIN2_LNAGAINDB8(self)
        self.zz_fdict['LNAGAINDB8'] = self.LNAGAINDB8
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_LNAGAIN3(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_LNAGAIN3, self).__init__(rmio, label,
            0xa020c000, 0x124,
            'LNAGAIN3', 'AGC_S.LNAGAIN3', 'read-write',
            u"",
            0x0000DBE3, 0x0000FFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.LNAGAINDB9 = RM_Field_AGC_S_LNAGAIN3_LNAGAINDB9(self)
        self.zz_fdict['LNAGAINDB9'] = self.LNAGAINDB9
        self.LNAGAINDB10 = RM_Field_AGC_S_LNAGAIN3_LNAGAINDB10(self)
        self.zz_fdict['LNAGAINDB10'] = self.LNAGAINDB10
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_TIACODE2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_TIACODE2, self).__init__(rmio, label,
            0xa020c000, 0x128,
            'TIACODE2', 'AGC_S.TIACODE2', 'read-write',
            u"",
            0x211A1410, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.TIACAPFB1 = RM_Field_AGC_S_TIACODE2_TIACAPFB1(self)
        self.zz_fdict['TIACAPFB1'] = self.TIACAPFB1
        self.TIACAPFB2 = RM_Field_AGC_S_TIACODE2_TIACAPFB2(self)
        self.zz_fdict['TIACAPFB2'] = self.TIACAPFB2
        self.TIACAPFB3 = RM_Field_AGC_S_TIACODE2_TIACAPFB3(self)
        self.zz_fdict['TIACAPFB3'] = self.TIACAPFB3
        self.TIACAPFB4 = RM_Field_AGC_S_TIACODE2_TIACAPFB4(self)
        self.zz_fdict['TIACAPFB4'] = self.TIACAPFB4
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_TIACODE3(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_TIACODE3, self).__init__(rmio, label,
            0xa020c000, 0x12C,
            'TIACODE3', 'AGC_S.TIACODE3', 'read-write',
            u"",
            0x51403429, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.TIACAPFB5 = RM_Field_AGC_S_TIACODE3_TIACAPFB5(self)
        self.zz_fdict['TIACAPFB5'] = self.TIACAPFB5
        self.TIACAPFB6 = RM_Field_AGC_S_TIACODE3_TIACAPFB6(self)
        self.zz_fdict['TIACAPFB6'] = self.TIACAPFB6
        self.TIACAPFB7 = RM_Field_AGC_S_TIACODE3_TIACAPFB7(self)
        self.zz_fdict['TIACAPFB7'] = self.TIACAPFB7
        self.TIACAPFB8 = RM_Field_AGC_S_TIACODE3_TIACAPFB8(self)
        self.zz_fdict['TIACAPFB8'] = self.TIACAPFB8
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_TIACODE4(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_TIACODE4, self).__init__(rmio, label,
            0xa020c000, 0x130,
            'TIACODE4', 'AGC_S.TIACODE4', 'read-write',
            u"",
            0x009B7E67, 0x00FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.TIACAPFB9 = RM_Field_AGC_S_TIACODE4_TIACAPFB9(self)
        self.zz_fdict['TIACAPFB9'] = self.TIACAPFB9
        self.TIACAPFB10 = RM_Field_AGC_S_TIACODE4_TIACAPFB10(self)
        self.zz_fdict['TIACAPFB10'] = self.TIACAPFB10
        self.TIACAPFB11 = RM_Field_AGC_S_TIACODE4_TIACAPFB11(self)
        self.zz_fdict['TIACAPFB11'] = self.TIACAPFB11
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_PGAGAIN1(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_PGAGAIN1, self).__init__(rmio, label,
            0xa020c000, 0x134,
            'PGAGAIN1', 'AGC_S.PGAGAIN1', 'read-write',
            u"",
            0x01E10088, 0x07FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.PGAGAINDB1 = RM_Field_AGC_S_PGAGAIN1_PGAGAINDB1(self)
        self.zz_fdict['PGAGAINDB1'] = self.PGAGAINDB1
        self.PGAGAINDB2 = RM_Field_AGC_S_PGAGAIN1_PGAGAINDB2(self)
        self.zz_fdict['PGAGAINDB2'] = self.PGAGAINDB2
        self.PGAGAINDB3 = RM_Field_AGC_S_PGAGAIN1_PGAGAINDB3(self)
        self.zz_fdict['PGAGAINDB3'] = self.PGAGAINDB3
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_PGAGAIN2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_PGAGAIN2, self).__init__(rmio, label,
            0xa020c000, 0x138,
            'PGAGAIN2', 'AGC_S.PGAGAIN2', 'read-write',
            u"",
            0x0180D070, 0x07FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.PGAGAINDB4 = RM_Field_AGC_S_PGAGAIN2_PGAGAINDB4(self)
        self.zz_fdict['PGAGAINDB4'] = self.PGAGAINDB4
        self.PGAGAINDB5 = RM_Field_AGC_S_PGAGAIN2_PGAGAINDB5(self)
        self.zz_fdict['PGAGAINDB5'] = self.PGAGAINDB5
        self.PGAGAINDB6 = RM_Field_AGC_S_PGAGAIN2_PGAGAINDB6(self)
        self.zz_fdict['PGAGAINDB6'] = self.PGAGAINDB6
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_PGAGAIN3(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_PGAGAIN3, self).__init__(rmio, label,
            0xa020c000, 0x13C,
            'PGAGAIN3', 'AGC_S.PGAGAIN3', 'read-write',
            u"",
            0x0120A058, 0x07FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.PGAGAINDB7 = RM_Field_AGC_S_PGAGAIN3_PGAGAINDB7(self)
        self.zz_fdict['PGAGAINDB7'] = self.PGAGAINDB7
        self.PGAGAINDB8 = RM_Field_AGC_S_PGAGAIN3_PGAGAINDB8(self)
        self.zz_fdict['PGAGAINDB8'] = self.PGAGAINDB8
        self.PGAGAINDB9 = RM_Field_AGC_S_PGAGAIN3_PGAGAINDB9(self)
        self.zz_fdict['PGAGAINDB9'] = self.PGAGAINDB9
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_PGAGAIN4(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_PGAGAIN4, self).__init__(rmio, label,
            0xa020c000, 0x140,
            'PGAGAIN4', 'AGC_S.PGAGAIN4', 'read-write',
            u"",
            0x00007040, 0x0003FFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.PGAGAINDB10 = RM_Field_AGC_S_PGAGAIN4_PGAGAINDB10(self)
        self.zz_fdict['PGAGAINDB10'] = self.PGAGAINDB10
        self.PGAGAINDB11 = RM_Field_AGC_S_PGAGAIN4_PGAGAINDB11(self)
        self.zz_fdict['PGAGAINDB11'] = self.PGAGAINDB11
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_ADC0(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_ADC0, self).__init__(rmio, label,
            0xa020c000, 0x144,
            'ADC0', 'AGC_S.ADC0', 'read-write',
            u"",
            0x06A30E00, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.ADCGAINDB0 = RM_Field_AGC_S_ADC0_ADCGAINDB0(self)
        self.zz_fdict['ADCGAINDB0'] = self.ADCGAINDB0
        self.ADCGAINDB1 = RM_Field_AGC_S_ADC0_ADCGAINDB1(self)
        self.zz_fdict['ADCGAINDB1'] = self.ADCGAINDB1
        self.ADCGAINDB2 = RM_Field_AGC_S_ADC0_ADCGAINDB2(self)
        self.zz_fdict['ADCGAINDB2'] = self.ADCGAINDB2
        self.ADCGAINDB3 = RM_Field_AGC_S_ADC0_ADCGAINDB3(self)
        self.zz_fdict['ADCGAINDB3'] = self.ADCGAINDB3
        self.ADCSCALE0 = RM_Field_AGC_S_ADC0_ADCSCALE0(self)
        self.zz_fdict['ADCSCALE0'] = self.ADCSCALE0
        self.ADCSCALE1 = RM_Field_AGC_S_ADC0_ADCSCALE1(self)
        self.zz_fdict['ADCSCALE1'] = self.ADCSCALE1
        self.ADCSCALE2 = RM_Field_AGC_S_ADC0_ADCSCALE2(self)
        self.zz_fdict['ADCSCALE2'] = self.ADCSCALE2
        self.ADCSCALE3 = RM_Field_AGC_S_ADC0_ADCSCALE3(self)
