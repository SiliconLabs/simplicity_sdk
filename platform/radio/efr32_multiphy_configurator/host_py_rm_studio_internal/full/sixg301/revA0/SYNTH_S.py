...
class RM_Peripheral_SYNTH_S(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.FSWIF = RM_Register_SYNTH_S_FSWIF(self.zz_rmio, self.zz_label)
        self.zz_rdict['FSWIF'] = self.FSWIF
        self.FSWIEN = RM_Register_SYNTH_S_FSWIEN(self.zz_rmio, self.zz_label)
        ...
        self.SPARE = RM_Register_SYNTH_S_SPARE(self.zz_rmio, self.zz_label)
