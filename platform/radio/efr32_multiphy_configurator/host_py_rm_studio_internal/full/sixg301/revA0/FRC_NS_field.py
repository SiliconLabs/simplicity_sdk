...
class RM_Field_FRC_NS_CTRL_RXABORTHWBEH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_NS_CTRL_RXABORTHWBEH, self).__init__(register,
            'RXABORTHWBEH', 'FRC_NS.CTRL.RXABORTHWBEH', 'read-write',
            u"",
            15, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_FRC_NS_CTRL_RXABORTHWSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_NS_CTRL_RXABORTHWSEL, self).__init__(register,
            'RXABORTHWSEL', 'FRC_NS.CTRL.RXABORTHWSEL', 'read-write',
            u"",
            22, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_FRC_NS_CTRL_RXABORTHWDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_NS_CTRL_RXABORTHWDIS, self).__init__(register,
            'RXABORTHWDIS', 'FRC_NS.CTRL.RXABORTHWDIS', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
