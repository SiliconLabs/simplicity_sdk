...
class RM_Field_SYNTH_S_FSWIF_LOCKED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIF_LOCKED, self).__init__(register,
            'LOCKED', 'SYNTH_S.FSWIF.LOCKED', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_FSWIF_UNLOCKED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIF_UNLOCKED, self).__init__(register,
            'UNLOCKED', 'SYNTH_S.FSWIF.UNLOCKED', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_FSWIF_SYRDY(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIF_SYRDY, self).__init__(register,
            'SYRDY', 'SYNTH_S.FSWIF.SYRDY', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_FSWIF_VCOHIGH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIF_VCOHIGH, self).__init__(register,
            'VCOHIGH', 'SYNTH_S.FSWIF.VCOHIGH', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_FSWIF_VCOLOW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIF_VCOLOW, self).__init__(register,
            'VCOLOW', 'SYNTH_S.FSWIF.VCOLOW', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_FSWIF_LOCNTDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIF_LOCNTDONE, self).__init__(register,
            'LOCNTDONE', 'SYNTH_S.FSWIF.LOCNTDONE', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_FSWIF_FCALDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIF_FCALDONE, self).__init__(register,
            'FCALDONE', 'SYNTH_S.FSWIF.FCALDONE', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_FSWIEN_LOCKED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIEN_LOCKED, self).__init__(register,
            'LOCKED', 'SYNTH_S.FSWIEN.LOCKED', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_FSWIEN_UNLOCKED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIEN_UNLOCKED, self).__init__(register,
            'UNLOCKED', 'SYNTH_S.FSWIEN.UNLOCKED', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_FSWIEN_SYRDY(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIEN_SYRDY, self).__init__(register,
            'SYRDY', 'SYNTH_S.FSWIEN.SYRDY', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_FSWIEN_VCOHIGH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIEN_VCOHIGH, self).__init__(register,
            'VCOHIGH', 'SYNTH_S.FSWIEN.VCOHIGH', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_FSWIEN_VCOLOW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIEN_VCOLOW, self).__init__(register,
            'VCOLOW', 'SYNTH_S.FSWIEN.VCOLOW', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_FSWIEN_LOCNTDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIEN_LOCNTDONE, self).__init__(register,
            'LOCNTDONE', 'SYNTH_S.FSWIEN.LOCNTDONE', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_FSWIEN_FCALDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FSWIEN_FCALDONE, self).__init__(register,
            'FCALDONE', 'SYNTH_S.FSWIEN.FCALDONE', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_SYNTH_S_CTRL_FORCECLKXOSCEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_CTRL_FORCECLKXOSCEN, self).__init__(register,
            'FORCECLKXOSCEN', 'SYNTH_S.CTRL.FORCECLKXOSCEN', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_SYNTH_S_DSMCTRLRX_QNCMODERX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_DSMCTRLRX_QNCMODERX, self).__init__(register,
            'QNCMODERX', 'SYNTH_S.DSMCTRLRX.QNCMODERX', 'read-write',
            u"",
            7, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_DSMCTRLRX_GLMSOVERRIDEVALRX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_DSMCTRLRX_GLMSOVERRIDEVALRX, self).__init__(register,
            'GLMSOVERRIDEVALRX', 'SYNTH_S.DSMCTRLRX.GLMSOVERRIDEVALRX', 'read-write',
            u"",
            9, 13)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_SYNTH_S_DSMCTRLTX_QNCMODETX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_DSMCTRLTX_QNCMODETX, self).__init__(register,
            'QNCMODETX', 'SYNTH_S.DSMCTRLTX.QNCMODETX', 'read-write',
            u"",
            7, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_SYNTH_S_DSMCTRLTX_GLMSOVERRIDEVALTX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_DSMCTRLTX_GLMSOVERRIDEVALTX, self).__init__(register,
            'GLMSOVERRIDEVALTX', 'SYNTH_S.DSMCTRLTX.GLMSOVERRIDEVALTX', 'read-write',
            u"",
            9, 13)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_SYNTH_S_FCALCTRL_FCALRST(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_FCALCTRL_FCALRST, self).__init__(register,
            'FCALRST', 'SYNTH_S.FCALCTRL.FCALRST', 'write-only',
            u"",
            24, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_SYNTH_S_SPARE_SPARE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_S_SPARE_SPARE, self).__init__(register,
            'SPARE', 'SYNTH_S.SPARE.SPARE', 'read-write',
            u"",
            0, 8)
        self.__dict__['zz_frozen'] = True
