...
class RM_Register_FRC_S_CTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RXABORTHWBEH = RM_Field_FRC_S_CTRL_RXABORTHWBEH(self)
        ...
        self.RXABORTHWSEL = RM_Field_FRC_S_CTRL_RXABORTHWSEL(self)
        ...
        self.RXABORTHWDIS = RM_Field_FRC_S_CTRL_RXABORTHWDIS(self)
