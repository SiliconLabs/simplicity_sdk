...
class RM_Register_MODEM_S_IF2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_IF2, self).__init__(rmio, label,
            0xa0214000, 0x00C,
            'IF2', 'MODEM_S.IF2', 'read-write',
            u"",
            0x00000000, 0x00000001,
            0x00001000, 0x00002000,
            0x00003000)

        self.AMPAVERAGERDONEIF = RM_Field_MODEM_S_IF2_AMPAVERAGERDONEIF(self)
...
class RM_Register_MODEM_S_IEN2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_IEN2, self).__init__(rmio, label,
            0xa0214000, 0x014,
            'IEN2', 'MODEM_S.IEN2', 'read-write',
            u"",
            0x00000000, 0x00000001,
            0x00001000, 0x00002000,
            0x00003000)

        self.AMPAVERAGERDONEIEN = RM_Field_MODEM_S_IEN2_AMPAVERAGERDONEIEN(self)
...
class RM_Register_MODEM_S_SEQIF2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_SEQIF2, self).__init__(rmio, label,
            0xa0214000, 0x01C,
            'SEQIF2', 'MODEM_S.SEQIF2', 'read-write',
            u"",
            0x00000000, 0x00000001,
            0x00001000, 0x00002000,
            0x00003000)

        self.AMPAVERAGERDONESEQIF = RM_Field_MODEM_S_SEQIF2_AMPAVERAGERDONESEQIF(self)
...
class RM_Register_MODEM_S_SEQIEN2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_SEQIEN2, self).__init__(rmio, label,
            0xa0214000, 0x024,
            'SEQIEN2', 'MODEM_S.SEQIEN2', 'read-write',
            u"",
            0x00000000, 0x00000001,
            0x00001000, 0x00002000,
            0x00003000)

        self.AMPAVERAGERDONESEQIEN = RM_Field_MODEM_S_SEQIEN2_AMPAVERAGERDONESEQIEN(self)
...
class RM_Register_MODEM_S_STATUS3(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TXTIMTESTERRLAT = RM_Field_MODEM_S_STATUS3_TXTIMTESTERRLAT(self)
...
class RM_Register_MODEM_S_CTRL5(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.AFIFOBYP = RM_Field_MODEM_S_CTRL5_AFIFOBYP(self)
        ...
        self.FEFILTCLKSEL = RM_Field_MODEM_S_CTRL5_FEFILTCLKSEL(self)
...
class RM_Register_MODEM_S_RAMPCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RAMPDISRST = RM_Field_MODEM_S_RAMPCTRL_RAMPDISRST(self)
        ...
        self.RAMPMODE = RM_Field_MODEM_S_RAMPCTRL_RAMPMODE(self)
...
class RM_Register_MODEM_S_RAMPLEV(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RAMPLEVOFFS = RM_Field_MODEM_S_RAMPLEV_RAMPLEVOFFS(self)
...
class RM_Register_MODEM_S_ETSCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.CAPTRIGSAMP = RM_Field_MODEM_S_ETSCTRL_CAPTRIGSAMP(self)
        self.zz_fdict['CAPTRIGSAMP'] = self.CAPTRIGSAMP
        self.CAPTRIGCONDBYP = RM_Field_MODEM_S_ETSCTRL_CAPTRIGCONDBYP(self)
...
class RM_Register_MODEM_S_CHFCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.ADJGAINWIN = RM_Field_MODEM_S_CHFCTRL_ADJGAINWIN(self)
...
class RM_Register_MODEM_S_FRMSCHTIME(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RXDTIMLOSDETTHD = RM_Field_MODEM_S_FRMSCHTIME_RXDTIMLOSDETTHD(self)
...
class RM_Register_MODEM_S_SICTRL0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYMIDENTDIS = RM_Field_MODEM_S_SICTRL0_SYMIDENTDIS(self)
...
class RM_Register_MODEM_S_SICTRL1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.FREQOFFTOLERANCE = RM_Field_MODEM_S_SICTRL1_FREQOFFTOLERANCE(self)
...
class RM_Register_MODEM_S_SICTRL2(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SISTARTDELAYMODE = RM_Field_MODEM_S_SICTRL2_SISTARTDELAYMODE(self)
...
class RM_Register_MODEM_S_ECACTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_ECACTRL, self).__init__(rmio, label,
            0xa0214000, 0x28C,
            'ECACTRL', 'MODEM_S.ECACTRL', 'read-write',
            u"",
            0x00000000, 0x0000003F,
            0x00001000, 0x00002000,
            0x00003000)

        self.FEFILTDBGSEL = RM_Field_MODEM_S_ECACTRL_FEFILTDBGSEL(self)
        self.zz_fdict['FEFILTDBGSEL'] = self.FEFILTDBGSEL
        self.FEFILTDBGLSB = RM_Field_MODEM_S_ECACTRL_FEFILTDBGLSB(self)
        self.zz_fdict['FEFILTDBGLSB'] = self.FEFILTDBGLSB
        self.ECADEMODSEL = RM_Field_MODEM_S_ECACTRL_ECADEMODSEL(self)
...
class RM_Register_MODEM_S_HADMCTRL0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TGUARDPERIOD = RM_Field_MODEM_S_HADMCTRL0_TGUARDPERIOD(self)
        self.zz_fdict['TGUARDPERIOD'] = self.TGUARDPERIOD
        self.TEXCL = RM_Field_MODEM_S_HADMCTRL0_TEXCL(self)
        self.zz_fdict['TEXCL'] = self.TEXCL
        self.TSWITCH = RM_Field_MODEM_S_HADMCTRL0_TSWITCH(self)
        self.zz_fdict['TSWITCH'] = self.TSWITCH
        self.TGRPDLY = RM_Field_MODEM_S_HADMCTRL0_TGRPDLY(self)
        self.zz_fdict['TGRPDLY'] = self.TGRPDLY
        self.ACI = RM_Field_MODEM_S_HADMCTRL0_ACI(self)
...
class RM_Register_MODEM_S_HADMCTRL1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.API = RM_Field_MODEM_S_HADMCTRL1_API(self)
...
class RM_Register_MODEM_S_HADMSTATUS6(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TONEQUALITY = RM_Field_MODEM_S_HADMSTATUS6_TONEQUALITY(self)
...
class RM_Register_MODEM_S_HADMCTRL2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_HADMCTRL2, self).__init__(rmio, label,
            0xa0214000, 0x3E4,
            'HADMCTRL2', 'MODEM_S.HADMCTRL2', 'read-write',
            u"",
            0x00000000, 0x7FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.TONEQUALITYTHRESH = RM_Field_MODEM_S_HADMCTRL2_TONEQUALITYTHRESH(self)
        self.zz_fdict['TONEQUALITYTHRESH'] = self.TONEQUALITYTHRESH
        self.PHASEPERCHANNEL = RM_Field_MODEM_S_HADMCTRL2_PHASEPERCHANNEL(self)
        self.zz_fdict['PHASEPERCHANNEL'] = self.PHASEPERCHANNEL
        self.CHNO = RM_Field_MODEM_S_HADMCTRL2_CHNO(self)
        self.zz_fdict['CHNO'] = self.CHNO
        self.OWRRSTDLO = RM_Field_MODEM_S_HADMCTRL2_OWRRSTDLO(self)
        self.zz_fdict['OWRRSTDLO'] = self.OWRRSTDLO
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_S_HADMCTRL3(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_HADMCTRL3, self).__init__(rmio, label,
            0xa0214000, 0x3E8,
            'HADMCTRL3', 'MODEM_S.HADMCTRL3', 'read-write',
            u"",
            0x00000000, 0x00FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.ANTVALHADM = RM_Field_MODEM_S_HADMCTRL3_ANTVALHADM(self)
        self.zz_fdict['ANTVALHADM'] = self.ANTVALHADM
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_S_HADMCTRL4(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_HADMCTRL4, self).__init__(rmio, label,
            0xa0214000, 0x3EC,
            'HADMCTRL4', 'MODEM_S.HADMCTRL4', 'read-write',
            u"",
            0x00000000, 0xFE003FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.RTTMODE = RM_Field_MODEM_S_HADMCTRL4_RTTMODE(self)
        self.zz_fdict['RTTMODE'] = self.RTTMODE
        self.RTTLEN = RM_Field_MODEM_S_HADMCTRL4_RTTLEN(self)
        self.zz_fdict['RTTLEN'] = self.RTTLEN
        self.CSSYNCANTSEL = RM_Field_MODEM_S_HADMCTRL4_CSSYNCANTSEL(self)
        self.zz_fdict['CSSYNCANTSEL'] = self.CSSYNCANTSEL
        self.RBSTRACKNUM = RM_Field_MODEM_S_HADMCTRL4_RBSTRACKNUM(self)
        self.zz_fdict['RBSTRACKNUM'] = self.RBSTRACKNUM
        self.RTTTIMEOUT = RM_Field_MODEM_S_HADMCTRL4_RTTTIMEOUT(self)
        self.zz_fdict['RTTTIMEOUT'] = self.RTTTIMEOUT
        self.PBRSEL = RM_Field_MODEM_S_HADMCTRL4_PBRSEL(self)
        self.zz_fdict['PBRSEL'] = self.PBRSEL
        self.RTTSEL = RM_Field_MODEM_S_HADMCTRL4_RTTSEL(self)
        self.zz_fdict['RTTSEL'] = self.RTTSEL
        self.DBGSEL = RM_Field_MODEM_S_HADMCTRL4_DBGSEL(self)
        self.zz_fdict['DBGSEL'] = self.DBGSEL
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_S_HADMSTATUS7(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_HADMSTATUS7, self).__init__(rmio, label,
            0xa0214000, 0x3F0,
            'HADMSTATUS7', 'MODEM_S.HADMSTATUS7', 'read-only',
            u"",
            0x00000000, 0x3FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.COSTLATE2 = RM_Field_MODEM_S_HADMSTATUS7_COSTLATE2(self)
        self.zz_fdict['COSTLATE2'] = self.COSTLATE2
        self.COSTCURR2 = RM_Field_MODEM_S_HADMSTATUS7_COSTCURR2(self)
        self.zz_fdict['COSTCURR2'] = self.COSTCURR2
        self.COSTEARL2 = RM_Field_MODEM_S_HADMSTATUS7_COSTEARL2(self)
        self.zz_fdict['COSTEARL2'] = self.COSTEARL2
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_S_HADMCTRL5(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_HADMCTRL5, self).__init__(rmio, label,
            0xa0214000, 0x3F4,
            'HADMCTRL5', 'MODEM_S.HADMCTRL5', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.DCCOMPI = RM_Field_MODEM_S_HADMCTRL5_DCCOMPI(self)
        self.zz_fdict['DCCOMPI'] = self.DCCOMPI
        self.DCCOMPQ = RM_Field_MODEM_S_HADMCTRL5_DCCOMPQ(self)
...
class RM_Register_MODEM_S_EHDSSSCFG3(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LQIAVGWIN = RM_Field_MODEM_S_EHDSSSCFG3_LQIAVGWIN(self)
...
class RM_Register_MODEM_S_TXCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_TXCTRL, self).__init__(rmio, label,
            0xa0214000, 0x4A0,
            'TXCTRL', 'MODEM_S.TXCTRL', 'read-write',
            u"",
            0x00000018, 0xC000007F,
            0x00001000, 0x00002000,
            0x00003000)

        self.TXMOD = RM_Field_MODEM_S_TXCTRL_TXMOD(self)
        self.zz_fdict['TXMOD'] = self.TXMOD
        self.BR2M = RM_Field_MODEM_S_TXCTRL_BR2M(self)
        self.zz_fdict['BR2M'] = self.BR2M
        self.FORCECLKEN = RM_Field_MODEM_S_TXCTRL_FORCECLKEN(self)
        self.zz_fdict['FORCECLKEN'] = self.FORCECLKEN
        self.TXINTPEN = RM_Field_MODEM_S_TXCTRL_TXINTPEN(self)
        self.zz_fdict['TXINTPEN'] = self.TXINTPEN
        self.TXDSEN = RM_Field_MODEM_S_TXCTRL_TXDSEN(self)
        self.zz_fdict['TXDSEN'] = self.TXDSEN
        self.TXAFIFOBYP = RM_Field_MODEM_S_TXCTRL_TXAFIFOBYP(self)
        self.zz_fdict['TXAFIFOBYP'] = self.TXAFIFOBYP
        self.TXTIMTESTEN = RM_Field_MODEM_S_TXCTRL_TXTIMTESTEN(self)
        self.zz_fdict['TXTIMTESTEN'] = self.TXTIMTESTEN
        self.TXDOFORCEI = RM_Field_MODEM_S_TXCTRL_TXDOFORCEI(self)
        self.zz_fdict['TXDOFORCEI'] = self.TXDOFORCEI
        self.TXDOFORCEQ = RM_Field_MODEM_S_TXCTRL_TXDOFORCEQ(self)
...
class RM_Register_MODEM_S_TXCORRSTATIC(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_TXCORRSTATIC, self).__init__(rmio, label,
            0xa0214000, 0x4A8,
            'TXCORRSTATIC', 'MODEM_S.TXCORRSTATIC', 'read-write',
            u"",
            0x000000C0, 0x07FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.TXDGAIN6DB = RM_Field_MODEM_S_TXCORRSTATIC_TXDGAIN6DB(self)
        self.zz_fdict['TXDGAIN6DB'] = self.TXDGAIN6DB
        self.TXDGAIN = RM_Field_MODEM_S_TXCORRSTATIC_TXDGAIN(self)
        self.zz_fdict['TXDGAIN'] = self.TXDGAIN
        self.TXINVCORDICIN = RM_Field_MODEM_S_TXCORRSTATIC_TXINVCORDICIN(self)
        self.zz_fdict['TXINVCORDICIN'] = self.TXINVCORDICIN
        self.TXIQSWAP = RM_Field_MODEM_S_TXCORRSTATIC_TXIQSWAP(self)
        self.zz_fdict['TXIQSWAP'] = self.TXIQSWAP
        self.TXDACFORMAT = RM_Field_MODEM_S_TXCORRSTATIC_TXDACFORMAT(self)
        self.zz_fdict['TXDACFORMAT'] = self.TXDACFORMAT
        self.TXFREQCORR = RM_Field_MODEM_S_TXCORRSTATIC_TXFREQCORR(self)
        self.zz_fdict['TXFREQCORR'] = self.TXFREQCORR
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_S_TXCORRPTE(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_TXCORRPTE, self).__init__(rmio, label,
            0xa0214000, 0x4AC,
            'TXCORRPTE', 'MODEM_S.TXCORRPTE', 'read-write',
            u"",
            0x00000000, 0x1FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.TXIQIMBEN = RM_Field_MODEM_S_TXCORRPTE_TXIQIMBEN(self)
        self.zz_fdict['TXIQIMBEN'] = self.TXIQIMBEN
        self.TXGAINIMB = RM_Field_MODEM_S_TXCORRPTE_TXGAINIMB(self)
        self.zz_fdict['TXGAINIMB'] = self.TXGAINIMB
        self.TXPHSIMB = RM_Field_MODEM_S_TXCORRPTE_TXPHSIMB(self)
        self.zz_fdict['TXPHSIMB'] = self.TXPHSIMB
        self.TXDCI = RM_Field_MODEM_S_TXCORRPTE_TXDCI(self)
        self.zz_fdict['TXDCI'] = self.TXDCI
        self.TXDCQ = RM_Field_MODEM_S_TXCORRPTE_TXDCQ(self)
...
class RM_Register_MODEM_S_COMMANDS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_COMMANDS, self).__init__(rmio, label,
            0xa0214000, 0x580,
            'COMMANDS', 'MODEM_S.COMMANDS', 'write-only',
            u"",
            0x00000000, 0x00000003,
            0x00001000, 0x00002000,
            0x00003000)

        self.START = RM_Field_MODEM_S_COMMANDS_START(self)
        self.zz_fdict['START'] = self.START
        self.ABORT = RM_Field_MODEM_S_COMMANDS_ABORT(self)
        self.zz_fdict['ABORT'] = self.ABORT
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_S_AMPAVERAGERCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_AMPAVERAGERCTRL, self).__init__(rmio, label,
            0xa0214000, 0x584,
            'AMPAVERAGERCTRL', 'MODEM_S.AMPAVERAGERCTRL', 'read-write',
            u"",
            0x00000000, 0x0000000F,
            0x00001000, 0x00002000,
            0x00003000)

        self.ENAMPAVERAGER = RM_Field_MODEM_S_AMPAVERAGERCTRL_ENAMPAVERAGER(self)
        self.zz_fdict['ENAMPAVERAGER'] = self.ENAMPAVERAGER
        self.NUMCYCLES = RM_Field_MODEM_S_AMPAVERAGERCTRL_NUMCYCLES(self)
        self.zz_fdict['NUMCYCLES'] = self.NUMCYCLES
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_S_RESULT(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_RESULT, self).__init__(rmio, label,
            0xa0214000, 0x588,
            'RESULT', 'MODEM_S.RESULT', 'read-only',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.RESULT = RM_Field_MODEM_S_RESULT_RESULT(self)
