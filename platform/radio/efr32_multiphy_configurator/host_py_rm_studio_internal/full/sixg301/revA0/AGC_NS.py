...
class RM_Peripheral_AGC_NS(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.PNGAIN1 = RM_Register_AGC_NS_PNGAIN1(self.zz_rmio, self.zz_label)
        self.zz_rdict['PNGAIN1'] = self.PNGAIN1
        self.PNGAIN2 = RM_Register_AGC_NS_PNGAIN2(self.zz_rmio, self.zz_label)
        self.zz_rdict['PNGAIN2'] = self.PNGAIN2
        self.PNGAIN3 = RM_Register_AGC_NS_PNGAIN3(self.zz_rmio, self.zz_label)
        self.zz_rdict['PNGAIN3'] = self.PNGAIN3
        self.PNGAIN4 = RM_Register_AGC_NS_PNGAIN4(self.zz_rmio, self.zz_label)
        self.zz_rdict['PNGAIN4'] = self.PNGAIN4
        self.LNAGAIN1 = RM_Register_AGC_NS_LNAGAIN1(self.zz_rmio, self.zz_label)
        self.zz_rdict['LNAGAIN1'] = self.LNAGAIN1
        self.LNAGAIN2 = RM_Register_AGC_NS_LNAGAIN2(self.zz_rmio, self.zz_label)
        self.zz_rdict['LNAGAIN2'] = self.LNAGAIN2
        self.LNAGAIN3 = RM_Register_AGC_NS_LNAGAIN3(self.zz_rmio, self.zz_label)
        self.zz_rdict['LNAGAIN3'] = self.LNAGAIN3
        self.TIACODE2 = RM_Register_AGC_NS_TIACODE2(self.zz_rmio, self.zz_label)
        self.zz_rdict['TIACODE2'] = self.TIACODE2
        self.TIACODE3 = RM_Register_AGC_NS_TIACODE3(self.zz_rmio, self.zz_label)
        self.zz_rdict['TIACODE3'] = self.TIACODE3
        self.TIACODE4 = RM_Register_AGC_NS_TIACODE4(self.zz_rmio, self.zz_label)
        self.zz_rdict['TIACODE4'] = self.TIACODE4
        self.PGAGAIN1 = RM_Register_AGC_NS_PGAGAIN1(self.zz_rmio, self.zz_label)
        self.zz_rdict['PGAGAIN1'] = self.PGAGAIN1
        self.PGAGAIN2 = RM_Register_AGC_NS_PGAGAIN2(self.zz_rmio, self.zz_label)
        self.zz_rdict['PGAGAIN2'] = self.PGAGAIN2
        self.PGAGAIN3 = RM_Register_AGC_NS_PGAGAIN3(self.zz_rmio, self.zz_label)
        self.zz_rdict['PGAGAIN3'] = self.PGAGAIN3
        self.PGAGAIN4 = RM_Register_AGC_NS_PGAGAIN4(self.zz_rmio, self.zz_label)
        self.zz_rdict['PGAGAIN4'] = self.PGAGAIN4
        self.ADC0 = RM_Register_AGC_NS_ADC0(self.zz_rmio, self.zz_label)
        self.zz_rdict['ADC0'] = self.ADC0
