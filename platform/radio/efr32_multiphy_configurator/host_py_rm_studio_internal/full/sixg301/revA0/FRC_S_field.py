...
class RM_Field_FRC_S_CTRL_RXABORTHWBEH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_S_CTRL_RXABORTHWBEH, self).__init__(register,
            'RXABORTHWBEH', 'FRC_S.CTRL.RXABORTHWBEH', 'read-write',
            u"",
            15, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_FRC_S_CTRL_RXABORTHWSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_S_CTRL_RXABORTHWSEL, self).__init__(register,
            'RXABORTHWSEL', 'FRC_S.CTRL.RXABORTHWSEL', 'read-write',
            u"",
            22, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_FRC_S_CTRL_RXABORTHWDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_S_CTRL_RXABORTHWDIS, self).__init__(register,
            'RXABORTHWDIS', 'FRC_S.CTRL.RXABORTHWDIS', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
