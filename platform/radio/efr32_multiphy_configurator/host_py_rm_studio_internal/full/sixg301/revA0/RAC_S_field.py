...
class RM_Field_RAC_S_CTRL_FSMDEMODENSEARCH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_CTRL_FSMDEMODENSEARCH, self).__init__(register,
            'FSMDEMODENSEARCH', 'RAC_S.CTRL.FSMDEMODENSEARCH', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_CTRL_FSMDEMODENWAIT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_CTRL_FSMDEMODENWAIT, self).__init__(register,
            'FSMDEMODENWAIT', 'RAC_S.CTRL.FSMDEMODENWAIT', 'read-write',
            u"",
            17, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_IF_PREREGBYPOUT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_IF_PREREGBYPOUT, self).__init__(register,
            'PREREGBYPOUT', 'RAC_S.IF.PREREGBYPOUT', 'read-write',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_IEN_PREREGBYPOUT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_IEN_PREREGBYPOUT, self).__init__(register,
            'PREREGBYPOUT', 'RAC_S.IEN.PREREGBYPOUT', 'read-write',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_SEQIF_PREREGBYPOUT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SEQIF_PREREGBYPOUT, self).__init__(register,
            'PREREGBYPOUT', 'RAC_S.SEQIF.PREREGBYPOUT', 'read-write',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_SEQIF_BRERRAHB2AHB0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SEQIF_BRERRAHB2AHB0, self).__init__(register,
            'BRERRAHB2AHB0', 'RAC_S.SEQIF.BRERRAHB2AHB0', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SEQIF_BRERRAHB2AHB1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SEQIF_BRERRAHB2AHB1, self).__init__(register,
            'BRERRAHB2AHB1', 'RAC_S.SEQIF.BRERRAHB2AHB1', 'read-write',
            u"",
            29, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SEQIF_BRERRLPW2HOST(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SEQIF_BRERRLPW2HOST, self).__init__(register,
            'BRERRLPW2HOST', 'RAC_S.SEQIF.BRERRLPW2HOST', 'read-write',
            u"",
            30, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SEQIF_BRERRLPW2SYSMB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SEQIF_BRERRLPW2SYSMB, self).__init__(register,
            'BRERRLPW2SYSMB', 'RAC_S.SEQIF.BRERRLPW2SYSMB', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_SEQIEN_PREREGBYPOUT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SEQIEN_PREREGBYPOUT, self).__init__(register,
            'PREREGBYPOUT', 'RAC_S.SEQIEN.PREREGBYPOUT', 'read-write',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_SEQIEN_BRERRAHB2AHB0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SEQIEN_BRERRAHB2AHB0, self).__init__(register,
            'BRERRAHB2AHB0', 'RAC_S.SEQIEN.BRERRAHB2AHB0', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SEQIEN_BRERRAHB2AHB1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SEQIEN_BRERRAHB2AHB1, self).__init__(register,
            'BRERRAHB2AHB1', 'RAC_S.SEQIEN.BRERRAHB2AHB1', 'read-write',
            u"",
            29, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SEQIEN_BRERRLPW2HOST(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SEQIEN_BRERRLPW2HOST, self).__init__(register,
            'BRERRLPW2HOST', 'RAC_S.SEQIEN.BRERRLPW2HOST', 'read-write',
            u"",
            30, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SEQIEN_BRERRLPW2SYSMB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SEQIEN_BRERRLPW2SYSMB, self).__init__(register,
            'BRERRLPW2SYSMB', 'RAC_S.SEQIEN.BRERRLPW2SYSMB', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_FSWIF_BRERRAHB2AHB0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_FSWIF_BRERRAHB2AHB0, self).__init__(register,
            'BRERRAHB2AHB0', 'RAC_S.FSWIF.BRERRAHB2AHB0', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_FSWIF_BRERRAHB2AHB1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_FSWIF_BRERRAHB2AHB1, self).__init__(register,
            'BRERRAHB2AHB1', 'RAC_S.FSWIF.BRERRAHB2AHB1', 'read-write',
            u"",
            29, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_FSWIF_BRERRLPW2HOST(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_FSWIF_BRERRLPW2HOST, self).__init__(register,
            'BRERRLPW2HOST', 'RAC_S.FSWIF.BRERRLPW2HOST', 'read-write',
            u"",
            30, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_FSWIF_BRERRLPW2SYSMB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_FSWIF_BRERRLPW2SYSMB, self).__init__(register,
            'BRERRLPW2SYSMB', 'RAC_S.FSWIF.BRERRLPW2SYSMB', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_FSWIEN_BRERRAHB2AHB0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_FSWIEN_BRERRAHB2AHB0, self).__init__(register,
            'BRERRAHB2AHB0', 'RAC_S.FSWIEN.BRERRAHB2AHB0', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_FSWIEN_BRERRAHB2AHB1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_FSWIEN_BRERRAHB2AHB1, self).__init__(register,
            'BRERRAHB2AHB1', 'RAC_S.FSWIEN.BRERRAHB2AHB1', 'read-write',
            u"",
            29, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_FSWIEN_BRERRLPW2HOST(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_FSWIEN_BRERRLPW2HOST, self).__init__(register,
            'BRERRLPW2HOST', 'RAC_S.FSWIEN.BRERRLPW2HOST', 'read-write',
            u"",
            30, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_FSWIEN_BRERRLPW2SYSMB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_FSWIEN_BRERRLPW2SYSMB, self).__init__(register,
            'BRERRLPW2SYSMB', 'RAC_S.FSWIEN.BRERRLPW2SYSMB', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_RACSPARE_RACSPARE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_RACSPARE_RACSPARE, self).__init__(register,
            'RACSPARE', 'RAC_S.RACSPARE.RACSPARE', 'read-write',
            u"",
            0, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_PRSCTRL_CTI0SEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_PRSCTRL_CTI0SEL, self).__init__(register,
            'CTI0SEL', 'RAC_S.PRSCTRL.CTI0SEL', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_PRSCTRL_CTI1SEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_PRSCTRL_CTI1SEL, self).__init__(register,
            'CTI1SEL', 'RAC_S.PRSCTRL.CTI1SEL', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_PRSCTRL_CTI2SEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_PRSCTRL_CTI2SEL, self).__init__(register,
            'CTI2SEL', 'RAC_S.PRSCTRL.CTI2SEL', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_PRSCTRL_CTI3SEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_PRSCTRL_CTI3SEL, self).__init__(register,
            'CTI3SEL', 'RAC_S.PRSCTRL.CTI3SEL', 'read-write',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SWDBG_SWDBG0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SWDBG_SWDBG0, self).__init__(register,
            'SWDBG0', 'RAC_S.SWDBG.SWDBG0', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SWDBG_SWDBG1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SWDBG_SWDBG1, self).__init__(register,
            'SWDBG1', 'RAC_S.SWDBG.SWDBG1', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SWDBG_SWDBG2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SWDBG_SWDBG2, self).__init__(register,
            'SWDBG2', 'RAC_S.SWDBG.SWDBG2', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SWDBG_SWDBG3(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SWDBG_SWDBG3, self).__init__(register,
            'SWDBG3', 'RAC_S.SWDBG.SWDBG3', 'read-write',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_PAENCTRL_INVRFCLKTXDAC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_PAENCTRL_INVRFCLKTXDAC, self).__init__(register,
            'INVRFCLKTXDAC', 'RAC_S.PAENCTRL.INVRFCLKTXDAC', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_DCCAL_DCRUN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_DCCAL_DCRUN, self).__init__(register,
            'DCRUN', 'RAC_S.DCCAL.DCRUN', 'write-only',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_DCCAL_DCBUSY(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_DCCAL_DCBUSY, self).__init__(register,
            'DCBUSY', 'RAC_S.DCCAL.DCBUSY', 'read-only',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_DCCAL_DCDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_DCCAL_DCDONE, self).__init__(register,
            'DCDONE', 'RAC_S.DCCAL.DCDONE', 'read-only',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_DCCAL_MAXITERS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_DCCAL_MAXITERS, self).__init__(register,
            'MAXITERS', 'RAC_S.DCCAL.MAXITERS', 'read-write',
            u"",
            3, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_DCCAL_SETTLECNT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_DCCAL_SETTLECNT, self).__init__(register,
            'SETTLECNT', 'RAC_S.DCCAL.SETTLECNT', 'read-write',
            u"",
            7, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_DCCAL_DCPKDINV(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_DCCAL_DCPKDINV, self).__init__(register,
            'DCPKDINV', 'RAC_S.DCCAL.DCPKDINV', 'read-write',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_DCCAL_DCCTRLOX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_DCCAL_DCCTRLOX, self).__init__(register,
            'DCCTRLOX', 'RAC_S.DCCAL.DCCTRLOX', 'read-write',
            u"",
            12, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_DCCAL_OXICAL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_DCCAL_OXICAL, self).__init__(register,
            'OXICAL', 'RAC_S.DCCAL.OXICAL', 'read-only',
            u"",
            20, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_DCCAL_OXQCAL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_DCCAL_OXQCAL, self).__init__(register,
            'OXQCAL', 'RAC_S.DCCAL.OXQCAL', 'read-only',
            u"",
            26, 6)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_DIGCLKRETIMECTRL_ENCLKQSPIDIGCLK(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_DIGCLKRETIMECTRL_ENCLKQSPIDIGCLK, self).__init__(register,
            'ENCLKQSPIDIGCLK', 'RAC_S.DIGCLKRETIMECTRL.ENCLKQSPIDIGCLK', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_DIGCLKRETIMECTRL_QSPIHIGHCOUNTDIGCLK(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_DIGCLKRETIMECTRL_QSPIHIGHCOUNTDIGCLK, self).__init__(register,
            'QSPIHIGHCOUNTDIGCLK', 'RAC_S.DIGCLKRETIMECTRL.QSPIHIGHCOUNTDIGCLK', 'read-write',
            u"",
            11, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_DIGCLKRETIMECTRL_QSPILOWCOUNTDIGCLK(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_DIGCLKRETIMECTRL_QSPILOWCOUNTDIGCLK, self).__init__(register,
            'QSPILOWCOUNTDIGCLK', 'RAC_S.DIGCLKRETIMECTRL.QSPILOWCOUNTDIGCLK', 'read-write',
            u"",
            15, 4)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_XORETIMECTRL_ENCLKQSPIXO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_XORETIMECTRL_ENCLKQSPIXO, self).__init__(register,
            'ENCLKQSPIXO', 'RAC_S.XORETIMECTRL.ENCLKQSPIXO', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_XORETIMECTRL_QSPIHIGHCOUNTXO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_XORETIMECTRL_QSPIHIGHCOUNTXO, self).__init__(register,
            'QSPIHIGHCOUNTXO', 'RAC_S.XORETIMECTRL.QSPIHIGHCOUNTXO', 'read-write',
            u"",
            10, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_XORETIMECTRL_QSPILOWCOUNTXO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_XORETIMECTRL_QSPILOWCOUNTXO, self).__init__(register,
            'QSPILOWCOUNTXO', 'RAC_S.XORETIMECTRL.QSPILOWCOUNTXO', 'read-write',
            u"",
            14, 4)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_SYDLFCTRL1_SYDLFREADXIMAPPING(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SYDLFCTRL1_SYDLFREADXIMAPPING, self).__init__(register,
            'SYDLFREADXIMAPPING', 'RAC_S.SYDLFCTRL1.SYDLFREADXIMAPPING', 'read-write',
            u"",
            6, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_AUXADCCTRL2_IFADCDISABLECLK(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_AUXADCCTRL2_IFADCDISABLECLK, self).__init__(register,
            'IFADCDISABLECLK', 'RAC_S.AUXADCCTRL2.IFADCDISABLECLK', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_AUXADCCTRL2_IFADCS2PRSTEDGE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_AUXADCCTRL2_IFADCS2PRSTEDGE, self).__init__(register,
            'IFADCS2PRSTEDGE', 'RAC_S.AUXADCCTRL2.IFADCS2PRSTEDGE', 'read-write',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_SYDLFCTRL0_SYDLFCONTRDEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SYDLFCTRL0_SYDLFCONTRDEN, self).__init__(register,
            'SYDLFCONTRDEN', 'RAC_S.SYDLFCTRL0.SYDLFCONTRDEN', 'read-write',
            u"",
            22, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SYDLFCTRL0_SYDLFRDPRDMAN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SYDLFCTRL0_SYDLFRDPRDMAN, self).__init__(register,
            'SYDLFRDPRDMAN', 'RAC_S.SYDLFCTRL0.SYDLFRDPRDMAN', 'read-write',
            u"",
            23, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SYDLFCTRL0_SYDLFRDPRDEXP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SYDLFCTRL0_SYDLFRDPRDEXP, self).__init__(register,
            'SYDLFRDPRDEXP', 'RAC_S.SYDLFCTRL0.SYDLFRDPRDEXP', 'read-write',
            u"",
            26, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SYDLFCTRL0_SYDLFRDDLY(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SYDLFCTRL0_SYDLFRDDLY, self).__init__(register,
            'SYDLFRDDLY', 'RAC_S.SYDLFCTRL0.SYDLFRDDLY', 'read-write',
            u"",
            29, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_SYLOCTRL1_SYENLODIVHADMRXTXMAN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SYLOCTRL1_SYENLODIVHADMRXTXMAN, self).__init__(register,
            'SYENLODIVHADMRXTXMAN', 'RAC_S.SYLOCTRL1.SYENLODIVHADMRXTXMAN', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_SYTRIM3_SYTDCREGTRIMVREGTX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SYTRIM3_SYTDCREGTRIMVREGTX, self).__init__(register,
            'SYTDCREGTRIMVREGTX', 'RAC_S.SYTRIM3.SYTDCREGTRIMVREGTX', 'read-write',
            u"",
            24, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_SYTRIM3_SYVCOREGTRIMVREGTX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_SYTRIM3_SYVCOREGTRIMVREGTX, self).__init__(register,
            'SYVCOREGTRIMVREGTX', 'RAC_S.SYTRIM3.SYVCOREGTRIMVREGTX', 'read-write',
            u"",
            30, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_S_HFXOCTRL_ENCLKSYANA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFXOCTRL_ENCLKSYANA, self).__init__(register,
            'ENCLKSYANA', 'RAC_S.HFXOCTRL.ENCLKSYANA', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFXOCTRL_ENCLKCLKMULTANA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFXOCTRL_ENCLKCLKMULTANA, self).__init__(register,
            'ENCLKCLKMULTANA', 'RAC_S.HFXOCTRL.ENCLKCLKMULTANA', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFXOCTRL_ENCLKDIFANA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFXOCTRL_ENCLKDIFANA, self).__init__(register,
            'ENCLKDIFANA', 'RAC_S.HFXOCTRL.ENCLKDIFANA', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFXOCTRL_SQBUFBIASANA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFXOCTRL_SQBUFBIASANA, self).__init__(register,
            'SQBUFBIASANA', 'RAC_S.HFXOCTRL.SQBUFBIASANA', 'read-write',
            u"",
            3, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFXOCTRL_SQBUFBIASRESANA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFXOCTRL_SQBUFBIASRESANA, self).__init__(register,
            'SQBUFBIASRESANA', 'RAC_S.HFXOCTRL.SQBUFBIASRESANA', 'read-write',
            u"",
            6, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFXOCTRL_SQBUFBIASANAOVR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFXOCTRL_SQBUFBIASANAOVR, self).__init__(register,
            'SQBUFBIASANAOVR', 'RAC_S.HFXOCTRL.SQBUFBIASANAOVR', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFXOCTRL_SQBUFBIASRESANAOVR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFXOCTRL_SQBUFBIASRESANAOVR, self).__init__(register,
            'SQBUFBIASRESANAOVR', 'RAC_S.HFXOCTRL.SQBUFBIASRESANAOVR', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFXOCTRL_SHUNTBIASANAHPEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFXOCTRL_SHUNTBIASANAHPEN, self).__init__(register,
            'SHUNTBIASANAHPEN', 'RAC_S.HFXOCTRL.SHUNTBIASANAHPEN', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMEENRETIME(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMEENRETIME, self).__init__(register,
            'HFRCORETIMEENRETIME', 'RAC_S.HFRCORETIMECTRL.HFRCORETIMEENRETIME', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMEDISRETIME(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMEDISRETIME, self).__init__(register,
            'HFRCORETIMEDISRETIME', 'RAC_S.HFRCORETIMECTRL.HFRCORETIMEDISRETIME', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMERESETN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMERESETN, self).__init__(register,
            'HFRCORETIMERESETN', 'RAC_S.HFRCORETIMECTRL.HFRCORETIMERESETN', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMELIMITH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMELIMITH, self).__init__(register,
            'HFRCORETIMELIMITH', 'RAC_S.HFRCORETIMECTRL.HFRCORETIMELIMITH', 'read-write',
            u"",
            3, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMELIMITL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFRCORETIMECTRL_HFRCORETIMELIMITL, self).__init__(register,
            'HFRCORETIMELIMITL', 'RAC_S.HFRCORETIMECTRL.HFRCORETIMELIMITL', 'read-write',
            u"",
            6, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFRCORETIMECTRL_ENCLKQSPIHFRCOLPW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFRCORETIMECTRL_ENCLKQSPIHFRCOLPW, self).__init__(register,
            'ENCLKQSPIHFRCOLPW', 'RAC_S.HFRCORETIMECTRL.ENCLKQSPIHFRCOLPW', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFRCORETIMECTRL_QSPIHIGHCOUNTHFRCOLPW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFRCORETIMECTRL_QSPIHIGHCOUNTHFRCOLPW, self).__init__(register,
            'QSPIHIGHCOUNTHFRCOLPW', 'RAC_S.HFRCORETIMECTRL.QSPIHIGHCOUNTHFRCOLPW', 'read-write',
            u"",
            10, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFRCORETIMECTRL_QSPILOWCOUNTHFRCOLPW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFRCORETIMECTRL_QSPILOWCOUNTHFRCOLPW, self).__init__(register,
            'QSPILOWCOUNTHFRCOLPW', 'RAC_S.HFRCORETIMECTRL.QSPILOWCOUNTHFRCOLPW', 'read-write',
            u"",
            14, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFRCORETIMESTATUS_HFRCORETIMECLKSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFRCORETIMESTATUS_HFRCORETIMECLKSEL, self).__init__(register,
            'HFRCORETIMECLKSEL', 'RAC_S.HFRCORETIMESTATUS.HFRCORETIMECLKSEL', 'read-only',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_HFRCORETIMESTATUS_HFRCORETIMERESETNLO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_HFRCORETIMESTATUS_HFRCORETIMERESETNLO, self).__init__(register,
            'HFRCORETIMERESETNLO', 'RAC_S.HFRCORETIMESTATUS.HFRCORETIMERESETNLO', 'read-only',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_AGCOVERWRITE2_ENMANTIACAPFB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_AGCOVERWRITE2_ENMANTIACAPFB, self).__init__(register,
            'ENMANTIACAPFB', 'RAC_S.AGCOVERWRITE2.ENMANTIACAPFB', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_S_AGCOVERWRITE2_MANTIACAPFB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_S_AGCOVERWRITE2_MANTIACAPFB, self).__init__(register,
            'MANTIACAPFB', 'RAC_S.AGCOVERWRITE2.MANTIACAPFB', 'read-write',
            u"",
            1, 8)
        self.__dict__['zz_frozen'] = True
