...
class RM_Field_MODEM_S_IF2_AMPAVERAGERDONEIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_IF2_AMPAVERAGERDONEIF, self).__init__(register,
            'AMPAVERAGERDONEIF', 'MODEM_S.IF2.AMPAVERAGERDONEIF', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_IEN2_AMPAVERAGERDONEIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_IEN2_AMPAVERAGERDONEIEN, self).__init__(register,
            'AMPAVERAGERDONEIEN', 'MODEM_S.IEN2.AMPAVERAGERDONEIEN', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_SEQIF2_AMPAVERAGERDONESEQIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_SEQIF2_AMPAVERAGERDONESEQIF, self).__init__(register,
            'AMPAVERAGERDONESEQIF', 'MODEM_S.SEQIF2.AMPAVERAGERDONESEQIF', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_SEQIEN2_AMPAVERAGERDONESEQIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_SEQIEN2_AMPAVERAGERDONESEQIEN, self).__init__(register,
            'AMPAVERAGERDONESEQIEN', 'MODEM_S.SEQIEN2.AMPAVERAGERDONESEQIEN', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_STATUS3_TXTIMTESTERRLAT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_STATUS3_TXTIMTESTERRLAT, self).__init__(register,
            'TXTIMTESTERRLAT', 'MODEM_S.STATUS3.TXTIMTESTERRLAT', 'read-only',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_CTRL5_AFIFOBYP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_CTRL5_AFIFOBYP, self).__init__(register,
            'AFIFOBYP', 'MODEM_S.CTRL5.AFIFOBYP', 'read-write',
            u"",
            23, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_CTRL5_FEFILTCLKSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_CTRL5_FEFILTCLKSEL, self).__init__(register,
            'FEFILTCLKSEL', 'MODEM_S.CTRL5.FEFILTCLKSEL', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_RAMPCTRL_RAMPDISRST(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_RAMPCTRL_RAMPDISRST, self).__init__(register,
            'RAMPDISRST', 'MODEM_S.RAMPCTRL.RAMPDISRST', 'read-write',
            u"",
            13, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_RAMPCTRL_RAMPMODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_RAMPCTRL_RAMPMODE, self).__init__(register,
            'RAMPMODE', 'MODEM_S.RAMPCTRL.RAMPMODE', 'read-write',
            u"",
            24, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_RAMPLEV_RAMPLEVOFFS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_RAMPLEV_RAMPLEVOFFS, self).__init__(register,
            'RAMPLEVOFFS', 'MODEM_S.RAMPLEV.RAMPLEVOFFS', 'read-write',
            u"",
            24, 8)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_ETSCTRL_CAPTRIGSAMP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_ETSCTRL_CAPTRIGSAMP, self).__init__(register,
            'CAPTRIGSAMP', 'MODEM_S.ETSCTRL.CAPTRIGSAMP', 'read-write',
            u"",
            30, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_ETSCTRL_CAPTRIGCONDBYP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_ETSCTRL_CAPTRIGCONDBYP, self).__init__(register,
            'CAPTRIGCONDBYP', 'MODEM_S.ETSCTRL.CAPTRIGCONDBYP', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_CHFCTRL_ADJGAINWIN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_CHFCTRL_ADJGAINWIN, self).__init__(register,
            'ADJGAINWIN', 'MODEM_S.CHFCTRL.ADJGAINWIN', 'read-write',
            u"",
            9, 8)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_FRMSCHTIME_RXDTIMLOSDETTHD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_FRMSCHTIME_RXDTIMLOSDETTHD, self).__init__(register,
            'RXDTIMLOSDETTHD', 'MODEM_S.FRMSCHTIME.RXDTIMLOSDETTHD', 'read-write',
            u"",
            20, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_SICTRL0_SYMIDENTDIS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_SICTRL0_SYMIDENTDIS, self).__init__(register,
            'SYMIDENTDIS', 'MODEM_S.SICTRL0.SYMIDENTDIS', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_SICTRL1_FREQOFFTOLERANCE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_SICTRL1_FREQOFFTOLERANCE, self).__init__(register,
            'FREQOFFTOLERANCE', 'MODEM_S.SICTRL1.FREQOFFTOLERANCE', 'read-write',
            u"",
            29, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_SICTRL2_SISTARTDELAYMODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_SICTRL2_SISTARTDELAYMODE, self).__init__(register,
            'SISTARTDELAYMODE', 'MODEM_S.SICTRL2.SISTARTDELAYMODE', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_ECACTRL_FEFILTDBGSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_ECACTRL_FEFILTDBGSEL, self).__init__(register,
            'FEFILTDBGSEL', 'MODEM_S.ECACTRL.FEFILTDBGSEL', 'read-write',
            u"",
            0, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_ECACTRL_FEFILTDBGLSB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_ECACTRL_FEFILTDBGLSB, self).__init__(register,
            'FEFILTDBGLSB', 'MODEM_S.ECACTRL.FEFILTDBGLSB', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_ECACTRL_ECADEMODSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_ECACTRL_ECADEMODSEL, self).__init__(register,
            'ECADEMODSEL', 'MODEM_S.ECACTRL.ECADEMODSEL', 'read-write',
            u"",
            3, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_HADMCTRL0_TGUARDPERIOD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL0_TGUARDPERIOD, self).__init__(register,
            'TGUARDPERIOD', 'MODEM_S.HADMCTRL0.TGUARDPERIOD', 'read-write',
            u"",
            15, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL0_TEXCL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL0_TEXCL, self).__init__(register,
            'TEXCL', 'MODEM_S.HADMCTRL0.TEXCL', 'read-write',
            u"",
            19, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL0_TSWITCH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL0_TSWITCH, self).__init__(register,
            'TSWITCH', 'MODEM_S.HADMCTRL0.TSWITCH', 'read-write',
            u"",
            22, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL0_TGRPDLY(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL0_TGRPDLY, self).__init__(register,
            'TGRPDLY', 'MODEM_S.HADMCTRL0.TGRPDLY', 'read-write',
            u"",
            25, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL0_ACI(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL0_ACI, self).__init__(register,
            'ACI', 'MODEM_S.HADMCTRL0.ACI', 'read-write',
            u"",
            29, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_HADMCTRL1_API(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL1_API, self).__init__(register,
            'API', 'MODEM_S.HADMCTRL1.API', 'read-write',
            u"",
            25, 5)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_HADMSTATUS6_TONEQUALITY(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMSTATUS6_TONEQUALITY, self).__init__(register,
            'TONEQUALITY', 'MODEM_S.HADMSTATUS6.TONEQUALITY', 'read-only',
            u"",
            16, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_HADMCTRL2_TONEQUALITYTHRESH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL2_TONEQUALITYTHRESH, self).__init__(register,
            'TONEQUALITYTHRESH', 'MODEM_S.HADMCTRL2.TONEQUALITYTHRESH', 'read-write',
            u"",
            0, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL2_PHASEPERCHANNEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL2_PHASEPERCHANNEL, self).__init__(register,
            'PHASEPERCHANNEL', 'MODEM_S.HADMCTRL2.PHASEPERCHANNEL', 'read-write',
            u"",
            8, 16)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL2_CHNO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL2_CHNO, self).__init__(register,
            'CHNO', 'MODEM_S.HADMCTRL2.CHNO', 'read-write',
            u"",
            24, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL2_OWRRSTDLO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL2_OWRRSTDLO, self).__init__(register,
            'OWRRSTDLO', 'MODEM_S.HADMCTRL2.OWRRSTDLO', 'read-write',
            u"",
            30, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL3_ANTVALHADM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL3_ANTVALHADM, self).__init__(register,
            'ANTVALHADM', 'MODEM_S.HADMCTRL3.ANTVALHADM', 'read-write',
            u"",
            0, 24)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL4_RTTMODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL4_RTTMODE, self).__init__(register,
            'RTTMODE', 'MODEM_S.HADMCTRL4.RTTMODE', 'read-write',
            u"",
            0, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL4_RTTLEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL4_RTTLEN, self).__init__(register,
            'RTTLEN', 'MODEM_S.HADMCTRL4.RTTLEN', 'read-write',
            u"",
            2, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL4_CSSYNCANTSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL4_CSSYNCANTSEL, self).__init__(register,
            'CSSYNCANTSEL', 'MODEM_S.HADMCTRL4.CSSYNCANTSEL', 'read-write',
            u"",
            5, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL4_RBSTRACKNUM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL4_RBSTRACKNUM, self).__init__(register,
            'RBSTRACKNUM', 'MODEM_S.HADMCTRL4.RBSTRACKNUM', 'read-write',
            u"",
            8, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL4_RTTTIMEOUT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL4_RTTTIMEOUT, self).__init__(register,
            'RTTTIMEOUT', 'MODEM_S.HADMCTRL4.RTTTIMEOUT', 'read-write',
            u"",
            11, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL4_PBRSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL4_PBRSEL, self).__init__(register,
            'PBRSEL', 'MODEM_S.HADMCTRL4.PBRSEL', 'read-write',
            u"",
            25, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL4_RTTSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL4_RTTSEL, self).__init__(register,
            'RTTSEL', 'MODEM_S.HADMCTRL4.RTTSEL', 'read-write',
            u"",
            27, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL4_DBGSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL4_DBGSEL, self).__init__(register,
            'DBGSEL', 'MODEM_S.HADMCTRL4.DBGSEL', 'read-write',
            u"",
            29, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMSTATUS7_COSTLATE2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMSTATUS7_COSTLATE2, self).__init__(register,
            'COSTLATE2', 'MODEM_S.HADMSTATUS7.COSTLATE2', 'read-only',
            u"",
            0, 10)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMSTATUS7_COSTCURR2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMSTATUS7_COSTCURR2, self).__init__(register,
            'COSTCURR2', 'MODEM_S.HADMSTATUS7.COSTCURR2', 'read-only',
            u"",
            10, 10)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMSTATUS7_COSTEARL2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMSTATUS7_COSTEARL2, self).__init__(register,
            'COSTEARL2', 'MODEM_S.HADMSTATUS7.COSTEARL2', 'read-only',
            u"",
            20, 10)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL5_DCCOMPI(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL5_DCCOMPI, self).__init__(register,
            'DCCOMPI', 'MODEM_S.HADMCTRL5.DCCOMPI', 'read-write',
            u"",
            0, 16)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_HADMCTRL5_DCCOMPQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_HADMCTRL5_DCCOMPQ, self).__init__(register,
            'DCCOMPQ', 'MODEM_S.HADMCTRL5.DCCOMPQ', 'read-write',
            u"",
            16, 16)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_EHDSSSCFG3_LQIAVGWIN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_EHDSSSCFG3_LQIAVGWIN, self).__init__(register,
            'LQIAVGWIN', 'MODEM_S.EHDSSSCFG3.LQIAVGWIN', 'read-write',
            u"",
            30, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_TXCTRL_TXMOD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCTRL_TXMOD, self).__init__(register,
            'TXMOD', 'MODEM_S.TXCTRL.TXMOD', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCTRL_BR2M(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCTRL_BR2M, self).__init__(register,
            'BR2M', 'MODEM_S.TXCTRL.BR2M', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCTRL_FORCECLKEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCTRL_FORCECLKEN, self).__init__(register,
            'FORCECLKEN', 'MODEM_S.TXCTRL.FORCECLKEN', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCTRL_TXINTPEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCTRL_TXINTPEN, self).__init__(register,
            'TXINTPEN', 'MODEM_S.TXCTRL.TXINTPEN', 'read-write',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCTRL_TXDSEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCTRL_TXDSEN, self).__init__(register,
            'TXDSEN', 'MODEM_S.TXCTRL.TXDSEN', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCTRL_TXAFIFOBYP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCTRL_TXAFIFOBYP, self).__init__(register,
            'TXAFIFOBYP', 'MODEM_S.TXCTRL.TXAFIFOBYP', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCTRL_TXTIMTESTEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCTRL_TXTIMTESTEN, self).__init__(register,
            'TXTIMTESTEN', 'MODEM_S.TXCTRL.TXTIMTESTEN', 'read-write',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCTRL_TXDOFORCEI(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCTRL_TXDOFORCEI, self).__init__(register,
            'TXDOFORCEI', 'MODEM_S.TXCTRL.TXDOFORCEI', 'read-write',
            u"",
            30, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCTRL_TXDOFORCEQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCTRL_TXDOFORCEQ, self).__init__(register,
            'TXDOFORCEQ', 'MODEM_S.TXCTRL.TXDOFORCEQ', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_TXCORRSTATIC_TXDGAIN6DB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCORRSTATIC_TXDGAIN6DB, self).__init__(register,
            'TXDGAIN6DB', 'MODEM_S.TXCORRSTATIC.TXDGAIN6DB', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCORRSTATIC_TXDGAIN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCORRSTATIC_TXDGAIN, self).__init__(register,
            'TXDGAIN', 'MODEM_S.TXCORRSTATIC.TXDGAIN', 'read-write',
            u"",
            1, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCORRSTATIC_TXINVCORDICIN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCORRSTATIC_TXINVCORDICIN, self).__init__(register,
            'TXINVCORDICIN', 'MODEM_S.TXCORRSTATIC.TXINVCORDICIN', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCORRSTATIC_TXIQSWAP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCORRSTATIC_TXIQSWAP, self).__init__(register,
            'TXIQSWAP', 'MODEM_S.TXCORRSTATIC.TXIQSWAP', 'read-write',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCORRSTATIC_TXDACFORMAT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCORRSTATIC_TXDACFORMAT, self).__init__(register,
            'TXDACFORMAT', 'MODEM_S.TXCORRSTATIC.TXDACFORMAT', 'read-write',
            u"",
            7, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCORRSTATIC_TXFREQCORR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCORRSTATIC_TXFREQCORR, self).__init__(register,
            'TXFREQCORR', 'MODEM_S.TXCORRSTATIC.TXFREQCORR', 'read-write',
            u"",
            8, 19)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCORRPTE_TXIQIMBEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCORRPTE_TXIQIMBEN, self).__init__(register,
            'TXIQIMBEN', 'MODEM_S.TXCORRPTE.TXIQIMBEN', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCORRPTE_TXGAINIMB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCORRPTE_TXGAINIMB, self).__init__(register,
            'TXGAINIMB', 'MODEM_S.TXCORRPTE.TXGAINIMB', 'read-write',
            u"",
            1, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCORRPTE_TXPHSIMB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCORRPTE_TXPHSIMB, self).__init__(register,
            'TXPHSIMB', 'MODEM_S.TXCORRPTE.TXPHSIMB', 'read-write',
            u"",
            7, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCORRPTE_TXDCI(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCORRPTE_TXDCI, self).__init__(register,
            'TXDCI', 'MODEM_S.TXCORRPTE.TXDCI', 'read-write',
            u"",
            13, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_TXCORRPTE_TXDCQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_TXCORRPTE_TXDCQ, self).__init__(register,
            'TXDCQ', 'MODEM_S.TXCORRPTE.TXDCQ', 'read-write',
            u"",
            21, 8)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_COMMANDS_START(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_COMMANDS_START, self).__init__(register,
            'START', 'MODEM_S.COMMANDS.START', 'write-only',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_COMMANDS_ABORT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_COMMANDS_ABORT, self).__init__(register,
            'ABORT', 'MODEM_S.COMMANDS.ABORT', 'write-only',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_AMPAVERAGERCTRL_ENAMPAVERAGER(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_AMPAVERAGERCTRL_ENAMPAVERAGER, self).__init__(register,
            'ENAMPAVERAGER', 'MODEM_S.AMPAVERAGERCTRL.ENAMPAVERAGER', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_AMPAVERAGERCTRL_NUMCYCLES(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_AMPAVERAGERCTRL_NUMCYCLES, self).__init__(register,
            'NUMCYCLES', 'MODEM_S.AMPAVERAGERCTRL.NUMCYCLES', 'read-write',
            u"",
            1, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_RESULT_RESULT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_RESULT_RESULT, self).__init__(register,
            'RESULT', 'MODEM_S.RESULT.RESULT', 'read-only',
            u"",
            0, 32)
        self.__dict__['zz_frozen'] = True
