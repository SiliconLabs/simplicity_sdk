 ...
 *
 * @note     (2) This port supports the ARM Cortex-M33 architectures.
 *******************************************************************************************************/
...
void OSInitHook(void)
{
  ...
  OS_CPU_ExceptStkLimit = (CPU_STK *)OSCfg_ISRStkBasePtr;
 ...
 *                     prior to ARMV8 and to the A, R and M architecture profiles thereafter. Special considerations
 *                     associated with ARMV8M are discussed in section 2.3.3"
 *                   - (1) Even if the SP 8-byte aligment is not a requirement for the ARMv8M profile, the stack is aligned
