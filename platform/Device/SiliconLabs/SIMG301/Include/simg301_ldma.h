/**************************************************************************//**
 * @file
 * @brief SIMG301 LDMA register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef SIMG301_LDMA_H
#define SIMG301_LDMA_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup SIMG301_LDMA LDMA
 * @{
 * @brief SIMG301 LDMA Register Declaration.
 *****************************************************************************/
...
typedef struct ldma_typedef{
  ...
  __IOM uint32_t  REQABORT;                     /**< DMA Req abort                                      */
  __IM uint32_t   ABORTSTATUS;                  /**< Abort Clean status register                        */
  uint32_t        RESERVED0[3U];                /**< Reserved for future use                            */
  LDMA_CH_TypeDef CH[8U];                       /**< DMA Channel Registers                              */
  uint32_t        RESERVED1[900U];              /**< Reserved for future use                            */
  ...
  __IOM uint32_t  REQABORT_SET;                 /**< DMA Req abort                                      */
  __IM uint32_t   ABORTSTATUS_SET;              /**< Abort Clean status register                        */
  uint32_t        RESERVED2[3U];                /**< Reserved for future use                            */
  LDMA_CH_TypeDef CH_SET[8U];                   /**< DMA Channel Registers                              */
  uint32_t        RESERVED3[900U];              /**< Reserved for future use                            */
  ...
  __IOM uint32_t  REQABORT_CLR;                 /**< DMA Req abort                                      */
  __IM uint32_t   ABORTSTATUS_CLR;              /**< Abort Clean status register                        */
  uint32_t        RESERVED4[3U];                /**< Reserved for future use                            */
  LDMA_CH_TypeDef CH_CLR[8U];                   /**< DMA Channel Registers                              */
  uint32_t        RESERVED5[900U];              /**< Reserved for future use                            */
  ...
  __IOM uint32_t  REQABORT_TGL;                 /**< DMA Req abort                                      */
  __IM uint32_t   ABORTSTATUS_TGL;              /**< Abort Clean status register                        */
  uint32_t        RESERVED6[3U];                /**< Reserved for future use                            */
  LDMA_CH_TypeDef CH_TGL[8U];                   /**< DMA Channel Registers                              */
} LDMA_TypeDef;
/** @} End of group SIMG301_LDMA */

/**************************************************************************//**
 * @addtogroup SIMG301_LDMA
 * @{
 * @defgroup SIMG301_LDMA_BitFields LDMA Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for LDMA IPVERSION */
#define _LDMA_IPVERSION_RESETVALUE               0x00000003UL                             /**< Default value for LDMA_IPVERSION            */
...
#define _LDMA_IPVERSION_IPVERSION_DEFAULT        0x00000003UL                             /**< Mode DEFAULT for LDMA_IPVERSION             */
...
#define _LDMA_STATUS_RESETVALUE                  0x08000038UL                           /**< Default value for LDMA_STATUS               */
...
#define _LDMA_STATUS_CHGRANT_DEFAULT             0x00000007UL                           /**< Mode DEFAULT for LDMA_STATUS                */
...
#define LDMA_CHDONE_CHDONE0                      (0x1UL << 0)                           /**< Channel 0 Linking Done Status flag          */
...
#define LDMA_CHDONE_CHDONE1                      (0x1UL << 1)                           /**< Channel 1 Linking Done Status flag          */
...
#define LDMA_CHDONE_CHDONE2                      (0x1UL << 2)                           /**< Channel 2 Linking Done Status flag          */
...
#define LDMA_CHDONE_CHDONE3                      (0x1UL << 3)                           /**< Channel 3 Linking Done Status flag          */
...
#define LDMA_CHDONE_CHDONE4                      (0x1UL << 4)                           /**< Channel 4 Linking Done Status flag          */
...
#define LDMA_CHDONE_CHDONE5                      (0x1UL << 5)                           /**< Channel 5 Linking Done Status flag          */
...
#define LDMA_CHDONE_CHDONE6                      (0x1UL << 6)                           /**< Channel 6 Linking Done Status flag          */
...
#define LDMA_CHDONE_CHDONE7                      (0x1UL << 7)                           /**< Channel 7 Linking Done Status flag          */
...
#define _LDMA_IF_MASK                            0x00FF00FFUL                           /**< Mask for LDMA_IF                            */
...
#define LDMA_IF_ERROR0                           (0x1UL << 16)                          /**< Error Flag                                  */
#define _LDMA_IF_ERROR0_SHIFT                    16                                     /**< Shift value for LDMA_ERROR0                 */
#define _LDMA_IF_ERROR0_MASK                     0x10000UL                              /**< Bit mask for LDMA_ERROR0                    */
#define _LDMA_IF_ERROR0_DEFAULT                  0x00000000UL                           /**< Mode DEFAULT for LDMA_IF                    */
#define LDMA_IF_ERROR0_DEFAULT                   (_LDMA_IF_ERROR0_DEFAULT << 16)        /**< Shifted mode DEFAULT for LDMA_IF            */
#define LDMA_IF_ERROR1                           (0x1UL << 17)                          /**< Error Flag                                  */
#define _LDMA_IF_ERROR1_SHIFT                    17                                     /**< Shift value for LDMA_ERROR1                 */
#define _LDMA_IF_ERROR1_MASK                     0x20000UL                              /**< Bit mask for LDMA_ERROR1                    */
#define _LDMA_IF_ERROR1_DEFAULT                  0x00000000UL                           /**< Mode DEFAULT for LDMA_IF                    */
#define LDMA_IF_ERROR1_DEFAULT                   (_LDMA_IF_ERROR1_DEFAULT << 17)        /**< Shifted mode DEFAULT for LDMA_IF            */
#define LDMA_IF_ERROR2                           (0x1UL << 18)                          /**< Error Flag                                  */
#define _LDMA_IF_ERROR2_SHIFT                    18                                     /**< Shift value for LDMA_ERROR2                 */
#define _LDMA_IF_ERROR2_MASK                     0x40000UL                              /**< Bit mask for LDMA_ERROR2                    */
#define _LDMA_IF_ERROR2_DEFAULT                  0x00000000UL                           /**< Mode DEFAULT for LDMA_IF                    */
#define LDMA_IF_ERROR2_DEFAULT                   (_LDMA_IF_ERROR2_DEFAULT << 18)        /**< Shifted mode DEFAULT for LDMA_IF            */
#define LDMA_IF_ERROR3                           (0x1UL << 19)                          /**< Error Flag                                  */
#define _LDMA_IF_ERROR3_SHIFT                    19                                     /**< Shift value for LDMA_ERROR3                 */
#define _LDMA_IF_ERROR3_MASK                     0x80000UL                              /**< Bit mask for LDMA_ERROR3                    */
#define _LDMA_IF_ERROR3_DEFAULT                  0x00000000UL                           /**< Mode DEFAULT for LDMA_IF                    */
#define LDMA_IF_ERROR3_DEFAULT                   (_LDMA_IF_ERROR3_DEFAULT << 19)        /**< Shifted mode DEFAULT for LDMA_IF            */
#define LDMA_IF_ERROR4                           (0x1UL << 20)                          /**< Error Flag                                  */
#define _LDMA_IF_ERROR4_SHIFT                    20                                     /**< Shift value for LDMA_ERROR4                 */
#define _LDMA_IF_ERROR4_MASK                     0x100000UL                             /**< Bit mask for LDMA_ERROR4                    */
#define _LDMA_IF_ERROR4_DEFAULT                  0x00000000UL                           /**< Mode DEFAULT for LDMA_IF                    */
#define LDMA_IF_ERROR4_DEFAULT                   (_LDMA_IF_ERROR4_DEFAULT << 20)        /**< Shifted mode DEFAULT for LDMA_IF            */
#define LDMA_IF_ERROR5                           (0x1UL << 21)                          /**< Error Flag                                  */
#define _LDMA_IF_ERROR5_SHIFT                    21                                     /**< Shift value for LDMA_ERROR5                 */
#define _LDMA_IF_ERROR5_MASK                     0x200000UL                             /**< Bit mask for LDMA_ERROR5                    */
#define _LDMA_IF_ERROR5_DEFAULT                  0x00000000UL                           /**< Mode DEFAULT for LDMA_IF                    */
#define LDMA_IF_ERROR5_DEFAULT                   (_LDMA_IF_ERROR5_DEFAULT << 21)        /**< Shifted mode DEFAULT for LDMA_IF            */
#define LDMA_IF_ERROR6                           (0x1UL << 22)                          /**< Error Flag                                  */
#define _LDMA_IF_ERROR6_SHIFT                    22                                     /**< Shift value for LDMA_ERROR6                 */
#define _LDMA_IF_ERROR6_MASK                     0x400000UL                             /**< Bit mask for LDMA_ERROR6                    */
#define _LDMA_IF_ERROR6_DEFAULT                  0x00000000UL                           /**< Mode DEFAULT for LDMA_IF                    */
#define LDMA_IF_ERROR6_DEFAULT                   (_LDMA_IF_ERROR6_DEFAULT << 22)        /**< Shifted mode DEFAULT for LDMA_IF            */
#define LDMA_IF_ERROR7                           (0x1UL << 23)                          /**< Error Flag                                  */
#define _LDMA_IF_ERROR7_SHIFT                    23                                     /**< Shift value for LDMA_ERROR7                 */
#define _LDMA_IF_ERROR7_MASK                     0x800000UL                             /**< Bit mask for LDMA_ERROR7                    */
#define _LDMA_IF_ERROR7_DEFAULT                  0x00000000UL                           /**< Mode DEFAULT for LDMA_IF                    */
#define LDMA_IF_ERROR7_DEFAULT                   (_LDMA_IF_ERROR7_DEFAULT << 23)        /**< Shifted mode DEFAULT for LDMA_IF            */
...
/* Bit fields for LDMA REQABORT */
#define _LDMA_REQABORT_RESETVALUE                0x00000000UL                           /**< Default value for LDMA_REQABORT             */
#define _LDMA_REQABORT_MASK                      0x000000FFUL                           /**< Mask for LDMA_REQABORT                      */
#define _LDMA_REQABORT_REQABORT_SHIFT            0                                      /**< Shift value for LDMA_REQABORT               */
#define _LDMA_REQABORT_REQABORT_MASK             0xFFUL                                 /**< Bit mask for LDMA_REQABORT                  */
#define _LDMA_REQABORT_REQABORT_DEFAULT          0x00000000UL                           /**< Mode DEFAULT for LDMA_REQABORT              */
#define LDMA_REQABORT_REQABORT_DEFAULT           (_LDMA_REQABORT_REQABORT_DEFAULT << 0) /**< Shifted mode DEFAULT for LDMA_REQABORT      */

/* Bit fields for LDMA ABORTSTATUS */
#define _LDMA_ABORTSTATUS_RESETVALUE             0x000000FFUL                                 /**< Default value for LDMA_ABORTSTATUS          */
#define _LDMA_ABORTSTATUS_MASK                   0x000000FFUL                                 /**< Mask for LDMA_ABORTSTATUS                   */
#define _LDMA_ABORTSTATUS_ABORTSTATUS_SHIFT      0                                            /**< Shift value for LDMA_ABORTSTATUS            */
#define _LDMA_ABORTSTATUS_ABORTSTATUS_MASK       0xFFUL                                       /**< Bit mask for LDMA_ABORTSTATUS               */
#define _LDMA_ABORTSTATUS_ABORTSTATUS_DEFAULT    0x000000FFUL                                 /**< Mode DEFAULT for LDMA_ABORTSTATUS           */
#define LDMA_ABORTSTATUS_ABORTSTATUS_DEFAULT     (_LDMA_ABORTSTATUS_ABORTSTATUS_DEFAULT << 0) /**< Shifted mode DEFAULT for LDMA_ABORTSTATUS   */
...
/** @} End of group SIMG301_LDMA_BitFields */
/** @} End of group SIMG301_LDMA */
/** @} End of group Parts */

#endif // SIMG301_LDMA_H
