/**************************************************************************//**
 * @file
 * @brief SIMG301 LFXO register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef SIMG301_LFXO_H
#define SIMG301_LFXO_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup SIMG301_LFXO LFXO
 * @{
 * @brief SIMG301 LFXO Register Declaration.
 *****************************************************************************/
...
typedef struct lfxo_typedef{
  ...
  __IOM uint32_t AGCCTRL;                       /**< AGC Control Register                               */
  ...
  __IOM uint32_t AGCCTRL_SET;                   /**< AGC Control Register                               */
  uint32_t       RESERVED5[1012U];              /**< Reserved for future use                            */
  ...
  __IOM uint32_t AGCCTRL_CLR;                   /**< AGC Control Register                               */
  uint32_t       RESERVED8[1012U];              /**< Reserved for future use                            */
  ...
  __IOM uint32_t AGCCTRL_TGL;                   /**< AGC Control Register                               */
} LFXO_TypeDef;
/** @} End of group SIMG301_LFXO */

/**************************************************************************//**
 * @addtogroup SIMG301_LFXO
 * @{
 * @defgroup SIMG301_LFXO_BitFields LFXO Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for LFXO IPVERSION */
#define _LFXO_IPVERSION_RESETVALUE           0x00000002UL                               /**< Default value for LFXO_IPVERSION            */
...
#define _LFXO_IPVERSION_IPVERSION_DEFAULT    0x00000002UL                               /**< Mode DEFAULT for LFXO_IPVERSION             */
...
#define _LFXO_CFG_RESETVALUE                 0x00010700UL                               /**< Default value for LFXO_CFG                  */
#define _LFXO_CFG_MASK                       0x0003F733UL                               /**< Mask for LFXO_CFG                           */
#define _LFXO_CFG_AGCRATE_SHIFT              0                                          /**< Shift value for LFXO_AGCRATE                */
#define _LFXO_CFG_AGCRATE_MASK               0x3UL                                      /**< Bit mask for LFXO_AGCRATE                   */
#define _LFXO_CFG_AGCRATE_DEFAULT            0x00000000UL                               /**< Mode DEFAULT for LFXO_CFG                   */
#define _LFXO_CFG_AGCRATE_SLOW               0x00000000UL                               /**< Mode SLOW for LFXO_CFG                      */
#define _LFXO_CFG_AGCRATE_MEDIUM             0x00000001UL                               /**< Mode MEDIUM for LFXO_CFG                    */
#define _LFXO_CFG_AGCRATE_FAST               0x00000002UL                               /**< Mode FAST for LFXO_CFG                      */
#define _LFXO_CFG_AGCRATE_TEST               0x00000003UL                               /**< Mode TEST for LFXO_CFG                      */
#define LFXO_CFG_AGCRATE_DEFAULT             (_LFXO_CFG_AGCRATE_DEFAULT << 0)           /**< Shifted mode DEFAULT for LFXO_CFG           */
#define LFXO_CFG_AGCRATE_SLOW                (_LFXO_CFG_AGCRATE_SLOW << 0)              /**< Shifted mode SLOW for LFXO_CFG              */
#define LFXO_CFG_AGCRATE_MEDIUM              (_LFXO_CFG_AGCRATE_MEDIUM << 0)            /**< Shifted mode MEDIUM for LFXO_CFG            */
#define LFXO_CFG_AGCRATE_FAST                (_LFXO_CFG_AGCRATE_FAST << 0)              /**< Shifted mode FAST for LFXO_CFG              */
#define LFXO_CFG_AGCRATE_TEST                (_LFXO_CFG_AGCRATE_TEST << 0)              /**< Shifted mode TEST for LFXO_CFG              */
...
#define _LFXO_CFG_MODE_XTAL_HP               0x00000001UL                               /**< Mode XTAL_HP for LFXO_CFG                   */
#define _LFXO_CFG_MODE_BUFEXTCLK             0x00000002UL                               /**< Mode BUFEXTCLK for LFXO_CFG                 */
#define _LFXO_CFG_MODE_DIGEXTCLK             0x00000003UL                               /**< Mode DIGEXTCLK for LFXO_CFG                 */
...
#define LFXO_CFG_MODE_XTAL_HP                (_LFXO_CFG_MODE_XTAL_HP << 4)              /**< Shifted mode XTAL_HP for LFXO_CFG           */
...
#define _LFXO_CFG_DRVCURR_SHIFT              12                                         /**< Shift value for LFXO_DRVCURR                */
#define _LFXO_CFG_DRVCURR_MASK               0xF000UL                                   /**< Bit mask for LFXO_DRVCURR                   */
#define _LFXO_CFG_DRVCURR_DEFAULT            0x00000000UL                               /**< Mode DEFAULT for LFXO_CFG                   */
#define _LFXO_CFG_DRVCURR_AGC                0x00000000UL                               /**< Mode AGC for LFXO_CFG                       */
#define _LFXO_CFG_DRVCURR_FORCE_1            0x00000001UL                               /**< Mode FORCE_1 for LFXO_CFG                   */
#define _LFXO_CFG_DRVCURR_FORCE_2            0x00000002UL                               /**< Mode FORCE_2 for LFXO_CFG                   */
#define _LFXO_CFG_DRVCURR_FORCE_3            0x00000003UL                               /**< Mode FORCE_3 for LFXO_CFG                   */
#define _LFXO_CFG_DRVCURR_FORCE_4            0x00000004UL                               /**< Mode FORCE_4 for LFXO_CFG                   */
#define _LFXO_CFG_DRVCURR_FORCE_5            0x00000005UL                               /**< Mode FORCE_5 for LFXO_CFG                   */
#define _LFXO_CFG_DRVCURR_FORCE_6            0x00000006UL                               /**< Mode FORCE_6 for LFXO_CFG                   */
#define _LFXO_CFG_DRVCURR_FORCE_7            0x00000007UL                               /**< Mode FORCE_7 for LFXO_CFG                   */
#define _LFXO_CFG_DRVCURR_FORCE_8            0x00000008UL                               /**< Mode FORCE_8 for LFXO_CFG                   */
#define _LFXO_CFG_DRVCURR_FORCE_9            0x00000009UL                               /**< Mode FORCE_9 for LFXO_CFG                   */
#define _LFXO_CFG_DRVCURR_FORCE_10           0x0000000AUL                               /**< Mode FORCE_10 for LFXO_CFG                  */
#define _LFXO_CFG_DRVCURR_FORCE_11           0x0000000BUL                               /**< Mode FORCE_11 for LFXO_CFG                  */
#define _LFXO_CFG_DRVCURR_FORCE_12           0x0000000CUL                               /**< Mode FORCE_12 for LFXO_CFG                  */
#define _LFXO_CFG_DRVCURR_FORCE_13           0x0000000DUL                               /**< Mode FORCE_13 for LFXO_CFG                  */
#define _LFXO_CFG_DRVCURR_FORCE_14           0x0000000EUL                               /**< Mode FORCE_14 for LFXO_CFG                  */
#define _LFXO_CFG_DRVCURR_FORCE_15           0x0000000FUL                               /**< Mode FORCE_15 for LFXO_CFG                  */
#define LFXO_CFG_DRVCURR_DEFAULT             (_LFXO_CFG_DRVCURR_DEFAULT << 12)          /**< Shifted mode DEFAULT for LFXO_CFG           */
#define LFXO_CFG_DRVCURR_AGC                 (_LFXO_CFG_DRVCURR_AGC << 12)              /**< Shifted mode AGC for LFXO_CFG               */
#define LFXO_CFG_DRVCURR_FORCE_1             (_LFXO_CFG_DRVCURR_FORCE_1 << 12)          /**< Shifted mode FORCE_1 for LFXO_CFG           */
#define LFXO_CFG_DRVCURR_FORCE_2             (_LFXO_CFG_DRVCURR_FORCE_2 << 12)          /**< Shifted mode FORCE_2 for LFXO_CFG           */
#define LFXO_CFG_DRVCURR_FORCE_3             (_LFXO_CFG_DRVCURR_FORCE_3 << 12)          /**< Shifted mode FORCE_3 for LFXO_CFG           */
#define LFXO_CFG_DRVCURR_FORCE_4             (_LFXO_CFG_DRVCURR_FORCE_4 << 12)          /**< Shifted mode FORCE_4 for LFXO_CFG           */
#define LFXO_CFG_DRVCURR_FORCE_5             (_LFXO_CFG_DRVCURR_FORCE_5 << 12)          /**< Shifted mode FORCE_5 for LFXO_CFG           */
#define LFXO_CFG_DRVCURR_FORCE_6             (_LFXO_CFG_DRVCURR_FORCE_6 << 12)          /**< Shifted mode FORCE_6 for LFXO_CFG           */
#define LFXO_CFG_DRVCURR_FORCE_7             (_LFXO_CFG_DRVCURR_FORCE_7 << 12)          /**< Shifted mode FORCE_7 for LFXO_CFG           */
#define LFXO_CFG_DRVCURR_FORCE_8             (_LFXO_CFG_DRVCURR_FORCE_8 << 12)          /**< Shifted mode FORCE_8 for LFXO_CFG           */
#define LFXO_CFG_DRVCURR_FORCE_9             (_LFXO_CFG_DRVCURR_FORCE_9 << 12)          /**< Shifted mode FORCE_9 for LFXO_CFG           */
#define LFXO_CFG_DRVCURR_FORCE_10            (_LFXO_CFG_DRVCURR_FORCE_10 << 12)         /**< Shifted mode FORCE_10 for LFXO_CFG          */
#define LFXO_CFG_DRVCURR_FORCE_11            (_LFXO_CFG_DRVCURR_FORCE_11 << 12)         /**< Shifted mode FORCE_11 for LFXO_CFG          */
#define LFXO_CFG_DRVCURR_FORCE_12            (_LFXO_CFG_DRVCURR_FORCE_12 << 12)         /**< Shifted mode FORCE_12 for LFXO_CFG          */
#define LFXO_CFG_DRVCURR_FORCE_13            (_LFXO_CFG_DRVCURR_FORCE_13 << 12)         /**< Shifted mode FORCE_13 for LFXO_CFG          */
#define LFXO_CFG_DRVCURR_FORCE_14            (_LFXO_CFG_DRVCURR_FORCE_14 << 12)         /**< Shifted mode FORCE_14 for LFXO_CFG          */
#define LFXO_CFG_DRVCURR_FORCE_15            (_LFXO_CFG_DRVCURR_FORCE_15 << 12)         /**< Shifted mode FORCE_15 for LFXO_CFG          */
#define _LFXO_CFG_REFLEVEL_SHIFT             16                                         /**< Shift value for LFXO_REFLEVEL               */
#define _LFXO_CFG_REFLEVEL_MASK              0x30000UL                                  /**< Bit mask for LFXO_REFLEVEL                  */
#define _LFXO_CFG_REFLEVEL_DEFAULT           0x00000001UL                               /**< Mode DEFAULT for LFXO_CFG                   */
#define _LFXO_CFG_REFLEVEL_MIN               0x00000000UL                               /**< Mode MIN for LFXO_CFG                       */
#define _LFXO_CFG_REFLEVEL_RESET             0x00000001UL                               /**< Mode RESET for LFXO_CFG                     */
#define _LFXO_CFG_REFLEVEL_MAX               0x00000003UL                               /**< Mode MAX for LFXO_CFG                       */
#define LFXO_CFG_REFLEVEL_DEFAULT            (_LFXO_CFG_REFLEVEL_DEFAULT << 16)         /**< Shifted mode DEFAULT for LFXO_CFG           */
#define LFXO_CFG_REFLEVEL_MIN                (_LFXO_CFG_REFLEVEL_MIN << 16)             /**< Shifted mode MIN for LFXO_CFG               */
#define LFXO_CFG_REFLEVEL_RESET              (_LFXO_CFG_REFLEVEL_RESET << 16)           /**< Shifted mode RESET for LFXO_CFG             */
#define LFXO_CFG_REFLEVEL_MAX                (_LFXO_CFG_REFLEVEL_MAX << 16)             /**< Shifted mode MAX for LFXO_CFG               */
...
/* Bit fields for LFXO AGCCTRL */
#define _LFXO_AGCCTRL_RESETVALUE             0x00000000UL                               /**< Default value for LFXO_AGCCTRL              */
#define _LFXO_AGCCTRL_MASK                   0x00000001UL                               /**< Mask for LFXO_AGCCTRL                       */
#define LFXO_AGCCTRL_DISAGCCLK               (0x1UL << 0)                               /**< LFXO AGC CLK Disable                        */
#define _LFXO_AGCCTRL_DISAGCCLK_SHIFT        0                                          /**< Shift value for LFXO_DISAGCCLK              */
#define _LFXO_AGCCTRL_DISAGCCLK_MASK         0x1UL                                      /**< Bit mask for LFXO_DISAGCCLK                 */
#define _LFXO_AGCCTRL_DISAGCCLK_DEFAULT      0x00000000UL                               /**< Mode DEFAULT for LFXO_AGCCTRL               */
#define _LFXO_AGCCTRL_DISAGCCLK_ENABLED      0x00000000UL                               /**< Mode ENABLED for LFXO_AGCCTRL               */
#define _LFXO_AGCCTRL_DISAGCCLK_DISABLED     0x00000001UL                               /**< Mode DISABLED for LFXO_AGCCTRL              */
#define LFXO_AGCCTRL_DISAGCCLK_DEFAULT       (_LFXO_AGCCTRL_DISAGCCLK_DEFAULT << 0)     /**< Shifted mode DEFAULT for LFXO_AGCCTRL       */
#define LFXO_AGCCTRL_DISAGCCLK_ENABLED       (_LFXO_AGCCTRL_DISAGCCLK_ENABLED << 0)     /**< Shifted mode ENABLED for LFXO_AGCCTRL       */
#define LFXO_AGCCTRL_DISAGCCLK_DISABLED      (_LFXO_AGCCTRL_DISAGCCLK_DISABLED << 0)    /**< Shifted mode DISABLED for LFXO_AGCCTRL      */

/** @} End of group SIMG301_LFXO_BitFields */
/** @} End of group SIMG301_LFXO */
/** @} End of group Parts */

#endif // SIMG301_LFXO_H
