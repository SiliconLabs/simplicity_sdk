/**************************************************************************//**
 * @file
 * @brief SIMG301 ICACHE register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef SIMG301_ICACHE_H
#define SIMG301_ICACHE_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup SIMG301_ICACHE ICACHE
 * @{
 * @brief SIMG301 ICACHE Register Declaration.
 *****************************************************************************/
...
/** @} End of group SIMG301_ICACHE */

/**************************************************************************//**
 * @addtogroup SIMG301_ICACHE
 * @{
 * @defgroup SIMG301_ICACHE_BitFields ICACHE Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for ICACHE IPVERSION */
#define _ICACHE_IPVERSION_RESETVALUE           0x00000001UL                               /**< Default value for ICACHE_IPVERSION          */
...
#define _ICACHE_IPVERSION_IPVERSION_DEFAULT    0x00000001UL                               /**< Mode DEFAULT for ICACHE_IPVERSION           */
...
#define _ICACHE_CTRL_MASK                      0x00000019UL                             /**< Mask for ICACHE_CTRL                        */
...
#define ICACHE_CTRL_RAMRETAINDIS               (0x1UL << 3)                             /**< RAM retain disable                          */
#define _ICACHE_CTRL_RAMRETAINDIS_SHIFT        3                                        /**< Shift value for ICACHE_RAMRETAINDIS         */
#define _ICACHE_CTRL_RAMRETAINDIS_MASK         0x8UL                                    /**< Bit mask for ICACHE_RAMRETAINDIS            */
#define _ICACHE_CTRL_RAMRETAINDIS_DEFAULT      0x00000000UL                             /**< Mode DEFAULT for ICACHE_CTRL                */
#define ICACHE_CTRL_RAMRETAINDIS_DEFAULT       (_ICACHE_CTRL_RAMRETAINDIS_DEFAULT << 3) /**< Shifted mode DEFAULT for ICACHE_CTRL        */
#define ICACHE_CTRL_DATACACHEDIS               (0x1UL << 4)                             /**< Data cache disable                          */
#define _ICACHE_CTRL_DATACACHEDIS_SHIFT        4                                        /**< Shift value for ICACHE_DATACACHEDIS         */
#define _ICACHE_CTRL_DATACACHEDIS_MASK         0x10UL                                   /**< Bit mask for ICACHE_DATACACHEDIS            */
#define _ICACHE_CTRL_DATACACHEDIS_DEFAULT      0x00000000UL                             /**< Mode DEFAULT for ICACHE_CTRL                */
#define ICACHE_CTRL_DATACACHEDIS_DEFAULT       (_ICACHE_CTRL_DATACACHEDIS_DEFAULT << 4) /**< Shifted mode DEFAULT for ICACHE_CTRL        */
...
#define ICACHE_CMD_INVALIDATE                  (0x1UL << 0)                             /**< Invalidate                                  */
#define _ICACHE_CMD_INVALIDATE_SHIFT           0                                        /**< Shift value for ICACHE_INVALIDATE           */
#define _ICACHE_CMD_INVALIDATE_MASK            0x1UL                                    /**< Bit mask for ICACHE_INVALIDATE              */
#define _ICACHE_CMD_INVALIDATE_DEFAULT         0x00000000UL                             /**< Mode DEFAULT for ICACHE_CMD                 */
#define ICACHE_CMD_INVALIDATE_DEFAULT          (_ICACHE_CMD_INVALIDATE_DEFAULT << 0)    /**< Shifted mode DEFAULT for ICACHE_CMD         */
...
/** @} End of group SIMG301_ICACHE_BitFields */
/** @} End of group SIMG301_ICACHE */
/** @} End of group Parts */

#endif // SIMG301_ICACHE_H
