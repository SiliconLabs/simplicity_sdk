/**************************************************************************//**
 * @file
 * @brief SIMG301 GPIO Port register and bit field definitions
 ******************************************************************************
 * # License
...
typedef struct gpio_port_typedef{
  ...
  __IOM uint32_t AMUXMODE;                      /**< amux mode               */
...
/* Bit fields for GPIO_P AMUXMODE */
#define _GPIO_P_AMUXMODE_RESETVALUE                    0x00000000UL                         /**< Default value for GPIO_P_AMUXMODE           */
#define _GPIO_P_AMUXMODE_MASK                          0x000001FFUL                         /**< Mask for GPIO_P_AMUXMODE                    */
#define _GPIO_P_AMUXMODE_LNEN_SHIFT                    0                                    /**< Shift value for GPIO_LNEN                   */
#define _GPIO_P_AMUXMODE_LNEN_MASK                     0x1FFUL                              /**< Bit mask for GPIO_LNEN                      */
#define _GPIO_P_AMUXMODE_LNEN_DEFAULT                  0x00000000UL                         /**< Mode DEFAULT for GPIO_P_AMUXMODE            */
#define GPIO_P_AMUXMODE_LNEN_DEFAULT                   (_GPIO_P_AMUXMODE_LNEN_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_P_AMUXMODE    */
/** @} End of group Parts */
