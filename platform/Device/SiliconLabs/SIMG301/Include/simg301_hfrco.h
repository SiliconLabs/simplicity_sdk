/**************************************************************************//**
 * @file
 * @brief SIMG301 HFRCO register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef SIMG301_HFRCO_H
#define SIMG301_HFRCO_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup SIMG301_HFRCO HFRCO
 * @{
 * @brief SIMG301 HFRCO Register Declaration.
 *****************************************************************************/
...
/** @} End of group SIMG301_HFRCO */

/**************************************************************************//**
 * @addtogroup SIMG301_HFRCO
 * @{
 * @defgroup SIMG301_HFRCO_BitFields HFRCO Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for HFRCO IPVERSION */
#define _HFRCO_IPVERSION_RESETVALUE           0x00000003UL                              /**< Default value for HFRCO_IPVERSION           */
...
#define _HFRCO_IPVERSION_IPVERSION_DEFAULT    0x00000003UL                              /**< Mode DEFAULT for HFRCO_IPVERSION            */
...
#define _HFRCO_CAL_RESETVALUE                 0xA60307DBUL                              /**< Default value for HFRCO_CAL                 */
#define _HFRCO_CAL_MASK                       0xFFFFFFFFUL                              /**< Mask for HFRCO_CAL                          */
#define _HFRCO_CAL_TUNING_SHIFT               0                                         /**< Shift value for HFRCO_TUNING                */
#define _HFRCO_CAL_TUNING_MASK                0x3FUL                                    /**< Bit mask for HFRCO_TUNING                   */
#define _HFRCO_CAL_TUNING_DEFAULT             0x0000001BUL                              /**< Mode DEFAULT for HFRCO_CAL                  */
#define HFRCO_CAL_TUNING_DEFAULT              (_HFRCO_CAL_TUNING_DEFAULT << 0)          /**< Shifted mode DEFAULT for HFRCO_CAL          */
#define _HFRCO_CAL_FINETUNING_SHIFT           6                                         /**< Shift value for HFRCO_FINETUNING            */
#define _HFRCO_CAL_FINETUNING_MASK            0xFC0UL                                   /**< Bit mask for HFRCO_FINETUNING               */
#define _HFRCO_CAL_FINETUNING_DEFAULT         0x0000001FUL                              /**< Mode DEFAULT for HFRCO_CAL                  */
#define HFRCO_CAL_FINETUNING_DEFAULT          (_HFRCO_CAL_FINETUNING_DEFAULT << 6)      /**< Shifted mode DEFAULT for HFRCO_CAL          */
#define _HFRCO_CAL_BANDCOARSE_SHIFT           12                                        /**< Shift value for HFRCO_BANDCOARSE            */
#define _HFRCO_CAL_BANDCOARSE_MASK            0x7000UL                                  /**< Bit mask for HFRCO_BANDCOARSE               */
#define _HFRCO_CAL_BANDCOARSE_DEFAULT         0x00000000UL                              /**< Mode DEFAULT for HFRCO_CAL                  */
#define HFRCO_CAL_BANDCOARSE_DEFAULT          (_HFRCO_CAL_BANDCOARSE_DEFAULT << 12)     /**< Shifted mode DEFAULT for HFRCO_CAL          */
#define _HFRCO_CAL_BANDFINE_SHIFT             15                                        /**< Shift value for HFRCO_BANDFINE              */
#define _HFRCO_CAL_BANDFINE_MASK              0x1F8000UL                                /**< Bit mask for HFRCO_BANDFINE                 */
#define _HFRCO_CAL_BANDFINE_DEFAULT           0x00000006UL                              /**< Mode DEFAULT for HFRCO_CAL                  */
#define HFRCO_CAL_BANDFINE_DEFAULT            (_HFRCO_CAL_BANDFINE_DEFAULT << 15)       /**< Shifted mode DEFAULT for HFRCO_CAL          */
#define _HFRCO_CAL_CLKDIV_SHIFT               21                                        /**< Shift value for HFRCO_CLKDIV                */
#define _HFRCO_CAL_CLKDIV_MASK                0x600000UL                                /**< Bit mask for HFRCO_CLKDIV                   */
...
#define _HFRCO_CAL_CLKDIV_DIV8                0x00000003UL                              /**< Mode DIV8 for HFRCO_CAL                     */
#define HFRCO_CAL_CLKDIV_DEFAULT              (_HFRCO_CAL_CLKDIV_DEFAULT << 21)         /**< Shifted mode DEFAULT for HFRCO_CAL          */
#define HFRCO_CAL_CLKDIV_DIV1                 (_HFRCO_CAL_CLKDIV_DIV1 << 21)            /**< Shifted mode DIV1 for HFRCO_CAL             */
#define HFRCO_CAL_CLKDIV_DIV2                 (_HFRCO_CAL_CLKDIV_DIV2 << 21)            /**< Shifted mode DIV2 for HFRCO_CAL             */
#define HFRCO_CAL_CLKDIV_DIV4                 (_HFRCO_CAL_CLKDIV_DIV4 << 21)            /**< Shifted mode DIV4 for HFRCO_CAL             */
#define HFRCO_CAL_CLKDIV_DIV8                 (_HFRCO_CAL_CLKDIV_DIV8 << 21)            /**< Shifted mode DIV8 for HFRCO_CAL             */
#define _HFRCO_CAL_SIGMADELTA_SHIFT           23                                        /**< Shift value for HFRCO_SIGMADELTA            */
#define _HFRCO_CAL_SIGMADELTA_MASK            0x1800000UL                               /**< Bit mask for HFRCO_SIGMADELTA               */
#define _HFRCO_CAL_SIGMADELTA_DEFAULT         0x00000000UL                              /**< Mode DEFAULT for HFRCO_CAL                  */
#define HFRCO_CAL_SIGMADELTA_DEFAULT          (_HFRCO_CAL_SIGMADELTA_DEFAULT << 23)     /**< Shifted mode DEFAULT for HFRCO_CAL          */
#define _HFRCO_CAL_BIAS_SHIFT                 25                                        /**< Shift value for HFRCO_BIAS                  */
#define _HFRCO_CAL_BIAS_MASK                  0xE000000UL                               /**< Bit mask for HFRCO_BIAS                     */
#define _HFRCO_CAL_BIAS_DEFAULT               0x00000003UL                              /**< Mode DEFAULT for HFRCO_CAL                  */
#define HFRCO_CAL_BIAS_DEFAULT                (_HFRCO_CAL_BIAS_DEFAULT << 25)           /**< Shifted mode DEFAULT for HFRCO_CAL          */
#define _HFRCO_CAL_TEMPCO_SHIFT               28                                        /**< Shift value for HFRCO_TEMPCO                */
#define _HFRCO_CAL_TEMPCO_MASK                0xF0000000UL                              /**< Bit mask for HFRCO_TEMPCO                   */
#define _HFRCO_CAL_TEMPCO_DEFAULT             0x0000000AUL                              /**< Mode DEFAULT for HFRCO_CAL                  */
#define HFRCO_CAL_TEMPCO_DEFAULT              (_HFRCO_CAL_TEMPCO_DEFAULT << 28)         /**< Shifted mode DEFAULT for HFRCO_CAL          */
...
/** @} End of group SIMG301_HFRCO_BitFields */
/** @} End of group SIMG301_HFRCO */
/** @} End of group Parts */

#endif // SIMG301_HFRCO_H
