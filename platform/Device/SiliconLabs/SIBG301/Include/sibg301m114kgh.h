 ...
 *
 *****************************************************************************/
#ifndef SIBG301M114KGH_H
#define SIBG301M114KGH_H
...
/**************************************************************************//**
 * @defgroup SIBG301M114KGH SIBG301M114KGH
 * @{
 *****************************************************************************/
...
typedef enum IRQn{
  ...
  /******  SIBG301 Peripheral Interrupt Numbers ******************************************/
  ...
  LEDDRV0_IRQn           = 77, /*!< 77 Si LEDDRV0 Interrupt */
...
/**************************************************************************//**
 * @defgroup SIBG301M114KGH_Core SIBG301M114KGH Core
 * @{
...
/** @} End of group SIBG301M114KGH_Core */

/**************************************************************************//**
* @defgroup SIBG301M114KGH_Part SIBG301M114KGH Part
* @{
******************************************************************************/
...
#if !defined(SIBG301M114KGH)
#define SIBG301M114KGH    1 /**< FULL Part */
#endif

/** Configure part number */
#define PART_NUMBER                                       "SIBG301M114KGH" /**< Part Number */

/** Family / Line / Series / Config */
#define _SI_BLUE_FAMILY                                   1                              /** Device Family Name Identifier */
#define _SI_BG_FAMILY                                     1                              /** Device Family Identifier */
...
/** Flash and SRAM limits for SIBG301M114KGH */
...
#define FLASH_SIZE                                        (0x001D0000UL) /**< Available Flash Memory */
...
#define LEDDRV_PRESENT                                      /** LEDDRV is available in this part */
#define LEDDRV_COUNT                                      1 /** 1 LEDDRVs available  */
...
#include "system_sibg301.h" /* System Header File */

/** @} End of group SIBG301M114KGH_Part */

/**************************************************************************//**
 * @defgroup SIBG301M114KGH_Peripheral_TypeDefs SIBG301M114KGH Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/
#include "sibg301_devinfo.h"
#include "sibg301_letimer.h"
#include "sibg301_adc.h"
#include "sibg301_acmp.h"
#include "sibg301_pcnt.h"
#include "sibg301_hfrco.h"
#include "sibg301_hfxo.h"
#include "sibg301_i2c.h"
#include "sibg301_wdog.h"
#include "sibg301_eusart.h"
#include "sibg301_socpll.h"
#include "sibg301_cmu.h"
#include "sibg301_hydraram.h"
#include "sibg301_ldma.h"
#include "sibg301_fsrco.h"
#include "sibg301_dpll.h"
#include "sibg301_lfxo.h"
#include "sibg301_lfrco.h"
#include "sibg301_ulfrco.h"
#include "sibg301_semaphore.h"
#include "sibg301_icache.h"
#include "sibg301_prs.h"
#include "sibg301_gpio.h"
#include "sibg301_ldmaxbar.h"
#include "sibg301_timer.h"
#include "sibg301_etampdet.h"
#include "sibg301_l2cache.h"
#include "sibg301_pixelrz.h"
#include "sibg301_burtc.h"
#include "sibg301_syscfg.h"
#include "sibg301_buram.h"
#include "sibg301_gpcrc.h"
#include "sibg301_leddrv.h"
#include "sibg301_rpa.h"
#include "sibg301_ksu.h"
#include "sibg301_symcrypto.h"
#include "sibg301_smu.h"
#include "sibg301_semailbox.h"
#include "sibg301_sysrtc.h"
#include "sibg301_scratchpad.h"
#include "sibg301_emu.h"
#include "sibg301_seportal.h"
#include "sibg301_lpw0portal.h"
#include "sibg301_hostportal.h"
#include "sibg301_devinfo_defines.h"

/* Custom headers for LDMAXBAR and PRS mappings */
#include "sibg301_prs_signals.h"
#include "sibg301_dma_descriptor.h"
#include "sibg301_ldmaxbar_defines.h"

/** @} End of group SIBG301M114KGH_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup SIBG301M114KGH_Peripheral_Base SIBG301M114KGH Peripheral Memory Map
 * @{
 *****************************************************************************/
...
#define LEDDRV0_S_BASE            (0x50880000UL) /* LEDDRV0_S base address */
...
#define LEDDRV0_NS_BASE           (0x40880000UL) /* LEDDRV0_NS base address */
...
#if ((defined(SL_TRUSTZONE_SECURE) && !defined(SL_TRUSTZONE_PERIPHERAL_LEDDRV0_S)) || (defined(SL_TRUSTZONE_PERIPHERAL_LEDDRV0_S) && (SL_TRUSTZONE_PERIPHERAL_LEDDRV0_S != 0)))
#define LEDDRV0_BASE           (LEDDRV0_S_BASE)              /* LEDDRV0 base address */
#else
#define LEDDRV0_BASE           (LEDDRV0_NS_BASE)             /* LEDDRV0 base address */
#endif // SL_TRUSTZONE_PERIPHERAL_LEDDRV0_S
...
/** @} End of group SIBG301M114KGH_Peripheral_Base */

/**************************************************************************//**
 * @defgroup SIBG301M114KGH_Peripheral_Declaration SIBG301M114KGH Peripheral Declarations Map
 * @{
 *****************************************************************************/
...
#define LEDDRV0_S            ((LEDDRV_TypeDef *) LEDDRV0_S_BASE)                 /**< LEDDRV0_S base pointer */
...
#define LEDDRV0_NS           ((LEDDRV_TypeDef *) LEDDRV0_NS_BASE)                /**< LEDDRV0_NS base pointer */
...
#define LEDDRV0              ((LEDDRV_TypeDef *) LEDDRV0_BASE)                   /**< LEDDRV0 base pointer */
...
/** @} End of group SIBG301M114KGH_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup SIBG301M114KGH_Peripheral_Parameters SIBG301M114KGH Peripheral Parameters
 * @{
...
/* Instance macros for LEDDRV */
#define LEDDRV(n)                    (((n) == 0) ? LEDDRV0 \
                                      : 0x0UL)
#define LEDDRV_NUM(ref)              (((ref) == LEDDRV0) ? 0 \
                                      : -1)
...
/** @} End of group SIBG301M114KGH_Peripheral_Parameters  */

/** @} End of group SIBG301M114KGH */
/** @}} End of group Parts */
