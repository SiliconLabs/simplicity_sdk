...
#if defined(_CMU_CLKEN2_EUSART2_SHIFT)
// Define EUSART2 peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_EUSART2_VALUE = (BUS_CLOCK_CLKEN2 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN2_EUSART2_SHIFT;
#endif

#if defined(_CMU_CLKEN2_EUSART3_SHIFT)
// Define EUSART3 peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_EUSART3_VALUE = (BUS_CLOCK_CLKEN2 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN2_EUSART3_SHIFT;
#endif
...
#if defined(_CMU_CLKEN2_I2C2_SHIFT)
// Define I2C2 peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_I2C2_VALUE = (BUS_CLOCK_CLKEN2 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN2_I2C2_SHIFT;
#endif

#if defined(_CMU_CLKEN2_I2C3_SHIFT)
// Define I2C3 peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_I2C3_VALUE = (BUS_CLOCK_CLKEN2 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN2_I2C3_SHIFT;
#endif
...
const uint32_t SL_BUS_CLOCK_TIMER5_VALUE = (BUS_CLOCK_CLKEN2 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN2_TIMER5_SHIFT;
#endif

#if defined(_CMU_CLKEN2_TIMER6_SHIFT)
// Define TIMER6 peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_TIMER6_VALUE = (BUS_CLOCK_CLKEN2 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN2_TIMER6_SHIFT;
#endif

#if defined(_CMU_CLKEN2_TIMER7_SHIFT)
// Define TIMER7 peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_TIMER7_VALUE = (BUS_CLOCK_CLKEN2 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN2_TIMER7_SHIFT;
#endif

#if defined(_CMU_CLKEN2_TIMER8_SHIFT)
// Define TIMER8 peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_TIMER8_VALUE = (BUS_CLOCK_CLKEN2 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN2_TIMER8_SHIFT;
#endif

#if defined(_CMU_CLKEN2_TIMER9_SHIFT)
// Define TIMER9 peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_TIMER9_VALUE = (BUS_CLOCK_CLKEN2 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN2_TIMER9_SHIFT;
#endif
...
#if defined(_CMU_CLKEN2_USART1_SHIFT)
// Define USART1 peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_USART1_VALUE = (BUS_CLOCK_CLKEN2 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN2_USART1_SHIFT;
#endif

#if defined(_CMU_CLKEN2_USART2_SHIFT)
// Define USART2 peripheral bus clock value.
const uint32_t SL_BUS_CLOCK_USART2_VALUE = (BUS_CLOCK_CLKEN2 << _BUS_CLOCK_CLKENX_SHIFT) | _CMU_CLKEN2_USART2_SHIFT;
#endif
