...
RESET_EXT_DEF(BOOTLOADER, BADAPP, 0x08U, "BAP")                // Application verification failed
RESET_EXT_DEF(BOOTLOADER, UPGRADE, 0x09U, "UPG")               // Bootloader requested that first stage upgrades main bootloader
RESET_EXT_DEF(BOOTLOADER, TIMEOUT, 0x0AU, "TME")               // Bootloader timed out waiting for upgrade image
RESET_EXT_DEF(BOOTLOADER, FAULT, 0x0BU, "FAU")                 // Soft-reset was forced to handle a fault
RESET_EXT_DEF(BOOTLOADER, TZFAULT, 0x0CU, "TZF")               // Soft-reset was forced to handle a security fault
