...
//Any _LOCATION <256 will dispatch to tokenManager by halInternalGetTokenData.
...
//Any _LOCATION <256 will dispatch to tokenManager by halInternalGetTokenData.
//Overloading the location with 0x1000 will keep the token out of tokenManager and
...
//Overloading the location with 0x2000 will keep the token out of tokenManager and
...
//Overloading the location with 0x3000 will keep the token out of tokenManager and
