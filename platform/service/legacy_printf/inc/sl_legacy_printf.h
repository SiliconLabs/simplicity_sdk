...
#define Ecode_t sl_status_t

/** @name Printf Prototypes
 * These prototypes are for the internal printf implementation, in case
 * it is desired to use it elsewhere. See the code for sli_legacy_serial_printf()
 ...
 *
 * @return The sl_status_t value of the typedefined function.
 */
typedef sl_status_t (emPrintfFlushHandler)(COM_Port_t flushVar,
                                           uint8_t *contents,
                                           uint8_t length);
