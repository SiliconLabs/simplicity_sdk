...
// <o SL_TOKEN_MANAGER_KLV_SECURITY_TYPE> The Static Secure Tokens Security Type
// <i> The static secure tokens are secured and stored.
// <i> Currently, only authenticated encryption is supported.
// <SL_TOKEN_MANAGER_KLV_SECURITY_TYPE_AEAD=> Authenticated Encryption
// <i> Default: SL_TOKEN_MANAGER_KLV_SECURITY_TYPE_AEAD
#define SL_TOKEN_MANAGER_KLV_SECURITY_TYPE  SL_TOKEN_MANAGER_KLV_SECURITY_TYPE_AEAD
#endif
