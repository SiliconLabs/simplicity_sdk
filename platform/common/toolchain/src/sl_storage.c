...
#define SERIES_3_BOOTLOADER_SIZE 0x8000UL
#define SERIES_2_BOOTLOADER_SIZE 0x4000UL
...
#else
  #if defined(FLASH_SIZE) && defined(_SILICON_LABS_32B_SERIES_3)
// Default storage size is 32 kB less than half the flash size
    #define _SL_BOOTLOADER_STORAGE_SIZE  ((FLASH_SIZE / 2UL) - SERIES_3_BOOTLOADER_SIZE)
  #elif defined(FLASH_SIZE) && defined(_SILICON_LABS_32B_SERIES_2)
// Default storage size is 16 kB less than half the flash size
    #define _SL_BOOTLOADER_STORAGE_SIZE  ((FLASH_SIZE / 2UL) - SERIES_2_BOOTLOADER_SIZE)
  #else
// Default to predefined storage size if no conditions are met
    #define _SL_BOOTLOADER_STORAGE_SIZE  SL_BOOTLOADER_STORAGE_SIZE
  #endif
#endif
