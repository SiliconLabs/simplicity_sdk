 ...
 */
#define SL_BT_VERSION_BUILD 581

/**
 * @brief The hash value of the build the Bluetooth SDK was created from
 */
#define SL_BT_VERSION_HASH {0xf1,0xaf,0x58,0xa7,0xfd,0xb1,0xaa,0x92,0x80,0x88,0xbf,0xe1,0xf7,0x95,0xc2,0xe5,0x32,0x90,0xc8,0x19}
