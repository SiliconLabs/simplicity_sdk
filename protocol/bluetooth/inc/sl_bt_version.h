 ...
 */
#define SL_BT_VERSION_BUILD 135

/**
 * @brief The hash value of the build the Bluetooth SDK was created from
 */
#define SL_BT_VERSION_HASH {0xba,0x29,0x27,0x60,0x50,0x4f,0xea,0xc5,0x70,0xec,0xd6,0x73,0xc5,0xdc,0x2e,0x5e,0x68,0x85,0x0b,0xfe}
