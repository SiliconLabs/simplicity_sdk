...
// <q SL_BT_CONTROLLER_2M_PHY_SUPPORT> Bluetooth Controller 2M PHY support
...
// <q SL_BT_CONTROLLER_CODED_PHY_SUPPORT> Bluetooth Controller Coded and SimulScan PHY support
