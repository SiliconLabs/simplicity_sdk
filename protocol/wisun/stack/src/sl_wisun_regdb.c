...
const sl_wisun_chan_params_t chan_params_table[] = {
  ...
  *      regulatory_domain        |     regional_regulation        | chan0_freq_hz      |    |       valid phy_mode_ids         chan_allowed */
  ...
  { SL_WISUN_REGULATORY_DOMAIN_JP, 1, SL_WISUN_REGULATION_ARIB,  0xff,  920600000,  200000,  38, {  2,                         }, NULL },
  { SL_WISUN_REGULATORY_DOMAIN_JP, 2, SL_WISUN_REGULATION_ARIB,  0xff,  920900000,  400000,  18, {  4,  5,                     }, NULL },
  { SL_WISUN_REGULATORY_DOMAIN_JP, 3, SL_WISUN_REGULATION_ARIB,  0xff,  920800000,  600000,  12, {  7,  8,                     }, NULL },
  { SL_WISUN_REGULATORY_DOMAIN_JP, 0, SL_WISUN_REGULATION_ARIB,    21,  920600000,  200000,  38, {  2, 18, 84, 85, 86,         }, "9-37", },
  { SL_WISUN_REGULATORY_DOMAIN_JP, 0, SL_WISUN_REGULATION_ARIB,    22,  920900000,  400000,  18, {  4,  5, 20, 21, 68, 69, 70, }, "4-17", },
  { SL_WISUN_REGULATORY_DOMAIN_JP, 0, SL_WISUN_REGULATION_ARIB,    23,  920800000,  600000,  12, {  7,  8, 23, 24,             }, "3-11", },
