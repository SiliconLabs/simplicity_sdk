...
static sl_zigbee_af_event_t detected_keyword_event;
...
static void detected_keywork_event_handler(sl_zigbee_af_event_t *event)
{
  sl_status_t status;
...
void sl_zigbee_af_main_init_cb(void)
{
  ...
  sl_zigbee_af_event_init(&detected_keyword_event, detected_keywork_event_handler);
}
...
void keyword_detected(uint8_t found_command_index)
{
  ...
  sl_zigbee_af_event_set_active(&detected_keyword_event);
}
