...
void (*sl_high_datarate_phy_rx_callback)(uint8_t *packet, uint8_t linkQuality, int8_t rssi) = NULL;
...
void sl_mac_high_datarate_phy_rx_callback(uint8_t *packet, uint8_t linkQuality, int8_t rssi)
{
  if (sl_high_datarate_phy_rx_callback != NULL) {
    (*sl_high_datarate_phy_rx_callback)(packet, linkQuality, rssi);
  }
}
/**
