...
// needed for sl_zigbee_signature_data_t
...
void afReportEventStatusHandler(uint32_t eventId,
                                ...
                                uint8_t* message,
                                sl_zigbee_signature_data_t* signature);
 ...
 */
bool sl_zigbee_af_drlc_event_action_cb(sl_zigbee_af_load_control_event_t *loadControlEvent,
