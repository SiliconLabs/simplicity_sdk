 ...
 *
 **/
void sl_zigbee_af_prepayment_schedule_prepayment_mode(uint8_t endpoint, uint32_t providerId, uint32_t issuerEventId, uint32_t dateTimeUtc, uint16_t paymentControlConfig);
