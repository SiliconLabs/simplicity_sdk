...
#define SUMMATION_TIERS SL_ZIGBEE_AF_PLUGIN_METER_SNAPSHOT_STORAGE_SUM_TIERS_SUPPORTED
#define BLOCK_TIERS  SL_ZIGBEE_AF_PLUGIN_METER_SNAPSHOT_STORAGE_BLOCK_TIERS_SUPPORTED
...
typedef struct {
  ...
  sl_802154_short_addr_t requestingId;
  uint8_t tiersInUse;
  ...
  uint8_t payloadType;
} sl_zigbee_af_snapshot_payload_t;
...
} sl_zigbee_af_snapshot_schedule_payload_t;
