...
#define EZSP_PROTOCOL_VERSION     0x0E
...
// this ezsp frame is the response to an sl_zigbee_ezsp_callback().
...
// be set only in the uart version when SL_ZIGBEE_EZSP_VALUE_UART_SYNCH_CALLBACKS is 0.
