...
#define sl_zigbee_gp_clear_proxy_table sl_zigbee_ezsp_gp_clear_proxy_table
#define sl_zigbee_gp_proxy_table_remove_entry sl_zigbee_ezsp_gp_proxy_table_remove_entry
