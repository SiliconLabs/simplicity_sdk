...
// void versionCB(void)
//   {  sli_legacy_serial_printf(APP_SERIAL, "version 0.1\r\n"); }
//
// void resetCB(void)
//   { while (1) ; }
//
...
//     printBindingTableUtil(APP_SERIAL, SL_ZIGBEE_BINDING_TABLE_SIZE);
//   }
// }
//
// // match top-level commands to the functions they will call
// sli_zigbee_cli_serial_cmd_entry_t cliCmdList[] = {
//   {"version", versionCB},
//   {"reset", resetCB},
//   {"print", printCB}
// };
// uint8_t cliCmdListLen = sizeof(cliCmdList)/sizeof(sli_zigbee_cli_serial_cmd_entry_t);
//
// // define the prompt
...
typedef const struct cliSerialCmdEntryS {
  const char * cmd;
  void (*action)(void);
} sli_zigbee_cli_serial_cmd_entry_t;

// *********************************************
// the application needs to define these:
// --------------------------------------
extern sli_zigbee_cli_serial_cmd_entry_t cliCmdList[];
