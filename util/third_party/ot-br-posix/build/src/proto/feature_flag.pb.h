...
class FeatureFlagList final :
 ...
 public:
  ...
  enum : int {
    ...
    kEnableEphemeralkeyFieldNumber = 8,
  ...
  bool has_enable_ephemeralkey() const;
  private:
  bool _internal_has_enable_ephemeralkey() const;
  public:
  void clear_enable_ephemeralkey();
  bool enable_ephemeralkey() const;
  void set_enable_ephemeralkey(bool value);
  private:
  bool _internal_enable_ephemeralkey() const;
  void _internal_set_enable_ephemeralkey(bool value);
  public:
...
// optional bool enable_ephemeralkey = 8 [default = false];
inline bool FeatureFlagList::_internal_has_enable_ephemeralkey() const {
  bool value = (_impl_._has_bits_[0] & 0x00000040u) != 0;
  return value;
}
inline bool FeatureFlagList::has_enable_ephemeralkey() const {
  return _internal_has_enable_ephemeralkey();
}
inline void FeatureFlagList::clear_enable_ephemeralkey() {
  _impl_.enable_ephemeralkey_ = false;
  _impl_._has_bits_[0] &= ~0x00000040u;
}
inline bool FeatureFlagList::_internal_enable_ephemeralkey() const {
  return _impl_.enable_ephemeralkey_;
}
inline bool FeatureFlagList::enable_ephemeralkey() const {
  // @@protoc_insertion_point(field_get:otbr.FeatureFlagList.enable_ephemeralkey)
  return _internal_enable_ephemeralkey();
}
inline void FeatureFlagList::_internal_set_enable_ephemeralkey(bool value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.enable_ephemeralkey_ = value;
}
inline void FeatureFlagList::set_enable_ephemeralkey(bool value) {
  _internal_set_enable_ephemeralkey(value);
  // @@protoc_insertion_point(field_set:otbr.FeatureFlagList.enable_ephemeralkey)
}
