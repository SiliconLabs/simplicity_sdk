...
PROTOBUF_CONSTEXPR FeatureFlagList::FeatureFlagList(
  ...
  , /*decltype(_impl_.enable_ephemeralkey_)*/false
...
class FeatureFlagList::_Internal {
 public:
  ...
  static void set_has_enable_ephemeralkey(HasBits* has_bits) {
    (*has_bits)[0] |= 64u;
  }
};
...
FeatureFlagList::FeatureFlagList(const FeatureFlagList& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.enable_ephemeralkey_){}
...
// @@protoc_insertion_point(message_clear_start:otbr.FeatureFlagList)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ::memset(&_impl_.enable_nat64_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.enable_ephemeralkey_) -
        reinterpret_cast<char*>(&_impl_.enable_nat64_)) + sizeof(_impl_.enable_ephemeralkey_));
    ...
    switch (tag >> 3) {
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 64)) {
          _Internal::set_has_enable_ephemeralkey(&has_bits);
          _impl_.enable_ephemeralkey_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* FeatureFlagList::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000040u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(8, this->_internal_enable_ephemeralkey(), target);
  }
...
void FeatureFlagList::MergeFrom(const FeatureFlagList& from) {
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000040u) {
      _this->_impl_.enable_ephemeralkey_ = from._impl_.enable_ephemeralkey_;
    }
    if (cached_has_bits & 0x00000080u) {
...
void FeatureFlagList::InternalSwap(FeatureFlagList* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FeatureFlagList, _impl_.enable_ephemeralkey_)
      + sizeof(FeatureFlagList::_impl_.enable_ephemeralkey_)
