...
class TelemetryData_BorderAgentCounters;
struct TelemetryData_BorderAgentCountersDefaultTypeInternal;
extern TelemetryData_BorderAgentCountersDefaultTypeInternal _TelemetryData_BorderAgentCounters_default_instance_;
class TelemetryData_BorderAgentInfo;
struct TelemetryData_BorderAgentInfoDefaultTypeInternal;
extern TelemetryData_BorderAgentInfoDefaultTypeInternal _TelemetryData_BorderAgentInfo_default_instance_;
...
class TelemetryData_ExternalRoutes;
struct TelemetryData_ExternalRoutesDefaultTypeInternal;
extern TelemetryData_ExternalRoutesDefaultTypeInternal _TelemetryData_ExternalRoutes_default_instance_;
...
template<> ::threadnetwork::TelemetryData_BorderAgentCounters* Arena::CreateMaybeMessage<::threadnetwork::TelemetryData_BorderAgentCounters>(Arena*);
template<> ::threadnetwork::TelemetryData_BorderAgentInfo* Arena::CreateMaybeMessage<::threadnetwork::TelemetryData_BorderAgentInfo>(Arena*);
...
template<> ::threadnetwork::TelemetryData_ExternalRoutes* Arena::CreateMaybeMessage<::threadnetwork::TelemetryData_ExternalRoutes>(Arena*);
...
class TelemetryData_WpanTopoFull final :
 ...
 public:
  ...
  bool has_peer_br_count() const;
  private:
  bool _internal_has_peer_br_count() const;
  public:
  void clear_peer_br_count();
  uint32_t peer_br_count() const;
  void set_peer_br_count(uint32_t value);
  private:
  uint32_t _internal_peer_br_count() const;
  void _internal_set_peer_br_count(uint32_t value);
  public:
...
class TelemetryData_ExternalRoutes final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:threadnetwork.TelemetryData.ExternalRoutes) */ {
 public:
  inline TelemetryData_ExternalRoutes() : TelemetryData_ExternalRoutes(nullptr) {}
  ~TelemetryData_ExternalRoutes() override;
  explicit PROTOBUF_CONSTEXPR TelemetryData_ExternalRoutes(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  TelemetryData_ExternalRoutes(const TelemetryData_ExternalRoutes& from);
  TelemetryData_ExternalRoutes(TelemetryData_ExternalRoutes&& from) noexcept
    : TelemetryData_ExternalRoutes() {
    *this = ::std::move(from);
  }

  inline TelemetryData_ExternalRoutes& operator=(const TelemetryData_ExternalRoutes& from) {
    CopyFrom(from);
    return *this;
  }
  inline TelemetryData_ExternalRoutes& operator=(TelemetryData_ExternalRoutes&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const TelemetryData_ExternalRoutes& default_instance() {
    return *internal_default_instance();
  }
  static inline const TelemetryData_ExternalRoutes* internal_default_instance() {
    return reinterpret_cast<const TelemetryData_ExternalRoutes*>(
               &_TelemetryData_ExternalRoutes_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    23;

  friend void swap(TelemetryData_ExternalRoutes& a, TelemetryData_ExternalRoutes& b) {
    a.Swap(&b);
  }
  inline void Swap(TelemetryData_ExternalRoutes* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(TelemetryData_ExternalRoutes* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  TelemetryData_ExternalRoutes* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<TelemetryData_ExternalRoutes>(arena);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
  void CopyFrom(const TelemetryData_ExternalRoutes& from);
  void MergeFrom(const TelemetryData_ExternalRoutes& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(TelemetryData_ExternalRoutes* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "threadnetwork.TelemetryData.ExternalRoutes";
  }
  protected:
  explicit TelemetryData_ExternalRoutes(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kHasDefaultRouteAddedFieldNumber = 1,
    kHasUlaRouteAddedFieldNumber = 2,
    kHasOthersRouteAddedFieldNumber = 3,
  };
  // optional bool has_default_route_added = 1;
  bool has_has_default_route_added() const;
  private:
  bool _internal_has_has_default_route_added() const;
  public:
  void clear_has_default_route_added();
  bool has_default_route_added() const;
  void set_has_default_route_added(bool value);
  private:
  bool _internal_has_default_route_added() const;
  void _internal_set_has_default_route_added(bool value);
  public:

  // optional bool has_ula_route_added = 2;
  bool has_has_ula_route_added() const;
  private:
  bool _internal_has_has_ula_route_added() const;
  public:
  void clear_has_ula_route_added();
  bool has_ula_route_added() const;
  void set_has_ula_route_added(bool value);
  private:
  bool _internal_has_ula_route_added() const;
  void _internal_set_has_ula_route_added(bool value);
  public:

  // optional bool has_others_route_added = 3;
  bool has_has_others_route_added() const;
  private:
  bool _internal_has_has_others_route_added() const;
  public:
  void clear_has_others_route_added();
  bool has_others_route_added() const;
  void set_has_others_route_added(bool value);
  private:
  bool _internal_has_others_route_added() const;
  void _internal_set_has_others_route_added(bool value);
  public:

  // @@protoc_insertion_point(class_scope:threadnetwork.TelemetryData.ExternalRoutes)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    bool has_default_route_added_;
    bool has_ula_route_added_;
    bool has_others_route_added_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_thread_5ftelemetry_2eproto;
};
...
class TelemetryData_BorderAgentCounters final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:threadnetwork.TelemetryData.BorderAgentCounters) */ {
 public:
  inline TelemetryData_BorderAgentCounters() : TelemetryData_BorderAgentCounters(nullptr) {}
  ~TelemetryData_BorderAgentCounters() override;
  explicit PROTOBUF_CONSTEXPR TelemetryData_BorderAgentCounters(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  TelemetryData_BorderAgentCounters(const TelemetryData_BorderAgentCounters& from);
  TelemetryData_BorderAgentCounters(TelemetryData_BorderAgentCounters&& from) noexcept
    : TelemetryData_BorderAgentCounters() {
    *this = ::std::move(from);
  }

  inline TelemetryData_BorderAgentCounters& operator=(const TelemetryData_BorderAgentCounters& from) {
    CopyFrom(from);
    return *this;
  }
  inline TelemetryData_BorderAgentCounters& operator=(TelemetryData_BorderAgentCounters&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const TelemetryData_BorderAgentCounters& default_instance() {
    return *internal_default_instance();
  }
  static inline const TelemetryData_BorderAgentCounters* internal_default_instance() {
    return reinterpret_cast<const TelemetryData_BorderAgentCounters*>(
               &_TelemetryData_BorderAgentCounters_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    24;

  friend void swap(TelemetryData_BorderAgentCounters& a, TelemetryData_BorderAgentCounters& b) {
    a.Swap(&b);
  }
  inline void Swap(TelemetryData_BorderAgentCounters* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(TelemetryData_BorderAgentCounters* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  TelemetryData_BorderAgentCounters* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<TelemetryData_BorderAgentCounters>(arena);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
  void CopyFrom(const TelemetryData_BorderAgentCounters& from);
  void MergeFrom(const TelemetryData_BorderAgentCounters& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(TelemetryData_BorderAgentCounters* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "threadnetwork.TelemetryData.BorderAgentCounters";
  }
  protected:
  explicit TelemetryData_BorderAgentCounters(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kEpskcActivationsFieldNumber = 1,
    kEpskcDeactivationClearsFieldNumber = 2,
    kEpskcDeactivationTimeoutsFieldNumber = 3,
    kEpskcDeactivationMaxAttemptsFieldNumber = 4,
    kEpskcDeactivationDisconnectsFieldNumber = 5,
    kEpskcInvalidBaStateErrorsFieldNumber = 6,
    kEpskcInvalidArgsErrorsFieldNumber = 7,
    kEpskcStartSecureSessionErrorsFieldNumber = 8,
    kEpskcSecureSessionSuccessesFieldNumber = 9,
    kEpskcSecureSessionFailuresFieldNumber = 10,
    kEpskcCommissionerPetitionsFieldNumber = 11,
    kPskcSecureSessionSuccessesFieldNumber = 12,
    kPskcSecureSessionFailuresFieldNumber = 13,
    kPskcCommissionerPetitionsFieldNumber = 14,
    kMgmtActiveGetReqsFieldNumber = 15,
    kMgmtPendingGetReqsFieldNumber = 16,
  };
  // optional uint32 epskc_activations = 1;
  bool has_epskc_activations() const;
  private:
  bool _internal_has_epskc_activations() const;
  public:
  void clear_epskc_activations();
  uint32_t epskc_activations() const;
  void set_epskc_activations(uint32_t value);
  private:
  uint32_t _internal_epskc_activations() const;
  void _internal_set_epskc_activations(uint32_t value);
  public:

  // optional uint32 epskc_deactivation_clears = 2;
  bool has_epskc_deactivation_clears() const;
  private:
  bool _internal_has_epskc_deactivation_clears() const;
  public:
  void clear_epskc_deactivation_clears();
  uint32_t epskc_deactivation_clears() const;
  void set_epskc_deactivation_clears(uint32_t value);
  private:
  uint32_t _internal_epskc_deactivation_clears() const;
  void _internal_set_epskc_deactivation_clears(uint32_t value);
  public:

  // optional uint32 epskc_deactivation_timeouts = 3;
  bool has_epskc_deactivation_timeouts() const;
  private:
  bool _internal_has_epskc_deactivation_timeouts() const;
  public:
  void clear_epskc_deactivation_timeouts();
  uint32_t epskc_deactivation_timeouts() const;
  void set_epskc_deactivation_timeouts(uint32_t value);
  private:
  uint32_t _internal_epskc_deactivation_timeouts() const;
  void _internal_set_epskc_deactivation_timeouts(uint32_t value);
  public:

  // optional uint32 epskc_deactivation_max_attempts = 4;
  bool has_epskc_deactivation_max_attempts() const;
  private:
  bool _internal_has_epskc_deactivation_max_attempts() const;
  public:
  void clear_epskc_deactivation_max_attempts();
  uint32_t epskc_deactivation_max_attempts() const;
  void set_epskc_deactivation_max_attempts(uint32_t value);
  private:
  uint32_t _internal_epskc_deactivation_max_attempts() const;
  void _internal_set_epskc_deactivation_max_attempts(uint32_t value);
  public:

  // optional uint32 epskc_deactivation_disconnects = 5;
  bool has_epskc_deactivation_disconnects() const;
  private:
  bool _internal_has_epskc_deactivation_disconnects() const;
  public:
  void clear_epskc_deactivation_disconnects();
  uint32_t epskc_deactivation_disconnects() const;
  void set_epskc_deactivation_disconnects(uint32_t value);
  private:
  uint32_t _internal_epskc_deactivation_disconnects() const;
  void _internal_set_epskc_deactivation_disconnects(uint32_t value);
  public:

  // optional uint32 epskc_invalid_ba_state_errors = 6;
  bool has_epskc_invalid_ba_state_errors() const;
  private:
  bool _internal_has_epskc_invalid_ba_state_errors() const;
  public:
  void clear_epskc_invalid_ba_state_errors();
  uint32_t epskc_invalid_ba_state_errors() const;
  void set_epskc_invalid_ba_state_errors(uint32_t value);
  private:
  uint32_t _internal_epskc_invalid_ba_state_errors() const;
  void _internal_set_epskc_invalid_ba_state_errors(uint32_t value);
  public:

  // optional uint32 epskc_invalid_args_errors = 7;
  bool has_epskc_invalid_args_errors() const;
  private:
  bool _internal_has_epskc_invalid_args_errors() const;
  public:
  void clear_epskc_invalid_args_errors();
  uint32_t epskc_invalid_args_errors() const;
  void set_epskc_invalid_args_errors(uint32_t value);
  private:
  uint32_t _internal_epskc_invalid_args_errors() const;
  void _internal_set_epskc_invalid_args_errors(uint32_t value);
  public:

  // optional uint32 epskc_start_secure_session_errors = 8;
  bool has_epskc_start_secure_session_errors() const;
  private:
  bool _internal_has_epskc_start_secure_session_errors() const;
  public:
  void clear_epskc_start_secure_session_errors();
  uint32_t epskc_start_secure_session_errors() const;
  void set_epskc_start_secure_session_errors(uint32_t value);
  private:
  uint32_t _internal_epskc_start_secure_session_errors() const;
  void _internal_set_epskc_start_secure_session_errors(uint32_t value);
  public:

  // optional uint32 epskc_secure_session_successes = 9;
  bool has_epskc_secure_session_successes() const;
  private:
  bool _internal_has_epskc_secure_session_successes() const;
  public:
  void clear_epskc_secure_session_successes();
  uint32_t epskc_secure_session_successes() const;
  void set_epskc_secure_session_successes(uint32_t value);
  private:
  uint32_t _internal_epskc_secure_session_successes() const;
  void _internal_set_epskc_secure_session_successes(uint32_t value);
  public:

  // optional uint32 epskc_secure_session_failures = 10;
  bool has_epskc_secure_session_failures() const;
  private:
  bool _internal_has_epskc_secure_session_failures() const;
  public:
  void clear_epskc_secure_session_failures();
  uint32_t epskc_secure_session_failures() const;
  void set_epskc_secure_session_failures(uint32_t value);
  private:
  uint32_t _internal_epskc_secure_session_failures() const;
  void _internal_set_epskc_secure_session_failures(uint32_t value);
  public:

  // optional uint32 epskc_commissioner_petitions = 11;
  bool has_epskc_commissioner_petitions() const;
  private:
  bool _internal_has_epskc_commissioner_petitions() const;
  public:
  void clear_epskc_commissioner_petitions();
  uint32_t epskc_commissioner_petitions() const;
  void set_epskc_commissioner_petitions(uint32_t value);
  private:
  uint32_t _internal_epskc_commissioner_petitions() const;
  void _internal_set_epskc_commissioner_petitions(uint32_t value);
  public:

  // optional uint32 pskc_secure_session_successes = 12;
  bool has_pskc_secure_session_successes() const;
  private:
  bool _internal_has_pskc_secure_session_successes() const;
  public:
  void clear_pskc_secure_session_successes();
  uint32_t pskc_secure_session_successes() const;
  void set_pskc_secure_session_successes(uint32_t value);
  private:
  uint32_t _internal_pskc_secure_session_successes() const;
  void _internal_set_pskc_secure_session_successes(uint32_t value);
  public:

  // optional uint32 pskc_secure_session_failures = 13;
  bool has_pskc_secure_session_failures() const;
  private:
  bool _internal_has_pskc_secure_session_failures() const;
  public:
  void clear_pskc_secure_session_failures();
  uint32_t pskc_secure_session_failures() const;
  void set_pskc_secure_session_failures(uint32_t value);
  private:
  uint32_t _internal_pskc_secure_session_failures() const;
  void _internal_set_pskc_secure_session_failures(uint32_t value);
  public:

  // optional uint32 pskc_commissioner_petitions = 14;
  bool has_pskc_commissioner_petitions() const;
  private:
  bool _internal_has_pskc_commissioner_petitions() const;
  public:
  void clear_pskc_commissioner_petitions();
  uint32_t pskc_commissioner_petitions() const;
  void set_pskc_commissioner_petitions(uint32_t value);
  private:
  uint32_t _internal_pskc_commissioner_petitions() const;
  void _internal_set_pskc_commissioner_petitions(uint32_t value);
  public:

  // optional uint32 mgmt_active_get_reqs = 15;
  bool has_mgmt_active_get_reqs() const;
  private:
  bool _internal_has_mgmt_active_get_reqs() const;
  public:
  void clear_mgmt_active_get_reqs();
  uint32_t mgmt_active_get_reqs() const;
  void set_mgmt_active_get_reqs(uint32_t value);
  private:
  uint32_t _internal_mgmt_active_get_reqs() const;
  void _internal_set_mgmt_active_get_reqs(uint32_t value);
  public:

  // optional uint32 mgmt_pending_get_reqs = 16;
  bool has_mgmt_pending_get_reqs() const;
  private:
  bool _internal_has_mgmt_pending_get_reqs() const;
  public:
  void clear_mgmt_pending_get_reqs();
  uint32_t mgmt_pending_get_reqs() const;
  void set_mgmt_pending_get_reqs(uint32_t value);
  private:
  uint32_t _internal_mgmt_pending_get_reqs() const;
  void _internal_set_mgmt_pending_get_reqs(uint32_t value);
  public:

  // @@protoc_insertion_point(class_scope:threadnetwork.TelemetryData.BorderAgentCounters)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    uint32_t epskc_activations_;
    uint32_t epskc_deactivation_clears_;
    uint32_t epskc_deactivation_timeouts_;
    uint32_t epskc_deactivation_max_attempts_;
    uint32_t epskc_deactivation_disconnects_;
    uint32_t epskc_invalid_ba_state_errors_;
    uint32_t epskc_invalid_args_errors_;
    uint32_t epskc_start_secure_session_errors_;
    uint32_t epskc_secure_session_successes_;
    uint32_t epskc_secure_session_failures_;
    uint32_t epskc_commissioner_petitions_;
    uint32_t pskc_secure_session_successes_;
    uint32_t pskc_secure_session_failures_;
    uint32_t pskc_commissioner_petitions_;
    uint32_t mgmt_active_get_reqs_;
    uint32_t mgmt_pending_get_reqs_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_thread_5ftelemetry_2eproto;
};
...
class TelemetryData_BorderAgentInfo final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:threadnetwork.TelemetryData.BorderAgentInfo) */ {
 public:
  inline TelemetryData_BorderAgentInfo() : TelemetryData_BorderAgentInfo(nullptr) {}
  ~TelemetryData_BorderAgentInfo() override;
  explicit PROTOBUF_CONSTEXPR TelemetryData_BorderAgentInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  TelemetryData_BorderAgentInfo(const TelemetryData_BorderAgentInfo& from);
  TelemetryData_BorderAgentInfo(TelemetryData_BorderAgentInfo&& from) noexcept
    : TelemetryData_BorderAgentInfo() {
    *this = ::std::move(from);
  }

  inline TelemetryData_BorderAgentInfo& operator=(const TelemetryData_BorderAgentInfo& from) {
    CopyFrom(from);
    return *this;
  }
  inline TelemetryData_BorderAgentInfo& operator=(TelemetryData_BorderAgentInfo&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const TelemetryData_BorderAgentInfo& default_instance() {
    return *internal_default_instance();
  }
  static inline const TelemetryData_BorderAgentInfo* internal_default_instance() {
    return reinterpret_cast<const TelemetryData_BorderAgentInfo*>(
               &_TelemetryData_BorderAgentInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    25;

  friend void swap(TelemetryData_BorderAgentInfo& a, TelemetryData_BorderAgentInfo& b) {
    a.Swap(&b);
  }
  inline void Swap(TelemetryData_BorderAgentInfo* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(TelemetryData_BorderAgentInfo* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  TelemetryData_BorderAgentInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<TelemetryData_BorderAgentInfo>(arena);
  }
  void CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)  final;
  void CopyFrom(const TelemetryData_BorderAgentInfo& from);
  void MergeFrom(const TelemetryData_BorderAgentInfo& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(TelemetryData_BorderAgentInfo* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "threadnetwork.TelemetryData.BorderAgentInfo";
  }
  protected:
  explicit TelemetryData_BorderAgentInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kBorderAgentCountersFieldNumber = 1,
  };
  // optional .threadnetwork.TelemetryData.BorderAgentCounters border_agent_counters = 1;
  bool has_border_agent_counters() const;
  private:
  bool _internal_has_border_agent_counters() const;
  public:
  void clear_border_agent_counters();
  const ::threadnetwork::TelemetryData_BorderAgentCounters& border_agent_counters() const;
  PROTOBUF_NODISCARD ::threadnetwork::TelemetryData_BorderAgentCounters* release_border_agent_counters();
  ::threadnetwork::TelemetryData_BorderAgentCounters* mutable_border_agent_counters();
  void set_allocated_border_agent_counters(::threadnetwork::TelemetryData_BorderAgentCounters* border_agent_counters);
  private:
  const ::threadnetwork::TelemetryData_BorderAgentCounters& _internal_border_agent_counters() const;
  ::threadnetwork::TelemetryData_BorderAgentCounters* _internal_mutable_border_agent_counters();
  public:
  void unsafe_arena_set_allocated_border_agent_counters(
      ::threadnetwork::TelemetryData_BorderAgentCounters* border_agent_counters);
  ::threadnetwork::TelemetryData_BorderAgentCounters* unsafe_arena_release_border_agent_counters();

  // @@protoc_insertion_point(class_scope:threadnetwork.TelemetryData.BorderAgentInfo)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::threadnetwork::TelemetryData_BorderAgentCounters* border_agent_counters_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_thread_5ftelemetry_2eproto;
};
...
class TelemetryData_WpanBorderRouter final :
 ...
 public:
  ...
  enum : int {
    ...
    kExternalRouteInfoFieldNumber = 13,
    kBorderAgentInfoFieldNumber = 14,
  ...
  // optional .threadnetwork.TelemetryData.ExternalRoutes external_route_info = 13;
  bool has_external_route_info() const;
  private:
  bool _internal_has_external_route_info() const;
  public:
  void clear_external_route_info();
  const ::threadnetwork::TelemetryData_ExternalRoutes& external_route_info() const;
  PROTOBUF_NODISCARD ::threadnetwork::TelemetryData_ExternalRoutes* release_external_route_info();
  ::threadnetwork::TelemetryData_ExternalRoutes* mutable_external_route_info();
  void set_allocated_external_route_info(::threadnetwork::TelemetryData_ExternalRoutes* external_route_info);
  private:
  const ::threadnetwork::TelemetryData_ExternalRoutes& _internal_external_route_info() const;
  ::threadnetwork::TelemetryData_ExternalRoutes* _internal_mutable_external_route_info();
  public:
  void unsafe_arena_set_allocated_external_route_info(
      ::threadnetwork::TelemetryData_ExternalRoutes* external_route_info);
  ::threadnetwork::TelemetryData_ExternalRoutes* unsafe_arena_release_external_route_info();

  // optional .threadnetwork.TelemetryData.BorderAgentInfo border_agent_info = 14;
  bool has_border_agent_info() const;
  private:
  bool _internal_has_border_agent_info() const;
  public:
  void clear_border_agent_info();
  const ::threadnetwork::TelemetryData_BorderAgentInfo& border_agent_info() const;
  PROTOBUF_NODISCARD ::threadnetwork::TelemetryData_BorderAgentInfo* release_border_agent_info();
  ::threadnetwork::TelemetryData_BorderAgentInfo* mutable_border_agent_info();
  void set_allocated_border_agent_info(::threadnetwork::TelemetryData_BorderAgentInfo* border_agent_info);
  private:
  const ::threadnetwork::TelemetryData_BorderAgentInfo& _internal_border_agent_info() const;
  ::threadnetwork::TelemetryData_BorderAgentInfo* _internal_mutable_border_agent_info();
  public:
  void unsafe_arena_set_allocated_border_agent_info(
      ::threadnetwork::TelemetryData_BorderAgentInfo* border_agent_info);
  ::threadnetwork::TelemetryData_BorderAgentInfo* unsafe_arena_release_border_agent_info();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::threadnetwork::TelemetryData_ExternalRoutes* external_route_info_;
    ::threadnetwork::TelemetryData_BorderAgentInfo* border_agent_info_;
    int dhcp6_pd_state_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_thread_5ftelemetry_2eproto;
...
class TelemetryData final :
 ...
 public:
  ...
  typedef TelemetryData_ExternalRoutes ExternalRoutes;
  typedef TelemetryData_BorderAgentCounters BorderAgentCounters;
  typedef TelemetryData_BorderAgentInfo BorderAgentInfo;
...
// optional uint32 peer_br_count = 18;
inline bool TelemetryData_WpanTopoFull::_internal_has_peer_br_count() const {
  bool value = (_impl_._has_bits_[0] & 0x00010000u) != 0;
  return value;
}
inline bool TelemetryData_WpanTopoFull::has_peer_br_count() const {
  return _internal_has_peer_br_count();
}
inline void TelemetryData_WpanTopoFull::clear_peer_br_count() {
  _impl_.peer_br_count_ = 0u;
  _impl_._has_bits_[0] &= ~0x00010000u;
}
inline uint32_t TelemetryData_WpanTopoFull::_internal_peer_br_count() const {
  return _impl_.peer_br_count_;
}
inline uint32_t TelemetryData_WpanTopoFull::peer_br_count() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.WpanTopoFull.peer_br_count)
  return _internal_peer_br_count();
}
inline void TelemetryData_WpanTopoFull::_internal_set_peer_br_count(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00010000u;
  _impl_.peer_br_count_ = value;
}
inline void TelemetryData_WpanTopoFull::set_peer_br_count(uint32_t value) {
  _internal_set_peer_br_count(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.WpanTopoFull.peer_br_count)
}
...
// optional uint32 peer_br_count = 8;
inline bool TelemetryData_InfraLinkInfo::_internal_has_peer_br_count() const {
  bool value = (_impl_._has_bits_[0] & 0x00000080u) != 0;
  return value;
}
inline bool TelemetryData_InfraLinkInfo::has_peer_br_count() const {
  return _internal_has_peer_br_count();
}
inline void TelemetryData_InfraLinkInfo::clear_peer_br_count() {
  _impl_.peer_br_count_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000080u;
}
inline uint32_t TelemetryData_InfraLinkInfo::_internal_peer_br_count() const {
  return _impl_.peer_br_count_;
}
inline uint32_t TelemetryData_InfraLinkInfo::peer_br_count() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.InfraLinkInfo.peer_br_count)
  return _internal_peer_br_count();
}
inline void TelemetryData_InfraLinkInfo::_internal_set_peer_br_count(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000080u;
  _impl_.peer_br_count_ = value;
}
inline void TelemetryData_InfraLinkInfo::set_peer_br_count(uint32_t value) {
  _internal_set_peer_br_count(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.InfraLinkInfo.peer_br_count)
}
...
// optional bool has_default_route_added = 1;
inline bool TelemetryData_ExternalRoutes::_internal_has_has_default_route_added() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool TelemetryData_ExternalRoutes::has_has_default_route_added() const {
  return _internal_has_has_default_route_added();
}
inline void TelemetryData_ExternalRoutes::clear_has_default_route_added() {
  _impl_.has_default_route_added_ = false;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline bool TelemetryData_ExternalRoutes::_internal_has_default_route_added() const {
  return _impl_.has_default_route_added_;
}
inline bool TelemetryData_ExternalRoutes::has_default_route_added() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.ExternalRoutes.has_default_route_added)
  return _internal_has_default_route_added();
}
inline void TelemetryData_ExternalRoutes::_internal_set_has_default_route_added(bool value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.has_default_route_added_ = value;
}
inline void TelemetryData_ExternalRoutes::set_has_default_route_added(bool value) {
  _internal_set_has_default_route_added(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.ExternalRoutes.has_default_route_added)
}

// optional bool has_ula_route_added = 2;
inline bool TelemetryData_ExternalRoutes::_internal_has_has_ula_route_added() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool TelemetryData_ExternalRoutes::has_has_ula_route_added() const {
  return _internal_has_has_ula_route_added();
}
inline void TelemetryData_ExternalRoutes::clear_has_ula_route_added() {
  _impl_.has_ula_route_added_ = false;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline bool TelemetryData_ExternalRoutes::_internal_has_ula_route_added() const {
  return _impl_.has_ula_route_added_;
}
inline bool TelemetryData_ExternalRoutes::has_ula_route_added() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.ExternalRoutes.has_ula_route_added)
  return _internal_has_ula_route_added();
}
inline void TelemetryData_ExternalRoutes::_internal_set_has_ula_route_added(bool value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.has_ula_route_added_ = value;
}
inline void TelemetryData_ExternalRoutes::set_has_ula_route_added(bool value) {
  _internal_set_has_ula_route_added(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.ExternalRoutes.has_ula_route_added)
}

// optional bool has_others_route_added = 3;
inline bool TelemetryData_ExternalRoutes::_internal_has_has_others_route_added() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool TelemetryData_ExternalRoutes::has_has_others_route_added() const {
  return _internal_has_has_others_route_added();
}
inline void TelemetryData_ExternalRoutes::clear_has_others_route_added() {
  _impl_.has_others_route_added_ = false;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline bool TelemetryData_ExternalRoutes::_internal_has_others_route_added() const {
  return _impl_.has_others_route_added_;
}
inline bool TelemetryData_ExternalRoutes::has_others_route_added() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.ExternalRoutes.has_others_route_added)
  return _internal_has_others_route_added();
}
inline void TelemetryData_ExternalRoutes::_internal_set_has_others_route_added(bool value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.has_others_route_added_ = value;
}
inline void TelemetryData_ExternalRoutes::set_has_others_route_added(bool value) {
  _internal_set_has_others_route_added(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.ExternalRoutes.has_others_route_added)
}
...
// optional uint32 epskc_activations = 1;
inline bool TelemetryData_BorderAgentCounters::_internal_has_epskc_activations() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_epskc_activations() const {
  return _internal_has_epskc_activations();
}
inline void TelemetryData_BorderAgentCounters::clear_epskc_activations() {
  _impl_.epskc_activations_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_epskc_activations() const {
  return _impl_.epskc_activations_;
}
inline uint32_t TelemetryData_BorderAgentCounters::epskc_activations() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.epskc_activations)
  return _internal_epskc_activations();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_epskc_activations(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.epskc_activations_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_epskc_activations(uint32_t value) {
  _internal_set_epskc_activations(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.epskc_activations)
}

// optional uint32 epskc_deactivation_clears = 2;
inline bool TelemetryData_BorderAgentCounters::_internal_has_epskc_deactivation_clears() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_epskc_deactivation_clears() const {
  return _internal_has_epskc_deactivation_clears();
}
inline void TelemetryData_BorderAgentCounters::clear_epskc_deactivation_clears() {
  _impl_.epskc_deactivation_clears_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_epskc_deactivation_clears() const {
  return _impl_.epskc_deactivation_clears_;
}
inline uint32_t TelemetryData_BorderAgentCounters::epskc_deactivation_clears() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.epskc_deactivation_clears)
  return _internal_epskc_deactivation_clears();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_epskc_deactivation_clears(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.epskc_deactivation_clears_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_epskc_deactivation_clears(uint32_t value) {
  _internal_set_epskc_deactivation_clears(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.epskc_deactivation_clears)
}

// optional uint32 epskc_deactivation_timeouts = 3;
inline bool TelemetryData_BorderAgentCounters::_internal_has_epskc_deactivation_timeouts() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_epskc_deactivation_timeouts() const {
  return _internal_has_epskc_deactivation_timeouts();
}
inline void TelemetryData_BorderAgentCounters::clear_epskc_deactivation_timeouts() {
  _impl_.epskc_deactivation_timeouts_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_epskc_deactivation_timeouts() const {
  return _impl_.epskc_deactivation_timeouts_;
}
inline uint32_t TelemetryData_BorderAgentCounters::epskc_deactivation_timeouts() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.epskc_deactivation_timeouts)
  return _internal_epskc_deactivation_timeouts();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_epskc_deactivation_timeouts(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.epskc_deactivation_timeouts_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_epskc_deactivation_timeouts(uint32_t value) {
  _internal_set_epskc_deactivation_timeouts(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.epskc_deactivation_timeouts)
}

// optional uint32 epskc_deactivation_max_attempts = 4;
inline bool TelemetryData_BorderAgentCounters::_internal_has_epskc_deactivation_max_attempts() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_epskc_deactivation_max_attempts() const {
  return _internal_has_epskc_deactivation_max_attempts();
}
inline void TelemetryData_BorderAgentCounters::clear_epskc_deactivation_max_attempts() {
  _impl_.epskc_deactivation_max_attempts_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_epskc_deactivation_max_attempts() const {
  return _impl_.epskc_deactivation_max_attempts_;
}
inline uint32_t TelemetryData_BorderAgentCounters::epskc_deactivation_max_attempts() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.epskc_deactivation_max_attempts)
  return _internal_epskc_deactivation_max_attempts();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_epskc_deactivation_max_attempts(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.epskc_deactivation_max_attempts_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_epskc_deactivation_max_attempts(uint32_t value) {
  _internal_set_epskc_deactivation_max_attempts(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.epskc_deactivation_max_attempts)
}

// optional uint32 epskc_deactivation_disconnects = 5;
inline bool TelemetryData_BorderAgentCounters::_internal_has_epskc_deactivation_disconnects() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_epskc_deactivation_disconnects() const {
  return _internal_has_epskc_deactivation_disconnects();
}
inline void TelemetryData_BorderAgentCounters::clear_epskc_deactivation_disconnects() {
  _impl_.epskc_deactivation_disconnects_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_epskc_deactivation_disconnects() const {
  return _impl_.epskc_deactivation_disconnects_;
}
inline uint32_t TelemetryData_BorderAgentCounters::epskc_deactivation_disconnects() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.epskc_deactivation_disconnects)
  return _internal_epskc_deactivation_disconnects();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_epskc_deactivation_disconnects(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.epskc_deactivation_disconnects_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_epskc_deactivation_disconnects(uint32_t value) {
  _internal_set_epskc_deactivation_disconnects(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.epskc_deactivation_disconnects)
}

// optional uint32 epskc_invalid_ba_state_errors = 6;
inline bool TelemetryData_BorderAgentCounters::_internal_has_epskc_invalid_ba_state_errors() const {
  bool value = (_impl_._has_bits_[0] & 0x00000020u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_epskc_invalid_ba_state_errors() const {
  return _internal_has_epskc_invalid_ba_state_errors();
}
inline void TelemetryData_BorderAgentCounters::clear_epskc_invalid_ba_state_errors() {
  _impl_.epskc_invalid_ba_state_errors_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000020u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_epskc_invalid_ba_state_errors() const {
  return _impl_.epskc_invalid_ba_state_errors_;
}
inline uint32_t TelemetryData_BorderAgentCounters::epskc_invalid_ba_state_errors() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.epskc_invalid_ba_state_errors)
  return _internal_epskc_invalid_ba_state_errors();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_epskc_invalid_ba_state_errors(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000020u;
  _impl_.epskc_invalid_ba_state_errors_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_epskc_invalid_ba_state_errors(uint32_t value) {
  _internal_set_epskc_invalid_ba_state_errors(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.epskc_invalid_ba_state_errors)
}

// optional uint32 epskc_invalid_args_errors = 7;
inline bool TelemetryData_BorderAgentCounters::_internal_has_epskc_invalid_args_errors() const {
  bool value = (_impl_._has_bits_[0] & 0x00000040u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_epskc_invalid_args_errors() const {
  return _internal_has_epskc_invalid_args_errors();
}
inline void TelemetryData_BorderAgentCounters::clear_epskc_invalid_args_errors() {
  _impl_.epskc_invalid_args_errors_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000040u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_epskc_invalid_args_errors() const {
  return _impl_.epskc_invalid_args_errors_;
}
inline uint32_t TelemetryData_BorderAgentCounters::epskc_invalid_args_errors() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.epskc_invalid_args_errors)
  return _internal_epskc_invalid_args_errors();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_epskc_invalid_args_errors(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000040u;
  _impl_.epskc_invalid_args_errors_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_epskc_invalid_args_errors(uint32_t value) {
  _internal_set_epskc_invalid_args_errors(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.epskc_invalid_args_errors)
}

// optional uint32 epskc_start_secure_session_errors = 8;
inline bool TelemetryData_BorderAgentCounters::_internal_has_epskc_start_secure_session_errors() const {
  bool value = (_impl_._has_bits_[0] & 0x00000080u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_epskc_start_secure_session_errors() const {
  return _internal_has_epskc_start_secure_session_errors();
}
inline void TelemetryData_BorderAgentCounters::clear_epskc_start_secure_session_errors() {
  _impl_.epskc_start_secure_session_errors_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000080u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_epskc_start_secure_session_errors() const {
  return _impl_.epskc_start_secure_session_errors_;
}
inline uint32_t TelemetryData_BorderAgentCounters::epskc_start_secure_session_errors() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.epskc_start_secure_session_errors)
  return _internal_epskc_start_secure_session_errors();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_epskc_start_secure_session_errors(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000080u;
  _impl_.epskc_start_secure_session_errors_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_epskc_start_secure_session_errors(uint32_t value) {
  _internal_set_epskc_start_secure_session_errors(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.epskc_start_secure_session_errors)
}

// optional uint32 epskc_secure_session_successes = 9;
inline bool TelemetryData_BorderAgentCounters::_internal_has_epskc_secure_session_successes() const {
  bool value = (_impl_._has_bits_[0] & 0x00000100u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_epskc_secure_session_successes() const {
  return _internal_has_epskc_secure_session_successes();
}
inline void TelemetryData_BorderAgentCounters::clear_epskc_secure_session_successes() {
  _impl_.epskc_secure_session_successes_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000100u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_epskc_secure_session_successes() const {
  return _impl_.epskc_secure_session_successes_;
}
inline uint32_t TelemetryData_BorderAgentCounters::epskc_secure_session_successes() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.epskc_secure_session_successes)
  return _internal_epskc_secure_session_successes();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_epskc_secure_session_successes(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000100u;
  _impl_.epskc_secure_session_successes_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_epskc_secure_session_successes(uint32_t value) {
  _internal_set_epskc_secure_session_successes(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.epskc_secure_session_successes)
}

// optional uint32 epskc_secure_session_failures = 10;
inline bool TelemetryData_BorderAgentCounters::_internal_has_epskc_secure_session_failures() const {
  bool value = (_impl_._has_bits_[0] & 0x00000200u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_epskc_secure_session_failures() const {
  return _internal_has_epskc_secure_session_failures();
}
inline void TelemetryData_BorderAgentCounters::clear_epskc_secure_session_failures() {
  _impl_.epskc_secure_session_failures_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000200u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_epskc_secure_session_failures() const {
  return _impl_.epskc_secure_session_failures_;
}
inline uint32_t TelemetryData_BorderAgentCounters::epskc_secure_session_failures() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.epskc_secure_session_failures)
  return _internal_epskc_secure_session_failures();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_epskc_secure_session_failures(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000200u;
  _impl_.epskc_secure_session_failures_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_epskc_secure_session_failures(uint32_t value) {
  _internal_set_epskc_secure_session_failures(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.epskc_secure_session_failures)
}

// optional uint32 epskc_commissioner_petitions = 11;
inline bool TelemetryData_BorderAgentCounters::_internal_has_epskc_commissioner_petitions() const {
  bool value = (_impl_._has_bits_[0] & 0x00000400u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_epskc_commissioner_petitions() const {
  return _internal_has_epskc_commissioner_petitions();
}
inline void TelemetryData_BorderAgentCounters::clear_epskc_commissioner_petitions() {
  _impl_.epskc_commissioner_petitions_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000400u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_epskc_commissioner_petitions() const {
  return _impl_.epskc_commissioner_petitions_;
}
inline uint32_t TelemetryData_BorderAgentCounters::epskc_commissioner_petitions() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.epskc_commissioner_petitions)
  return _internal_epskc_commissioner_petitions();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_epskc_commissioner_petitions(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000400u;
  _impl_.epskc_commissioner_petitions_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_epskc_commissioner_petitions(uint32_t value) {
  _internal_set_epskc_commissioner_petitions(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.epskc_commissioner_petitions)
}

// optional uint32 pskc_secure_session_successes = 12;
inline bool TelemetryData_BorderAgentCounters::_internal_has_pskc_secure_session_successes() const {
  bool value = (_impl_._has_bits_[0] & 0x00000800u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_pskc_secure_session_successes() const {
  return _internal_has_pskc_secure_session_successes();
}
inline void TelemetryData_BorderAgentCounters::clear_pskc_secure_session_successes() {
  _impl_.pskc_secure_session_successes_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000800u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_pskc_secure_session_successes() const {
  return _impl_.pskc_secure_session_successes_;
}
inline uint32_t TelemetryData_BorderAgentCounters::pskc_secure_session_successes() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.pskc_secure_session_successes)
  return _internal_pskc_secure_session_successes();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_pskc_secure_session_successes(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000800u;
  _impl_.pskc_secure_session_successes_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_pskc_secure_session_successes(uint32_t value) {
  _internal_set_pskc_secure_session_successes(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.pskc_secure_session_successes)
}

// optional uint32 pskc_secure_session_failures = 13;
inline bool TelemetryData_BorderAgentCounters::_internal_has_pskc_secure_session_failures() const {
  bool value = (_impl_._has_bits_[0] & 0x00001000u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_pskc_secure_session_failures() const {
  return _internal_has_pskc_secure_session_failures();
}
inline void TelemetryData_BorderAgentCounters::clear_pskc_secure_session_failures() {
  _impl_.pskc_secure_session_failures_ = 0u;
  _impl_._has_bits_[0] &= ~0x00001000u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_pskc_secure_session_failures() const {
  return _impl_.pskc_secure_session_failures_;
}
inline uint32_t TelemetryData_BorderAgentCounters::pskc_secure_session_failures() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.pskc_secure_session_failures)
  return _internal_pskc_secure_session_failures();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_pskc_secure_session_failures(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00001000u;
  _impl_.pskc_secure_session_failures_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_pskc_secure_session_failures(uint32_t value) {
  _internal_set_pskc_secure_session_failures(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.pskc_secure_session_failures)
}

// optional uint32 pskc_commissioner_petitions = 14;
inline bool TelemetryData_BorderAgentCounters::_internal_has_pskc_commissioner_petitions() const {
  bool value = (_impl_._has_bits_[0] & 0x00002000u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_pskc_commissioner_petitions() const {
  return _internal_has_pskc_commissioner_petitions();
}
inline void TelemetryData_BorderAgentCounters::clear_pskc_commissioner_petitions() {
  _impl_.pskc_commissioner_petitions_ = 0u;
  _impl_._has_bits_[0] &= ~0x00002000u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_pskc_commissioner_petitions() const {
  return _impl_.pskc_commissioner_petitions_;
}
inline uint32_t TelemetryData_BorderAgentCounters::pskc_commissioner_petitions() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.pskc_commissioner_petitions)
  return _internal_pskc_commissioner_petitions();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_pskc_commissioner_petitions(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00002000u;
  _impl_.pskc_commissioner_petitions_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_pskc_commissioner_petitions(uint32_t value) {
  _internal_set_pskc_commissioner_petitions(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.pskc_commissioner_petitions)
}

// optional uint32 mgmt_active_get_reqs = 15;
inline bool TelemetryData_BorderAgentCounters::_internal_has_mgmt_active_get_reqs() const {
  bool value = (_impl_._has_bits_[0] & 0x00004000u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_mgmt_active_get_reqs() const {
  return _internal_has_mgmt_active_get_reqs();
}
inline void TelemetryData_BorderAgentCounters::clear_mgmt_active_get_reqs() {
  _impl_.mgmt_active_get_reqs_ = 0u;
  _impl_._has_bits_[0] &= ~0x00004000u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_mgmt_active_get_reqs() const {
  return _impl_.mgmt_active_get_reqs_;
}
inline uint32_t TelemetryData_BorderAgentCounters::mgmt_active_get_reqs() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.mgmt_active_get_reqs)
  return _internal_mgmt_active_get_reqs();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_mgmt_active_get_reqs(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00004000u;
  _impl_.mgmt_active_get_reqs_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_mgmt_active_get_reqs(uint32_t value) {
  _internal_set_mgmt_active_get_reqs(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.mgmt_active_get_reqs)
}

// optional uint32 mgmt_pending_get_reqs = 16;
inline bool TelemetryData_BorderAgentCounters::_internal_has_mgmt_pending_get_reqs() const {
  bool value = (_impl_._has_bits_[0] & 0x00008000u) != 0;
  return value;
}
inline bool TelemetryData_BorderAgentCounters::has_mgmt_pending_get_reqs() const {
  return _internal_has_mgmt_pending_get_reqs();
}
inline void TelemetryData_BorderAgentCounters::clear_mgmt_pending_get_reqs() {
  _impl_.mgmt_pending_get_reqs_ = 0u;
  _impl_._has_bits_[0] &= ~0x00008000u;
}
inline uint32_t TelemetryData_BorderAgentCounters::_internal_mgmt_pending_get_reqs() const {
  return _impl_.mgmt_pending_get_reqs_;
}
inline uint32_t TelemetryData_BorderAgentCounters::mgmt_pending_get_reqs() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentCounters.mgmt_pending_get_reqs)
  return _internal_mgmt_pending_get_reqs();
}
inline void TelemetryData_BorderAgentCounters::_internal_set_mgmt_pending_get_reqs(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00008000u;
  _impl_.mgmt_pending_get_reqs_ = value;
}
inline void TelemetryData_BorderAgentCounters::set_mgmt_pending_get_reqs(uint32_t value) {
  _internal_set_mgmt_pending_get_reqs(value);
  // @@protoc_insertion_point(field_set:threadnetwork.TelemetryData.BorderAgentCounters.mgmt_pending_get_reqs)
}
...
// optional .threadnetwork.TelemetryData.BorderAgentCounters border_agent_counters = 1;
inline bool TelemetryData_BorderAgentInfo::_internal_has_border_agent_counters() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.border_agent_counters_ != nullptr);
  return value;
}
inline bool TelemetryData_BorderAgentInfo::has_border_agent_counters() const {
  return _internal_has_border_agent_counters();
}
inline void TelemetryData_BorderAgentInfo::clear_border_agent_counters() {
  if (_impl_.border_agent_counters_ != nullptr) _impl_.border_agent_counters_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::threadnetwork::TelemetryData_BorderAgentCounters& TelemetryData_BorderAgentInfo::_internal_border_agent_counters() const {
  const ::threadnetwork::TelemetryData_BorderAgentCounters* p = _impl_.border_agent_counters_;
  return p != nullptr ? *p : reinterpret_cast<const ::threadnetwork::TelemetryData_BorderAgentCounters&>(
      ::threadnetwork::_TelemetryData_BorderAgentCounters_default_instance_);
}
inline const ::threadnetwork::TelemetryData_BorderAgentCounters& TelemetryData_BorderAgentInfo::border_agent_counters() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.BorderAgentInfo.border_agent_counters)
  return _internal_border_agent_counters();
}
inline void TelemetryData_BorderAgentInfo::unsafe_arena_set_allocated_border_agent_counters(
    ::threadnetwork::TelemetryData_BorderAgentCounters* border_agent_counters) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.border_agent_counters_);
  }
  _impl_.border_agent_counters_ = border_agent_counters;
  if (border_agent_counters) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:threadnetwork.TelemetryData.BorderAgentInfo.border_agent_counters)
}
inline ::threadnetwork::TelemetryData_BorderAgentCounters* TelemetryData_BorderAgentInfo::release_border_agent_counters() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::threadnetwork::TelemetryData_BorderAgentCounters* temp = _impl_.border_agent_counters_;
  _impl_.border_agent_counters_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::threadnetwork::TelemetryData_BorderAgentCounters* TelemetryData_BorderAgentInfo::unsafe_arena_release_border_agent_counters() {
  // @@protoc_insertion_point(field_release:threadnetwork.TelemetryData.BorderAgentInfo.border_agent_counters)
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::threadnetwork::TelemetryData_BorderAgentCounters* temp = _impl_.border_agent_counters_;
  _impl_.border_agent_counters_ = nullptr;
  return temp;
}
inline ::threadnetwork::TelemetryData_BorderAgentCounters* TelemetryData_BorderAgentInfo::_internal_mutable_border_agent_counters() {
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.border_agent_counters_ == nullptr) {
    auto* p = CreateMaybeMessage<::threadnetwork::TelemetryData_BorderAgentCounters>(GetArenaForAllocation());
    _impl_.border_agent_counters_ = p;
  }
  return _impl_.border_agent_counters_;
}
inline ::threadnetwork::TelemetryData_BorderAgentCounters* TelemetryData_BorderAgentInfo::mutable_border_agent_counters() {
  ::threadnetwork::TelemetryData_BorderAgentCounters* _msg = _internal_mutable_border_agent_counters();
  // @@protoc_insertion_point(field_mutable:threadnetwork.TelemetryData.BorderAgentInfo.border_agent_counters)
  return _msg;
}
inline void TelemetryData_BorderAgentInfo::set_allocated_border_agent_counters(::threadnetwork::TelemetryData_BorderAgentCounters* border_agent_counters) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.border_agent_counters_;
  }
  if (border_agent_counters) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(border_agent_counters);
    if (message_arena != submessage_arena) {
      border_agent_counters = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, border_agent_counters, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  ...
  _impl_.border_agent_counters_ = border_agent_counters;
  // @@protoc_insertion_point(field_set_allocated:threadnetwork.TelemetryData.BorderAgentInfo.border_agent_counters)
}
...
// optional .threadnetwork.TelemetryData.ExternalRoutes external_route_info = 13;
inline bool TelemetryData_WpanBorderRouter::_internal_has_external_route_info() const {
  bool value = (_impl_._has_bits_[0] & 0x00000200u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.external_route_info_ != nullptr);
  return value;
}
inline bool TelemetryData_WpanBorderRouter::has_external_route_info() const {
  return _internal_has_external_route_info();
}
inline void TelemetryData_WpanBorderRouter::clear_external_route_info() {
  if (_impl_.external_route_info_ != nullptr) _impl_.external_route_info_->Clear();
  _impl_._has_bits_[0] &= ~0x00000200u;
}
inline const ::threadnetwork::TelemetryData_ExternalRoutes& TelemetryData_WpanBorderRouter::_internal_external_route_info() const {
  const ::threadnetwork::TelemetryData_ExternalRoutes* p = _impl_.external_route_info_;
  return p != nullptr ? *p : reinterpret_cast<const ::threadnetwork::TelemetryData_ExternalRoutes&>(
      ::threadnetwork::_TelemetryData_ExternalRoutes_default_instance_);
}
inline const ::threadnetwork::TelemetryData_ExternalRoutes& TelemetryData_WpanBorderRouter::external_route_info() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.WpanBorderRouter.external_route_info)
  return _internal_external_route_info();
}
inline void TelemetryData_WpanBorderRouter::unsafe_arena_set_allocated_external_route_info(
    ::threadnetwork::TelemetryData_ExternalRoutes* external_route_info) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.external_route_info_);
  }
  _impl_.external_route_info_ = external_route_info;
  if (external_route_info) {
    _impl_._has_bits_[0] |= 0x00000200u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000200u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:threadnetwork.TelemetryData.WpanBorderRouter.external_route_info)
}
inline ::threadnetwork::TelemetryData_ExternalRoutes* TelemetryData_WpanBorderRouter::release_external_route_info() {
  _impl_._has_bits_[0] &= ~0x00000200u;
  ::threadnetwork::TelemetryData_ExternalRoutes* temp = _impl_.external_route_info_;
  _impl_.external_route_info_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::threadnetwork::TelemetryData_ExternalRoutes* TelemetryData_WpanBorderRouter::unsafe_arena_release_external_route_info() {
  // @@protoc_insertion_point(field_release:threadnetwork.TelemetryData.WpanBorderRouter.external_route_info)
  _impl_._has_bits_[0] &= ~0x00000200u;
  ::threadnetwork::TelemetryData_ExternalRoutes* temp = _impl_.external_route_info_;
  _impl_.external_route_info_ = nullptr;
  return temp;
}
inline ::threadnetwork::TelemetryData_ExternalRoutes* TelemetryData_WpanBorderRouter::_internal_mutable_external_route_info() {
  _impl_._has_bits_[0] |= 0x00000200u;
  if (_impl_.external_route_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::threadnetwork::TelemetryData_ExternalRoutes>(GetArenaForAllocation());
    _impl_.external_route_info_ = p;
  }
  return _impl_.external_route_info_;
}
inline ::threadnetwork::TelemetryData_ExternalRoutes* TelemetryData_WpanBorderRouter::mutable_external_route_info() {
  ::threadnetwork::TelemetryData_ExternalRoutes* _msg = _internal_mutable_external_route_info();
  // @@protoc_insertion_point(field_mutable:threadnetwork.TelemetryData.WpanBorderRouter.external_route_info)
  return _msg;
}
inline void TelemetryData_WpanBorderRouter::set_allocated_external_route_info(::threadnetwork::TelemetryData_ExternalRoutes* external_route_info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.external_route_info_;
  }
  if (external_route_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(external_route_info);
    if (message_arena != submessage_arena) {
      external_route_info = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, external_route_info, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000200u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000200u;
  ...
  _impl_.external_route_info_ = external_route_info;
  // @@protoc_insertion_point(field_set_allocated:threadnetwork.TelemetryData.WpanBorderRouter.external_route_info)
}

// optional .threadnetwork.TelemetryData.BorderAgentInfo border_agent_info = 14;
inline bool TelemetryData_WpanBorderRouter::_internal_has_border_agent_info() const {
  bool value = (_impl_._has_bits_[0] & 0x00000400u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.border_agent_info_ != nullptr);
  return value;
}
inline bool TelemetryData_WpanBorderRouter::has_border_agent_info() const {
  return _internal_has_border_agent_info();
}
inline void TelemetryData_WpanBorderRouter::clear_border_agent_info() {
  if (_impl_.border_agent_info_ != nullptr) _impl_.border_agent_info_->Clear();
  _impl_._has_bits_[0] &= ~0x00000400u;
}
inline const ::threadnetwork::TelemetryData_BorderAgentInfo& TelemetryData_WpanBorderRouter::_internal_border_agent_info() const {
  const ::threadnetwork::TelemetryData_BorderAgentInfo* p = _impl_.border_agent_info_;
  return p != nullptr ? *p : reinterpret_cast<const ::threadnetwork::TelemetryData_BorderAgentInfo&>(
      ::threadnetwork::_TelemetryData_BorderAgentInfo_default_instance_);
}
inline const ::threadnetwork::TelemetryData_BorderAgentInfo& TelemetryData_WpanBorderRouter::border_agent_info() const {
  // @@protoc_insertion_point(field_get:threadnetwork.TelemetryData.WpanBorderRouter.border_agent_info)
  return _internal_border_agent_info();
}
inline void TelemetryData_WpanBorderRouter::unsafe_arena_set_allocated_border_agent_info(
    ::threadnetwork::TelemetryData_BorderAgentInfo* border_agent_info) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.border_agent_info_);
  }
  _impl_.border_agent_info_ = border_agent_info;
  if (border_agent_info) {
    _impl_._has_bits_[0] |= 0x00000400u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000400u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:threadnetwork.TelemetryData.WpanBorderRouter.border_agent_info)
}
inline ::threadnetwork::TelemetryData_BorderAgentInfo* TelemetryData_WpanBorderRouter::release_border_agent_info() {
  _impl_._has_bits_[0] &= ~0x00000400u;
  ::threadnetwork::TelemetryData_BorderAgentInfo* temp = _impl_.border_agent_info_;
  _impl_.border_agent_info_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::threadnetwork::TelemetryData_BorderAgentInfo* TelemetryData_WpanBorderRouter::unsafe_arena_release_border_agent_info() {
  // @@protoc_insertion_point(field_release:threadnetwork.TelemetryData.WpanBorderRouter.border_agent_info)
  _impl_._has_bits_[0] &= ~0x00000400u;
  ::threadnetwork::TelemetryData_BorderAgentInfo* temp = _impl_.border_agent_info_;
  _impl_.border_agent_info_ = nullptr;
  return temp;
}
inline ::threadnetwork::TelemetryData_BorderAgentInfo* TelemetryData_WpanBorderRouter::_internal_mutable_border_agent_info() {
  _impl_._has_bits_[0] |= 0x00000400u;
  if (_impl_.border_agent_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::threadnetwork::TelemetryData_BorderAgentInfo>(GetArenaForAllocation());
    _impl_.border_agent_info_ = p;
  }
  return _impl_.border_agent_info_;
}
inline ::threadnetwork::TelemetryData_BorderAgentInfo* TelemetryData_WpanBorderRouter::mutable_border_agent_info() {
  ::threadnetwork::TelemetryData_BorderAgentInfo* _msg = _internal_mutable_border_agent_info();
  // @@protoc_insertion_point(field_mutable:threadnetwork.TelemetryData.WpanBorderRouter.border_agent_info)
  return _msg;
}
inline void TelemetryData_WpanBorderRouter::set_allocated_border_agent_info(::threadnetwork::TelemetryData_BorderAgentInfo* border_agent_info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.border_agent_info_;
  }
  if (border_agent_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(border_agent_info);
    if (message_arena != submessage_arena) {
      border_agent_info = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, border_agent_info, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000400u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000400u;
  ...
  _impl_.border_agent_info_ = border_agent_info;
  // @@protoc_insertion_point(field_set_allocated:threadnetwork.TelemetryData.WpanBorderRouter.border_agent_info)
}
