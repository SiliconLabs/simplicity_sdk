...
// ------------------------------------------------------------------------------
// Plugin events
sli_zigbee_event_t sl_util_af_led_blink_led0_event_function_event;
sli_zigbee_event_t sl_util_af_led_blink_led1_event_function_event;

sli_zigbee_event_t * ledEventArray[BSP_LED_COUNT] = {
#if BSP_LED_COUNT >= 1
  &sl_util_af_led_blink_led0_event_function_event,
#endif
#if BSP_LED_COUNT >= 2
  &sl_util_af_led_blink_led1_event_function_event
#endif
};
...
void sl_util_af_led_blink_led0_event_function_event_handler(sli_zigbee_event_t* event)
{
  handleLedEvent(0);
}

// Plugin led1 event handler
void sl_util_af_led_blink_led1_event_function_event_handler(sli_zigbee_event_t* event)
{
  handleLedEvent(1);
}
