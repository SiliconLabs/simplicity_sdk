...
#define pwmBlinkEventControl  sl_util_af_bulb_pwm_driver_blink_event

sli_zigbee_event_t sl_util_af_bulb_pwm_driver_blink_event;
sli_zigbee_event_t sl_util_af_bulb_pwm_driver_status_event;
...
void halBulbPwmDriverBlinkInit(void)
{
  ...
  blinkState[BLINK_LED].event =
    &(sl_util_af_bulb_pwm_driver_blink_event);
  ...
  blinkState[BLINK_STATUS].event =
    &(sl_util_af_bulb_pwm_driver_status_event);
}

// ******** APIs and Event Functions *************
void sl_util_af_bulb_pwm_driver_blink_event_handler(void)
{
  eventHandler(&(blinkState[BLINK_LED]));
}

void sl_util_af_bulb_pwm_driver_status_event_handler(void)
{
