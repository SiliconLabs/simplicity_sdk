 ...
 *      void
 */
void dmpUiDisplayDirection(sl_dmp_ui_light_direction_t direction);
 ...
 *      void
 */
void dmpUiClearDirection(sl_dmp_ui_light_direction_t direction);
...
//void dmpUiDisplayZigBeeState(sl_dmp_ui_zigbee_network_state_t nwState);
...
//
//void dmpUiUpdateZigbeeStatus(sl_dmp_ui_zigbee_network_state_t nwState,
//                             bool withDisplayUpdate);
//
//bool dmpUiHelpMenuDisplayed();
//void dmpUiDisplayDirection(sl_dmp_ui_light_direction_t direction);
//sl_dmp_ui_light_direction_t dmpUiCurrentLightDirection();
