...
// sl_util_af_battery_monitor_data_ready_cb
void sl_util_af_battery_monitor_read_adc_event_handler(void)
{
  uint32_t flags;
  uint32_t vData;
  ...
  emberEventSetInactive(sl_util_af_battery_monitor_read_adc_event);
  ...
  if (timeSinceLastMeasureMS >= MS_BETWEEN_BATTERY_CHECK) {
    ...
    sl_util_af_battery_monitor_data_ready_cb(voltageMilliV);
