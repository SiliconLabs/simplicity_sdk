...
void sl_util_af_sb1_gesture_sensor_gesture_received_cb(uint8_t gesture,
                                                       uint8_t buttonNum);
...
void sl_util_af_sb1_gesture_sensor_init_cb(void)
{
  ...
  halGenericInterruptControlIrqEventRegister(irqConfig,
                                             &sl_util_af_sb1_gesture_sensor_message_ready_event);
...
// ******************************************************************************
void sl_util_af_sb1_gesture_sensor_message_ready_event_handler(void)
{
  uint8_t slave_addr;
  ...
  sl_util_af_sb1_gesture_sensor_gesture_received_cb((uint8_t)tGestureRxd,
                                                    buttonNum);
