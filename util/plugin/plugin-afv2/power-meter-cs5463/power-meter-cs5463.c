...
// ------------------------------------------------------------------------------
// Plugin events
sli_zigbee_event_t sl_util_af_power_meter_cs5463_init_event;
sli_zigbee_event_t sl_util_af_power_meter_cs5463_read_event;
...
extern void sl_util_af_eeprom_note_initialized_state(bool state);
extern void sl_util_af_eeprom_shutdown();
...
void sl_util_af_power_meter_cs5463_init_event_handler(sli_zigbee_event_t* event)
{
  halPowerMeterInit();
  emberEventSetInactive(sl_util_af_power_meter_cs5463_init_event);
  emberEventSetDelayMs(sl_util_af_power_meter_cs5463_read_event,
                       CS5463_MEASUREMENT_DELAY_MS);
}

void sl_util_af_power_meter_cs5463_read_event_handler(sli_zigbee_event_t* event)
{
  uint16_t gainFactor;
...
{
  emberEventSetDelayMs(sl_util_af_power_meter_cs5463_init_event,
...
bool halPowerMeterCalibrateCurrentGain(uint16_t referenceCurrentMa)
{
  ...
  emberEventSetInactive(sl_util_af_power_meter_cs5463_read_event);
