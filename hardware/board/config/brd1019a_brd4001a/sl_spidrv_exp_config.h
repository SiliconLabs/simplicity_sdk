...
// <<< sl:start pin_tool >>>
// <eusart signal=TX,RX,SCLK,(CS)> SL_SPIDRV_EXP
// $[EUSART_SL_SPIDRV_EXP]
#define SL_SPIDRV_EXP_PERIPHERAL                 EUSART1
...
#define SL_SPIDRV_EXP_SCLK_PORT                  SL_GPIO_PORT_C
#define SL_SPIDRV_EXP_SCLK_PIN                   2
