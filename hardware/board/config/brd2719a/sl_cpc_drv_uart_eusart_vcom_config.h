...
// EUSART0 TX on PB02
#define SL_CPC_DRV_UART_VCOM_TX_PORT             SL_GPIO_PORT_B
#define SL_CPC_DRV_UART_VCOM_TX_PIN              2

// EUSART0 RX on PB00
#define SL_CPC_DRV_UART_VCOM_RX_PORT             SL_GPIO_PORT_B
#define SL_CPC_DRV_UART_VCOM_RX_PIN              0

// EUSART0 CTS on PB03
#define SL_CPC_DRV_UART_VCOM_CTS_PORT            SL_GPIO_PORT_B
