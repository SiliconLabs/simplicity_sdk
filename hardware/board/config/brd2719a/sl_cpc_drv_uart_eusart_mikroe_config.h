...
#define SL_CPC_DRV_UART_MIKROE_PERIPHERAL        EUSART0
#define SL_CPC_DRV_UART_MIKROE_PERIPHERAL_NO     0

// EUSART0 TX on PA07
#define SL_CPC_DRV_UART_MIKROE_TX_PORT           SL_GPIO_PORT_A
#define SL_CPC_DRV_UART_MIKROE_TX_PIN            7

// EUSART0 RX on PA08
#define SL_CPC_DRV_UART_MIKROE_RX_PORT           SL_GPIO_PORT_A
#define SL_CPC_DRV_UART_MIKROE_RX_PIN            8

// EUSART0 CTS on PB03
#define SL_CPC_DRV_UART_MIKROE_CTS_PORT          SL_GPIO_PORT_B
#define SL_CPC_DRV_UART_MIKROE_CTS_PIN           3
