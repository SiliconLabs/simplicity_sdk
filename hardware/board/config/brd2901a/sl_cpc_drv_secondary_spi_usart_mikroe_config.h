...
#define SL_CPC_DRV_SPI_MIKROE_IRQ_PORT           gpioPortC
#define SL_CPC_DRV_SPI_MIKROE_IRQ_PIN            5

// [GPIO_SL_CPC_DRV_SPI_MIKROE_IRQ]$

// <usart signal=COPI,CIPO,CLK,(CS)> SL_CPC_DRV_SPI_MIKROE
// $[USART_SL_CPC_DRV_SPI_MIKROE]
#define SL_CPC_DRV_SPI_MIKROE_PERIPHERAL         USART0
#define SL_CPC_DRV_SPI_MIKROE_PERIPHERAL_NO      0

// USART0 TX on PD03
#define SL_CPC_DRV_SPI_MIKROE_COPI_PORT          gpioPortD
#define SL_CPC_DRV_SPI_MIKROE_COPI_PIN           3

// USART0 RX on PD02
#define SL_CPC_DRV_SPI_MIKROE_CIPO_PORT          gpioPortD
