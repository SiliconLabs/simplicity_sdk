#ifndef SL_EMLIB_GPIO_INIT_EXP_9_CONFIG_H
#define SL_EMLIB_GPIO_INIT_EXP_9_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_EXP_9_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_EXP_9_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_EXP_9_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_EXP_9_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_EXP_9
// $[GPIO_SL_EMLIB_GPIO_INIT_EXP_9]
#define SL_EMLIB_GPIO_INIT_EXP_9_PORT            SL_GPIO_PORT_B
#define SL_EMLIB_GPIO_INIT_EXP_9_PIN             1

// [GPIO_SL_EMLIB_GPIO_INIT_EXP_9]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_EXP_9_CONFIG_H
