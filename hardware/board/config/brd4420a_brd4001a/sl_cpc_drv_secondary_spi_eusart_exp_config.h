...
#define SL_CPC_DRV_SPI_EXP_IRQ_PORT              SL_GPIO_PORT_B
#define SL_CPC_DRV_SPI_EXP_IRQ_PIN               2

// [GPIO_SL_CPC_DRV_SPI_EXP_IRQ]$

// <eusart signal=COPI,CIPO,SCLK,(CS)> SL_CPC_DRV_SPI_EXP
...
#define SL_CPC_DRV_SPI_EXP_COPI_PIN              5

// EUSART1 RX on PC03
#define SL_CPC_DRV_SPI_EXP_CIPO_PORT             SL_GPIO_PORT_C
#define SL_CPC_DRV_SPI_EXP_CIPO_PIN              3
...
// EUSART1 CS on PC06
#define SL_CPC_DRV_SPI_EXP_CS_PORT               SL_GPIO_PORT_C
