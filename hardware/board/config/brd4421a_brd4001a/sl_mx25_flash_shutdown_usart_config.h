...
// USART0 TX on PB00
#define SL_MX25_FLASH_SHUTDOWN_TX_PORT           SL_GPIO_PORT_B
#define SL_MX25_FLASH_SHUTDOWN_TX_PIN            0

// USART0 RX on PB01
#define SL_MX25_FLASH_SHUTDOWN_RX_PORT           SL_GPIO_PORT_B
#define SL_MX25_FLASH_SHUTDOWN_RX_PIN            1

// USART0 CLK on PB02
#define SL_MX25_FLASH_SHUTDOWN_CLK_PORT          SL_GPIO_PORT_B
