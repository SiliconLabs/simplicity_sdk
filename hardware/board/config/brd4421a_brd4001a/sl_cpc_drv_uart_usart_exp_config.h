...
// <o SL_CPC_DRV_UART_EXP_RX_PAYLOAD_MAX_LENGTH>Max Rx Payload Length<1-4087>
...
// <o SL_CPC_DRV_UART_EXP_TX_QUEUE_ITEM_MAX_COUNT> Tx Queue Size
...
// <o SL_CPC_DRV_UART_EXP_RX_BUFFER_MAX_COUNT> Total Number of Rx Buffers
...
// USART1 TX on PA05
#define SL_CPC_DRV_UART_EXP_TX_PORT              SL_GPIO_PORT_A
#define SL_CPC_DRV_UART_EXP_TX_PIN               5

// USART1 RX on PA06
#define SL_CPC_DRV_UART_EXP_RX_PORT              SL_GPIO_PORT_A
#define SL_CPC_DRV_UART_EXP_RX_PIN               6

// USART1 CTS on PA04
#define SL_CPC_DRV_UART_EXP_CTS_PORT             SL_GPIO_PORT_A
#define SL_CPC_DRV_UART_EXP_CTS_PIN              4

// USART1 RTS on PA00
#define SL_CPC_DRV_UART_EXP_RTS_PORT             SL_GPIO_PORT_A
