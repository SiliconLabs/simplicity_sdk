...
// USART0 TX on PC05
#define SL_SPIDRV_USART_EXP_TX_PORT              SL_GPIO_PORT_C
#define SL_SPIDRV_USART_EXP_TX_PIN               5

// USART0 RX on PC03
#define SL_SPIDRV_USART_EXP_RX_PORT              SL_GPIO_PORT_C
#define SL_SPIDRV_USART_EXP_RX_PIN               3

// USART0 CLK on PC02
#define SL_SPIDRV_USART_EXP_CLK_PORT             SL_GPIO_PORT_C
#define SL_SPIDRV_USART_EXP_CLK_PIN              2

// USART0 CS on PC06
#define SL_SPIDRV_USART_EXP_CS_PORT              SL_GPIO_PORT_C
