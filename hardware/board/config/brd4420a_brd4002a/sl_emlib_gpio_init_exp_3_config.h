#ifndef SL_EMLIB_GPIO_INIT_EXP_3_CONFIG_H
#define SL_EMLIB_GPIO_INIT_EXP_3_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_EXP_3_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_EXP_3_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_EXP_3_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_EXP_3_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_EXP_3
// $[GPIO_SL_EMLIB_GPIO_INIT_EXP_3]
#define SL_EMLIB_GPIO_INIT_EXP_3_PORT            SL_GPIO_PORT_A
#define SL_EMLIB_GPIO_INIT_EXP_3_PIN             4

// [GPIO_SL_EMLIB_GPIO_INIT_EXP_3]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_EXP_3_CONFIG_H
